...
const CheckOutLoginSignup = () => {
    ...
    return (
        <div className="card br-15 mb-3 active-tab-shadow">
            <div className="card-header bg-blue" id="headingOne">
                                            ...
                                            <div className="fix-continue">
                                                <div className="common-button">
                                                    <button
                                                        onClick={handleLogin}
                                                        type="button"
                                                        className="bg-blue mt-3 text-uppercase text-white f-16 f-rob-bol checkout-login fix-continue"
                                                    >
                                                        Continue
                                                    </button>
                                                </div>
                                            ...
                                            <div className="fix-continue">
                                                <div className="common-button">
                                                    <button
                                                        ...
                                                        type="button"
                                                        className="bg-blue text-uppercase text-white f-16 f-rob-bol checkout-login fix-continue"
                                                    >
                                                        Submit
                                                    </button>
                                                </div>
