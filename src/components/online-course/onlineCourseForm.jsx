      ...
      <div>
        ...
        <div className="mb-3 d-none d-xl-block read-more-span">
          ...
          <span
            ...
            id="myBtnn"
            style={{ color: "rgb(110, 181, 0)", fontWeight: "500", cursor: "pointer" }}
          >
        ...
        <div className="row justify-content-center align-items-center">
          <div className="col-6 p-0">
            <Button
              className="btn btn-started mt-2 bg-dark w-100"
          ...
          {removeReferButton ? (
            ...
            <div className="col-6 px-2">
              <button className="btn btn-started mt-2 w-100" onClick={openForm}>
                Refer And Earn
              </button>
            </div>
          )}
