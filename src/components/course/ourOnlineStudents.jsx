                    ...
                    <div className="row">
                        <div className="col-lg-3 col-sm-6 text-center">
                            <span className="counter"
                                style={{ fontWeight: 'bold', lineHeight: '1.42857143', color: '#fff', fontSize: '40px', fontFamily: 'Nunito,sans-serif' }}>9500</span>
                        ...
                        <div className="col-lg-3 col-sm-6 text-center">
                            <span className="counter"
                                style={{ fontWeight: 'bold', lineHeight: '1.42857143', color: '#fff', fontSize: '40px', fontFamily: 'Nunito,sans-serif' }}>2700</span>
                            <i className="fas fa-plus" style={{ fontWeight: 'bold', color: '#fff', fontSize: '33px' }}></i>
                            <div className="tabata">
                        ...
                        <div className="col-lg-3 col-sm-6 text-center">
                            <span className="counter"
                                style={{ fontWeight: 'bold', lineHeight: '1.42857143', color: '#fff', fontSize: '40px', fontFamily: 'Nunito,sans-serif' }}>4550</span>
                            <i className="fas fa-plus" style={{ fontWeight: 'bold', color: '#fff', fontSize: '33px' }}></i>
                            <div className="tabata">
                        ...
                        <div className="col-lg-3 col-sm-6 text-center">
                            <span className="counter"
                                style={{ fontWeight: 'bold', lineHeight: '1.42857143', color: '#fff', fontSize: '40px', fontFamily: 'Nunito,sans-serif' }}>16750</span>
                            <i className="fas fa-plus" style={{ fontWeight: 'bold', color: '#fff', fontSize: '33px' }}></i>
                            <div className="tabata">
...
export default OurOnlineStudents;
