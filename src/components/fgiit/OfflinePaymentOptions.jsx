...
const OfflinePaymentOptions = ({ courseData, basePrice }) => {
  const [selectedOption, setSelectedOption] = useState(
    courseData.name == "Offline Anabolic-Androgenic Steroids Masterclass"
      ? "prepaid"
      : ""
  );
  ...
  useEffect(() => {
    ...
    if (itemCart) {
      localStorage.setItem(
        ...
        JSON.stringify({
          ...courseData,
          selectedEmiOption: selectedLocalEmiOption,
        })
      );
      localStorage.setItem("offlineCheckOut", "");
      window.location.href = "/fgiit/offline-check-out";
  ...
  return (
    <>
      ...
      <div className="payment-option-group" style={{ gap: "5px" }}>
        {courseData.name ==
          "Offline Anabolic-Androgenic Steroids Masterclass" ? (
          ""
        ) : (
          <>
            {/* EMI Options */}
                ...
                <div>
                  ...
                  <div className="emi-prices">
                    <strong>
                      ₹
                      {(
                        (courseData.prices + courseData.prices * 0.06) /
                        3
                      ).toFixed(0)}{" "}
                    </strong>
                    <span>per month</span>
                ...
                <div>
                  ...
                  <div className="emi-prices">
                    <strong>
                      ₹
                      {(
                        (courseData.prices + courseData.prices * 0.12) /
                        6
                      ).toFixed(0)}{" "}
                    </strong>
                    <span>per month</span>
                ...
                <div>
                  ...
                  <div className="emi-prices">
                    <strong>
                      ₹
                      {(
                        (courseData.prices + courseData.prices * 0.18) /
                        9
                      ).toFixed(0)}
                    </strong>
                    <span>per month</span>
                ...
                <div>
                  ...
                  <div className="emi-prices">
                    <strong>
                      ₹
                      {(
                        (courseData.prices + courseData.prices * 0.24) /
                        12
                      ).toFixed(0)}
                    </strong>
                    <span>per month</span>
              ...
              <p className="mt-2">
                ...
                {/* <p className="emi-price">
                  <strong>
                    ₹
                    {(
                      (courseData.prices - courseData.prices * 0.1) /
                      12
                    ).toFixed(0)}{" "}
                    per month
                  </strong>{" "}
