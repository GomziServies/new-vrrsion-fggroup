...
function BookPhotoSection({ englishbook, hindibook, currentBookLang }) {
  ...
  return (
    <div className="col-lg-6">
      <div
        ...
        style={{
          display:
            currentBookLang === "english" || currentBookLang === "E-english"
              ? "block"
              : "none",
        }}
      >
      ...
      <div
        className="product-imgs hindi-book singal-product-img"
        style={{
          display:
            currentBookLang === "hindi" || currentBookLang === "E-hindi"
              ? "block"
              : "none",
        }}
      >
        ...
        >
          <div className="main-image text-center mt-4">
            <InnerImageZoom
              src={hindibook[prevIndex]}
              zoomSrc={hindibook[prevIndex]}
              zoomType="hover"
              zoomPreload={true}
              alt="FG Group"
              width="85%"
...
export default BookPhotoSection;
