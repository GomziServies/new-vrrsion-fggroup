...
function ChatBotFWGComponent() {
  ...
  const openChatBotMobile = () => {
    ...
    window.location.href = "/fitnesswithgomzi/fwg-chatbot";
  };
  ...
  const startBot = () => {
    ...
    setTimeout(() => {
      setBotMessages([{ content: "Hi, welcome to FWG! 👋" }]);
    ...
    setTimeout(() => {
      setBotMessages((prevMessages) => [
        ...prevMessages,
        { content: "We are the Fitness experts." },
      ]);
      ...
      setBotMessages((prevMessages) => [
        ...prevMessages,
        {
          ...
          action: {
            ...
            options: [
              {
                text: "Weight Loss Program Issues.",
                value: "issue1",
              },
              // { text: "Other: Describe Issue: Provide a detailed description of the problem. Attach relevant documents/screenshots if needed.", value: "no" },
            ],
          },
        },
      ]);
      ...
      setBotMessages((prevMessages) => [
        ...prevMessages,
        {
          ...
          action: {
            ...
            options: [
              {
                text: "Weight Gain Program Issues.",
                value: "issue2",
              },
            ],
          },
      ...
      setBotMessages((prevMessages) => [
        ...prevMessages,
        {
          ...
          action: {
            ...
            options: [
              {
                text: "Bodybuilding Program Issues.",
                value: "issue3",
              },
            ],
          },
    ...
    if (choice === "other") {
      ...
      const selectChoice =
        choice === "issue1"
          ...
          : choice === "issue2"
          ? "Weight Gain Program Issues."
          : choice === "issue3"
          ? "Bodybuilding Program Issues."
          : choice === "issue4"
          ? "Diet or Nutrition Issues."
          : choice === "issue5"
          ? "Workout Plans Issues."
          : choice === "issue6"
  ...
  const handleOtherSubmit = () => {
    if (otherMessage.trim() !== "") {
      handleCreateComplaint(otherMessage);
        ...
        setBotMessages((prevMessages) =>
          prevMessages
            ...
            .concat(
              ...
              {
                content:
                  "Thank you, your complaint will be resolved in under 24-48 hours.",
              }
            )
        );
      }, 1000);
...
export default ChatBotFWGComponent;
