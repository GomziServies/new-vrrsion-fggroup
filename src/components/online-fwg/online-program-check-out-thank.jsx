...
function OnlineProgramCheckOutThank({ setCheckData }) {
  ...
  const handleComplete = () => {
    ...
    setCheckData("");
    window.location.href = ProgramData.link;
  };
                  ...
                  <div className="text-center">
                    ...
                    <div className="thank-you-content">
                      <p className="thank-you-message">
                        We appreciate your trust in choosing our program. You now
...
export default OnlineProgramCheckOutThank;
