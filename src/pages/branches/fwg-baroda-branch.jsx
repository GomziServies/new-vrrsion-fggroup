  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://fggroup.in/fwg-baroda-branch" />
                      ...
                      <div className="p-0 pricing-wrapper">
                        ...
                        <div className="is-visible">
                          <div className="px-4 text-center box-shadow pricing-table border-left border-right">
                            ...
                            <h2 className="h2-fs h2 mt-1">₹3000/-</h2>
                      ...
                      <div className="p-0 pricing-wrapper">
                        ...
                        <div className="is-visible">
                          <div className="px-4 text-center box-shadow pricing-table border-left border-right">
                            ...
                            <h2 className="h2-fs h2 mt-1">₹7200/-</h2>
                            <h2 className="h5 h5-fs mb-4">
                              Diet And personal Training
                            </h2>
                            <div className="border-bottom border-color mb-5"></div>
                      ...
                      <div className="p-0 pricing-wrapper">
                        ...
                        <div className="is-visible">
                          <div className="px-4 text-center box-shadow pricing-table border-left border-right">
                            ...
                            <h2 className="h2-fs h2 mt-1">₹15000/-</h2>
                            <h2 className="h5 h5-fs mb-4">
                              Diet And personal Training
                            </h2>
                            <div className="border-bottom border-color mb-5"></div>
                      ...
                      <div className="p-0 pricing-wrapper">
                        ...
                        <div className="is-visible">
                          <div className="px-4 text-center box-shadow pricing-table border-left border-right">
                            ...
                            <h2 className="h2-fs h2 mt-1">₹21000/-</h2>
                            <h2 className="h5 h5-fs mb-4">
                              Diet And personal Training
                            </h2>
                            <div className="border-bottom border-color mb-5"></div>
                      ...
                      <div className="p-0 pricing-wrapper">
                        ...
                        <div className="is-visible">
                          <div className="px-4 text-center box-shadow pricing-table border-left border-right">
                            ...
                            <h2 className="h2-fs h2 mt-1">₹30000/-</h2>
                            <h2 className="h5 h5-fs mb-4">
                              Diet And personal Training
                            </h2>
                            <div className="border-bottom border-color mb-5"></div>
          ...
          <div className="contact-experts flex">
            ...
            <div className="contacts row">
              <div className="col-lg-4">
                <Link to="" id="healthier_you" target="_blank">
      ...
      <section>
        <div className="container-fluid p-0">
          <Button
            href="https://api.whatsapp.com/send?phone=8866842520&amp;text=Hello I want to know more about Your Services."
...
export default FwgBarodaBranch;
