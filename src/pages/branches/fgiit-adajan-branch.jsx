...
import FGIITADAJAN from "../../pdf/fgiit-adajan.pdf";
import { Link } from "react-router-dom";
import { LazyLoadImage } from "react-lazy-load-image-component";
import "react-lazy-load-image-component/src/effects/blur.css";
import { Helmet } from "react-helmet";

function FGIITAdajanBranch() {
  ...
  return (
    <>
      <Helmet>
        <title>Fitness Courses in Adajan | FGIIT</title>
        <meta name="description" content="FGIIT, the premier Fitness Academy in Adajan. Offering top-rated diploma and fitness courses tailored to elevate your career. Join now and transform your passion into a profession. Enroll today and book a 7 day free demo session for your favorite course." />
        <meta name="keyword" content="FGIIT, best fitness institute in Adajan, fitness courses, diploma courses in fitness, best institute for fitness courses, fitness academy in Adajan, fitness academy" />
        <meta property="og:title" content="Fitness Courses in Adajan | FGIIT" />
        <meta property="og:description" content="FGIIT, the premier Fitness Academy in Adajan. Offering top-rated diploma and fitness courses tailored to elevate your career. Join now and transform your passion into a profession. Enroll today and book a 7 day free demo session for your favorite course." />
        <meta property="og:image" content="https://fggroup.in/assets/images/logo/fg_group.webp" />
        <meta property="og:url" content="https://fggroup.in/fgiit-adajan-branch" />
              ...
              <div className="mb-5 item mx-2">
                <div className="card border-0 rounded-0 box-shadow">
                  ...
                  <div className="card-body position-relative py-5">
                    ...
                    <h2 className="h4-fs h4">Duration: 6 Months</h2>
              ...
              <div className="mb-5 item mx-2">
                <div className="card border-0 rounded-0 box-shadow">
                  ...
                  <div className="card-body position-relative py-5">
                    ...
                    <h2 className="h4-fs h4">Duration: 2 Days</h2>
                    <p className="card-text paragraph mb-3">
      ...
      <section>
        <div className="container-fluid p-0">
          <Button
            href="https://api.whatsapp.com/send?phone=8866842520&amp;text=Hello I want to know more about EMI Option in FGIIT Courses in Adajan branch."
              ...
              >
                <div className="text-center item">
                  ...
                  <div className="bg-quote text-center pt-md-4">
                    ...
                    <p className="mb-5 h5 text-dark paragraph">
...
export default FGIITAdajanBranch;
