...
function HealthAndFitnessBooks() {
  ...
  return (
    <>
      <Helmet>
        <title>Health & Fitness Books | Fitness With Gomzi</title>
        <meta name="description" content="Fitness with Gomzi offers effective resources to help you achieve your health and fitness goals, including the RTP 1.0 weight loss program, RTP 2.0 home-based weight maintenance program, and the Transformation Kit. Say goodbye to fad diets and expensive gym memberships and hello to sustainable, long-term results with Fitness with Gomzi." />
        ...
        <meta property="og:title" content="Health & Fitness Books | Fitness With Gomzi" />
        <meta property="og:description" content="Fitness with Gomzi offers effective resources to help you achieve your health and fitness goals, including the RTP 1.0 weight loss program, RTP 2.0 home-based weight maintenance program, and the Transformation Kit. Say goodbye to fad diets and expensive gym memberships and hello to sustainable, long-term results with Fitness with Gomzi." />
