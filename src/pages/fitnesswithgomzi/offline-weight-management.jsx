...
import { OfflineWeightManagementProgramData } from "../../components/offline-fwg/AllOfflineProgramData";
...
function OfflineWeightManagement() {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer:
        "FGIIT's course includes unique topics such as group instructor training, anabolic and androgenic steroids, powerlifting, and injury rehabilitation. This makes FGIIT the most knowledgeable and value-for-money course in the industry.",
    },
    {
  ...
  return (
    <>
      <PageMeta
        title="Offline Weight Management Course | FG Group"
      ...
      <WhatsappHeaderApp
        message={
          "Hello, I wanted to know more about Offline Weight Management Program details. "
        }
                    ...
                    <div className="d-md-block d-none">
                      <div className="course-info">
                        ...
                        <ul className="course-list">
                          {OfflineWeightManagementProgramData?.info1.map(
                            (info) => (
                              <li>
              ...
              <div className="col-lg-5 mb-5 position-relative">
                <div className="black-before-2">
                  <OnlineProgramFormFwg
                    programData={OfflineWeightManagementProgramData}
                    openForm={openForm}
...
export default OfflineWeightManagement;
