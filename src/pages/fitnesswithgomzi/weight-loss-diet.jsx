...
function FlexibleWeightLossProgram() {
  ...
  const fitnessPlanBuy = async () => {
    ...
    new window.Razorpay({
      ...
      currency: "INR",
      name: "RTP-1.0 Weight Loss Plan",
      description: "RTP-1.0 Weight Loss Plan",
      prefill: {
        name: name,
        email: email,
        contact: phoneNumber,
  ...
  const bodybuildingEntryFeesSuccess = async (razorpayResponse) => {
    ...
    setShowModal(false);
    publicAxiosInstance
      .post("/guest-payment/buy-weight-loss-plan", payload)
      .then((response) => {
        Swal.fire({
          icon: "success",
  ...
  return (
    <>
      <Helmet>
        <title>Best Weight Loss Diet for Sustainable Results and Wellness</title>
        <meta name="description" content="Discover the best weight loss diet for sustainable results and wellness. Start your journey to a healthier you today!" />
        <meta name="keyword" content="weight loss program, weight loss, fitness plans, diet plans, keto diet plan, lose weight fast, best weight loss program, weight loss supplements, best way to lose weight, meal plan for weight loss, best weight loss supplements, mediterranean diet meal plan, fastest way to lose weight, best diet to lose weight, found weight loss, best way to lose belly fat, diet plan for weight loss, healthy meals for weight loss, weight loss diet, diet meal plans, dash diet meal plan, weight loss plan, quickest way to lose weight, diabetic diet plan, juniper weight loss, best way to lose weight fast, healthy meal plans, healthy snacks for weight loss, best weight loss, extreme weight loss methods, diet programs, Low-Carb Diet Plan, Personalized Weight Loss Plan, Best Meal Plan for Weight Loss, Online Weight Loss Program, Weight Loss Meal Plan for Women, Healthy Weight Loss Diet, Holistic Weight Loss, Natural Weight Loss Program, Rapid Weight Loss Plan, High Protein Diet Plan, Vegan Meal Plan for Weight Loss, Long-Term Weight Management, Custom Weight Loss Plan, Sustainable Weight Loss, Science-Backed Weight Loss, Intermittent Fasting for Weight Loss, Mindful Eating for Weight Loss, Affordable Weight Loss Plans" />
        <meta property="og:title" content="Best Weight Loss Diet for Sustainable Results and Wellness" />
        <meta property="og:description" content="Discover the best weight loss diet for sustainable results and wellness. Start your journey to a healthier you today!" />
        <meta property="og:image" content="https://fggroup.in/assets/images/logo/fg_group.webp" />
        <meta property="og:url" content="https://fggroup.in/fitnesswithgomzi/weight-loss-diet" />
      ...
      <p className="d-none">
     weight loss program, weight loss, fitness plans, diet plans, keto diet plan, lose weight fast, best weight loss program, weight loss supplements, best way to lose weight, meal plan for weight loss, best weight loss supplements, mediterranean diet meal plan, fastest way to lose weight, best diet to lose weight, found weight loss, best way to lose belly fat, diet plan for weight loss, healthy meals for weight loss, weight loss diet, diet meal plans, dash diet meal plan, weight loss plan, quickest way to lose weight, diabetic diet plan, juniper weight loss, best way to lose weight fast, healthy meal plans, healthy snacks for weight loss, best weight loss, extreme weight loss methods, diet programs, Low-Carb Diet Plan, Personalized Weight Loss Plan, Best Meal Plan for Weight Loss, Online Weight Loss Program, Weight Loss Meal Plan for Women, Healthy Weight Loss Diet, Holistic Weight Loss, Natural Weight Loss Program, Rapid Weight Loss Plan, High Protein Diet Plan, Vegan Meal Plan for Weight Loss, Long-Term Weight Management, Custom Weight Loss Plan, Sustainable Weight Loss, Science-Backed Weight Loss, Intermittent Fasting for Weight Loss, Mindful Eating for Weight Loss, Affordable Weight Loss Plans
      </p>
      <ModalVideo
        channel="youtube"
        isOpen={isVideoOpen}
...
export default FlexibleWeightLossProgram;
