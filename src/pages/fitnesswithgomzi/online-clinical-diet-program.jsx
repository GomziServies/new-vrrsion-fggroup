...
function OnlineClinicalDietProgram() {
  ...
  return (
    <>
      <Helmet>
        <title>Online Clinical Diet Program | FG Group</title>
        <meta name="description" content="Online Clinical Diet Program." />
        ...
        <meta
          property="og:title"
          content="Online Clinical Diet Program | FG Group"
        />
        <meta
          property="og:description"
          content="Online Clinical Diet Program."
        />
        <meta
          property="og:image"
...
export default OnlineClinicalDietProgram;
