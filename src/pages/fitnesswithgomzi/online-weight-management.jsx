...
import { WeightManagementProgramData } from "../../components/online-fwg/AllOnlineProgramData";
...
function OnlineWeightManagement() {
  ...
  const faqItems = [
    {
      question: "What is RTP 2.0, and how does it differ from RTP 1.0?",
      answer:
        "RTP 2.0 is an upgraded version of our weight management program. While RTP 1.0 focuses on basic fitness and weight loss, RTP 2.0 emphasizes sustainable weight management, preventing weight regain, and includes more personalized coaching and advanced diet plans.",
    },
    {
      question: "How long does the RTP 2.0 program last?",
      answer:
        "RTP 2.0 is a 12-month program designed to guide you through long-term weight management. It provides personalized workout and diet plans, regular consultations, and continuous support for the entire year.",
    },
    {
      question: "Is RTP 2.0 suitable for people with medical conditions?",
      answer:
        "Yes, RTP 2.0 is suitable for people with certain medical conditions like obesity, diabetes, and hypertension. However, we recommend consulting your doctor before enrolling, as the program can be customized based on medical history.",
    },

    {
      question: "Will I receive one-on-one coaching in RTP 2.0?",
      answer:
        "Yes, RTP 2.0 offers one-on-one sessions with personal trainers and dietitians. These sessions ensure that the program is tailored to your specific needs and fitness goals.",
    },
    {
      question:
        "What happens if I miss a session or fall behind in the program?",
      answer:
        "RTP 2.0 is designed with flexibility in mind. If you miss a session, we provide rescheduling options, and our trainers will help you get back on track. Additionally, the program includes multiple batch options to suit your schedule.",
    },
  ];
  ...
  return (
    <>
      <Helmet>
        <title>Online Weight Management Program | FG Group</title>
        <meta name="description" content="Online Weight Management Program." />
        ...
        <meta property="og:title" content="Online Weight Management Program | FG Group" />
        <meta property="og:description" content="Online Weight Management Program." />
        <meta
          property="og:image"
          content="https://fggroup.in/assets/images/logo/fg_group.webp"
        />
        <meta property="og:url" content="https://fggroup.in/fitnesswithgomzi/online-weight-management" />
      ...
      <WhatsappHeaderApp
        message={
          "Hello, I wanted to know more about Online Weight Management Program details. "
        }
                    ...
                    <div className="ply1">
                      <LazyLoadImage
                        ...
                        src={
                          ...
                          "/assets/images/fwg/rtp-two.webp"
                        }
                      />
                    ...
                    <div className="d-md-block d-none">
                      <div className="course-info">
                        ...
                        <ul className="course-list">
                          {WeightManagementProgramData?.info1.map((info) => (
                            <li>
              ...
              <div className="col-lg-5 mb-5 position-relative">
                <div className="black-before-2">
                  <OnlineProgramFormFwg
                    programData={WeightManagementProgramData}
                    openForm={openForm}
                    whatsappMessage="Hello, I wanted to know more about the Online Weight Management Program."
                  />
                </div>
              </div>
            </div>
                  ...
                  <div className="col-md-11 pl-0">
                    <Form>
                      ...
                      <div className="input-group align-items-center mb-3">
                        ...
                        >
                          <option value="" hidden>
                            Select which Program you interested
                          </option>
                          <option
                            className="field"
                            value="RTP-1.0-Fat-Loss Program"
                          >
                            RTP-1.0-Fat-Loss Program
                          </option>
                          <option
                            className="field"
                            value="RTP-2.0 - Weight Management"
                          >
                            RTP-2.0 - Weight Management
                          </option>
                          <option
                            className="field"
                            value="RTP-3.0 Clinical illness"
                          >
                            RTP-3.0 Clinical illness
                          </option>
                          <option
                            className="field"
                            value="RTP-4.0 Corporate Wellness"
                          >
                            RTP-4.0 Corporate Wellness
                          </option>
                          <option
                            className="field"
                            value="RTP-5.0 Prep Coaching"
                          >
...
export default OnlineWeightManagement;
