...
import { OfflineRapidWeightLossProgramData } from "../../components/offline-fwg/AllOfflineProgramData";
import WhatsappHeaderApp from "../../components/whatsappHeaderBtn";

function OfflineRapidWeightLoss() {
  ...
  return (
    <>
      <PageMeta
        title="Online Rapid Weight Loss Program | FG Group"
        description="Online Rapid Weight Loss Program."
      ...
      <WhatsappHeaderApp
        message={
          "Hello, I wanted to know more about Offline Rapid Weight Loss Program details. "
        }
                    ...
                    <div className="d-md-block d-none">
                      <div className="course-info">
                        ...
                        <ul className="course-list">
                          {OfflineRapidWeightLossProgramData?.info1.map(
                            (info) => (
                              <li>
              ...
              <div className="col-lg-5 px-md-0 position-relative">
                <div className="black-before-2">
                  <OnlineProgramFormFwg
                    programData={OfflineRapidWeightLossProgramData}
                    // openForm={openForm}
                ...
                >
                  ...
                  <div className="item mx-3">
                    <img
                      ...
                      src={
                        process.env.PUBLIC_URL +
                        "/assets/images/fwg/weight-loss-3.webp"
                      }
                      alt="weight loss transformation"
                    />
                  </div>
                  ...
                  <div className="item mx-3">
                    <img
                      ...
                      src={
                        process.env.PUBLIC_URL +
                        "/assets/images/fwg/weight-loss-5.webp"
                      }
                      alt="weight loss transformation"
                    />
                  </div>
                  <div className="item mx-3">
                    <img
                      ...
                      src={
                        process.env.PUBLIC_URL +
                        "/assets/images/fwg/weight-loss-6.webp"
                      }
                      alt="weight loss transformation"
                    />
                  </div>
...
export default OfflineRapidWeightLoss;
