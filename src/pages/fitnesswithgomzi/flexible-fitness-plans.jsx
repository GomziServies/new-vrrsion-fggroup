...
function FlexibleFitnessPlans() {
  ...
  return (
    <>
      <Helmet>
        <title>
          Flexible Fitness Courses | Personal Trainer & Gym Trainer Courses
        </title>
        <meta
          name="description"
          content="Here is one of the best ways to keep on learning while having a job or work at the same time with this online gym trainer course & dietitian course."
        />
        ...
        <meta
          property="og:title"
          content="Flexible Fitness Courses | Personal Trainer & Gym Trainer Courses"
        />
        <meta
            ...
            <div className="row">
              ...
              <div className="col-md-7">
                <div className="tabata">
                  <Link to="/fitnesswithgomzi/flexible-weight-loss-program">
        ...
        <div className="container-fluid py-5">
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-7">
                <div className="tabata">
                  <Link to="/fitnesswithgomzi/flexible-weight-managment">
                    <h2 className="h2-fs mt-2 mt-md-0">
        ...
        <div className="container-fluid py-5">
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-7">
                <div className="tabata">
                  <Link to="/fitnesswithgomzi/flexible-corporate-wellness">
                    <h2 className="h2-fs mt-2 mt-md-0">
        ...
        <div className="container-fluid py-5">
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-7">
                <div className="tabata">
                  <Link to="/fitnesswithgomzi/flexible-prep-coaching-for-bodybuilding">
                    <h2 className="h2-fs mt-2 mt-md-0">
