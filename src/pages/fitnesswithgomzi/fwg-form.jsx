...
import { bookRTPDemoLecture } from "../../assets/js/utils/contact-us";
...
function FWGFormPage() {
  ...
  const getTimeSlotOptions = (plan_name) => {
    switch (plan_name) {
      case "RTP 1.0":
        return (
          <>
      ...
      case "RTP 2.0":
        return (
          <>
            ...
            <option value="08:00">08:00 am To 09:00 am</option>
            <option value="18:00">06:00 pm to 07:00 pm</option>
          </>
        );
      ...
      case "RTP 3.0":
        return (
          <>
            ...
            <option value="17:00">05:00 pm to 06:00 pm</option>
          </>
        );
      ...
      case "RTP 5.0":
        return (
          <>
            ...
            <option value="07:00">07:00 am To 07:30 am</option>
          </>
        );
  ...
  const handleSubmit = async () => {
    ...
    const plan_name = formData.plan_name;
    ...
    let payload = {
      ...
      email,
      mobile,
      message: `I have booked a demo session for ${plan_name} at ${formattedDate} ${slot}`,
      subject: "Demo RTP Session",
      developer_notes: {
        topic: "Demo RTP Session",
        program: plan_name,
        date: formattedDate + " " + slot,
      },
    };

    await bookRTPDemoLecture(payload);
  ...
  return (
    <>
      <Helmet>
        <title>Book a live Demo session</title>
        ...
        <meta property="og:title" content="Book a live Demo session" />
        ...
        <meta property="og:url" content="https://fggroup.in/fitnesswithgomzi/fwg-form-page" />
                ...
                <div className="p-3">
                  ...
                  <div className="demoo mt-5">
                    <h2 className="mb-2 fs-30">
                      Get a free live Demo PT session / Diet Plan
                    </h2>
                    ...
                    <div className="d-block next-form" id="formmi">
                      ...
                      <div className="row justify-content-center">
                        <div className="col-md-10 col-12 pl-2 pl-md-0">
                          ...
                          <p className="mb-0 mt-2 mt-md-3">Program Name :-</p>
                          <div className="input-group align-items-center mb-3">
                            <span className="pr-2">
                            ...
                            <select
                              ...
                              style={{ width: "80%" }}
                            >
                              <option value="" hidden className="p-1">
                                Select Program
                              </option>
                              <option value="RTP 1.0">
                                RTP-1.0 Fat-Loss Program
                              </option>
                              <option value="RTP 2.0">
                                RTP-2.0 Weight Management
                              </option>
                              <option value="RTP 3.0">
                                RTP-3.0 Clinical illness
                              </option>
                              <option value="RTP 4.0">
                                RTP-4.0 Corporate Wellness
                              </option>
                              <option value="RTP 5.0">
                                RTP-5.0 Prep Coaching
                              </option>
                            </select>
                          </div>
                          <div className="row">
                            <div className="col-md-6 date-full-width">
                              <p className="mb-0">Date :-</p>
                              <DatePicker
                                selected={formData.date}
                                onChange={handleDateChange}
                                minDate={tomorrow}
                                className="input-group align-items-center mb-3 p-1 mt-0"
                                placeholderText="Choose a date"
                              />
                            </div>
                            <div className="col-md-6">
                              <p className="mb-0">Time :-</p>
                              <div className="input-group align-items-center mb-3 py-1 mt-0">
                                <span className="pr-2">
                                ...
                                <select
                                  ...
                                  style={{ width: "80%" }}
                                >
                                  {getTimeSlotOptions(formData.plan_name)}
                                </select>
                              </div>
                            </div>
                          </div>
