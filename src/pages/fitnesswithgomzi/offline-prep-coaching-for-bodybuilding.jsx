...
import { OfflinePrepCoachingProgramData } from "../../components/offline-fwg/AllOfflineProgramData";
...
function OfflinePrepCoachingProgram() {
  ...
  return (
    <>
      <PageMeta
        title="Offline Prep Coaching Program | FG Group"
      ...
      <WhatsappHeaderApp
        message={
          "Hello, I wanted to know more about Offline Prep Coaching Program details. "
        }
                    ...
                    <div className="ply1">
                      <LazyLoadImage
                        ...
                        src={
                          ...
                          "/assets/images/fwg/rtp-5.0-thumbnail-1.webp"
                        }
                      />
                    ...
                    <div className="d-md-block d-none">
                      <div className="course-info">
                        ...
                        <ul className="course-list">
                          {OfflinePrepCoachingProgramData?.info1.map((info) => (
                            <li>
              ...
              <div className="col-lg-5 mb-5 position-relative">
                <div className="black-before-2">
                  <OnlineProgramFormFwg
                    programData={OfflinePrepCoachingProgramData}
                    openForm={openForm}
...
export default OfflinePrepCoachingProgram;
