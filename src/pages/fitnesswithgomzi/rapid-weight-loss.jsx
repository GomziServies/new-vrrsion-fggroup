...
import BlogsRtpOne from "../../components/fwg/blogs";
import OnlineWeightLossRtpOne from "../../components/fwg/online-weight-loss";
import FwgHeader from "../../components/partials/Header/fwgheader";
import { Helmet } from "react-helmet";


function RapidWeightLoss() {
    ...
    return (
        <>
            <Helmet>
                <title>The best weight loss program for fast and lasting results</title>
                <meta name="description" content="Lose weight effectively with the best weight loss program. Achieve fast, lasting results and start your healthy journey today!" />
                <meta name="keyword" content="" />
                <meta property="og:title" content="The best weight loss program for fast and lasting results" />
                <meta property="og:description" content="Lose weight effectively with the best weight loss program. Achieve fast, lasting results and start your healthy journey today!" />
        ...
        !function(f,b,e,v,n,t,s)
            ...
            fbq('init', '522200965970197');
            fbq('track', 'PageView');
      `}
                </script>
                <noscript>
                    {
                        '<img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=522200965970197&ev=PageView&noscript=1" />'
                    }
                </noscript>
            </Helmet>
            ...
            <WhatsappHeaderApp
                message={
                    "Hello, I wanted to know more about Rapid Weight Loss Programs details. "
                }
            ...
            <section style={{ marginTop: "70px" }}>
                <div className="container-fluid p-0">
                    <LazyLoadImage
                        effect="blur"
                        src={process.env.PUBLIC_URL + "/assets/images/img/banner27.webp"}
                    ...
                    <LazyLoadImage
                        effect="blur"
                        src={
                            process.env.PUBLIC_URL + "/assets/images/img/banner-mobile27.webp"
                        }
                            ...
                            <div className="col-md-6 order-md-1 order-2">
                                <div className="design-h1">
                                    <div className="d-none d-md-block">
                                        <span className="px-3 py-2 bg-primary rounded text-white">
                                            Program Features
                                        </span>
                                    </div>
                                    <h1 style={{ color: "#333" }} className="m-0 pt-1 pt-md-3">
                                        Best Nutritionist and Personal Trainer for
                                        <span className="m-0 text-blue-color"> Weight Loss</span>
                                    </h1>
                                </div>
                                <div className="design-describe mt-2">
                                    <div className="logo-program-1">
                                        <div>
                                            <ul className="p-0 new-li news-li">
                                                ...
                                                <li>
                                                    <i className="fas fa-bullhorn"></i> Awareness Program
                                                </li>
                                                <li>
                                    ...
                                    <div className="Digital mt-3 d-block d-md-none">
                                        <div className="d-flex align-items-center">
                                            <h2
                                                className="m-0 h4-fs text-blue-color fs-24"
                                            >
                                                Book Appointment
                                            </h2>
                                        </div>
                                    ...
                                    <div className="mt-3 mt-md-0">
                                        {/* <!-- <a href="#;" className="btn btn-success btn-whats mt-3"
                                            onclick="purchasePlan('61837af8f7accb5ce2db4d82')">Click Here To Purchase</a> --> */}
                                        <Button
                                        ...
                                        <a
                                            ...
                                            className="btn btn-outline-danger ml-2 btn-whats btn-whatss"
                                            target="_blank"
                                            download
                                            rel="noreferrer"
                                        >
                            ...
                            <div className="col-lg-6 mb-md-4 mb-2 mt-4 order-1 order-md-2">
                                <div className="ply1 black-before">
                                    <LazyLoadImage
                                        effect="blur"
                                        className="lazy"
                                        src={process.env.PUBLIC_URL + "/assets/images/RTP-1.0.webp"}
                                        width="100%"
                                        style={{ borderRadius: "10px" }}
                                        alt="how to transform your body in 90 days"
                                    />
                                ...
                                <div className="col-6 text-center">
                                    <div className="achivement-box">
                                        <LazyLoadImage
                                            effect="blur"
                                            src={
                                                process.env.PUBLIC_URL + "/assets/images/icon/fit.webp"
                                            }
                                            className="img-fluid"
                                            alt="Fit"
                                        />
            ...
            <Achievement />
            <OnlineWeightLossRtpOne />
            <Coaches />
            <section className="margintop d-block d-md-none">
                <div className="container-fulid back-inter">
                    <div className="container">
                        <div className="">
                            <div className="row justify-content-center">
                                <div className="col-md-9 col-xl-7 text-center">
                                    <div className="tabata">
                                        <h2 className="h2-fs">International Client</h2>
                                        <p>
                                            Fitness With Gomzi: Our rapid transformation programs have
                                            helped over 1000 international clients achieve their
                                            fitness goals. Tailored to individual needs, our program
                                            is designed for quick results and is led by experienced
                                            trainers and nutritionists. Achieving your desired
                                            physique has never been easier.
                                        </p>
                                        <Link
                                            to="/fitnesswithgomzi/international-clients"
                                            className="btn mb-3"
                                            target="_blank"
                                        >
                                            Know More
                    ...
                    <div className="container blog2 py-5">
                        <div className="covid text-center">
                            <h2 className='h2-fs' style={{ color: "#333" }}>
                                few diet
                                <span className="m-0 text-blue-color"> recipes ideas</span>
                            </h2>
                        </div>
            ...
            <section className="margintop">
                <div className="container-fluid">
                    <div className="container blog2 blogii">
                        <div className="covid text-center">
                            <h2 className='h2-fs' style={{ color: "#333" }}>
                                How Do We{" "}
                                <span className="m-0 text-blue-color"> Help You ?</span>
                            </h2>
                        </div>
                        <div className="thm-bg-clr dector mb-3 mb-md-5"></div>
                        <div className="card border border-info mt-md-5">
                            <div className="card-header border-bottom alert-info border-info">
                                <h2 className="h4-fs">
                                    Responsibility of the nutritionist at Fitness with Gomzi for
                                    weight loss:{" "}
                                </h2>
                            </div>
                            <div className="card-body tabata">
                                <blockquote className="blockquote mb-0">
                                    <ul className="pl-0 pl-sm-4">
                                        <li>Our nutritionist will evaluate your health needs. </li>
                                        <li>
                                            He will analyze your eating habits and suggest necessary
                                            nutrition for your betterment
                                        </li>
                                        <li>
                                            Then He will develop educational resources and determine
                                            the Best Diet Plan For you.
                                        </li>
                                        <li>
                                            He will make adjustments to your diet plans as per your
                                            requirements.
                                        </li>
                                        <li>
                                            Our Nutritionist will monitor your progress periodically.
                                        </li>
                                        <li>
                                            Our FWG team are always connected with you to motivate you
                                            and guide you through your fitness journey.
                                        </li>
                                    </ul>
                                </blockquote>
                            </div>
                        ...
                        <div className="card border border-info mt-5">
                            <div className="card-header border-bottom alert-success border-info">
                                <h2 className="h4-fs">Nutritionists at Fitness with Gomzi offer :</h2>
                            </div>
                            <div className="card-body tabata">
                                <div className="row">
                                    <div className="col-lg-6 order-2 order-lg-1">
                                        <blockquote className="blockquote mb-0">
                                            <h2 className="h5-fs">A Personalized diet plan :</h2>
                                            <p className="text-muted">
                                                Our Nutritionist will provide you with the best diet
                                                plan for fat loss. After discussing your lifestyle
                                                habits and daily routine, our nutritionist will derive a
                                                proper diet chart to fit in your requirements; which
                                                will make it easy for you to follow.
                                            </p>
                                            <h2 className="h5-fs">Fat loss and muscle gain: </h2>
                                            <p className="text-muted">
                                                At FWG, Our dietitians will provide you with the best
                                                diet for your fat-loss and muscle gain. The diet usually
                                                contains low calories but are very rich in nutrition
                                                which will catalyze the process of losing weight and
                                    ...
                                    <div className="col-lg-6 order-1 order-lg-2">
                                        <LazyLoadImage
                                            ...
                                            src={
                                                process.env.PUBLIC_URL +
                                                "/assets/images/img/food-ketos.webp"
                                            }
                                            className="img-fluid"
                                            style={{ borderRadius: "10px" }}
                                            alt="food ketos"
                            ...
                            <div className="card-body tabata">
                                <div className="row">
                                    ...
                                    <div className="col-lg-6">
                                        <blockquote className="blockquote mb-0">
                                            <h2 className="mt-2 mt-md-0 h5-fs">Proper Exercise :</h2>
                                            <p className="text-muted">
                                                Physical exercise plays a crucial role in maintaining
                                                fitness. A balanced nutritious diet with physical
                                                exercise improves the lifestyle of the client. Gomzi
                                                nutritionists give a professional touch in training the
                                                clients to perform the exercise properly. It protects
                                                the patient from joint injuries, irregular heartbeat or
                                                pulse rate, and other adverse effects of improper
                                                exercise.
                                            </p>
                                            <h2 className="h5-fs">Interactive sessions :</h2>
                                            <p className="text-muted">
                                                At Fitness with Gomzi, some interactive sessions are
                                                taken at regular intervals. It redefines the client's
                                                weight and diet plan. It builds confidence and motivates
                                                the client to move toward a healthy life.
                                            </p>
                                        </blockquote>
                                    </div>
                                </div>
                        ...
                        <div className="card border border-info mt-5">
                            <div className="card-header border-bottom alert-primary border-info">
                                <h2 className="h4-fs">Do's and Don'ts :</h2>
                            </div>
                            <div className="card-body tabata">
                                <p>
                                    Studies show that more than 70 percent of clients try to
                                    change their diet plan and make changes in their exercises on
                                    their own for their comfort which gives adverse results.
                                </p>
                                <h2 className="h5-fs">Some Do's and Don'ts are below :</h2>
                                <blockquote className="blockquote mb-0">
                                    <ul className="pl-sm-4 pl-0">
                                        <li>Eat more veggies</li>
                                        <li>Be prepared</li>
                                        <li>Stay positive</li>
                                        <li>Don't give up </li>
                                        <li>Don't over exercise</li>
                                        <li>Don't be afraid of carbohydrates</li>
                                    </ul>
                                </blockquote>
                            </div>
                        </div>
                        <div className="card border border-info mt-5">
                            <div className="card-header border-bottom alert-success border-info">
                                <h2 className="h4-fs">
                                    Fitness with Gomzi provides professional ways for weight loss
                                    :
                                </h2>
                            </div>
                            <div className="card-body tabata">
                                <blockquote className="blockquote mb-0">
                                    <p>
                                        Everybody desires to stay fit and healthy, but with a busy
                                        schedule and an inactive lifestyle, they end up gaining more
                                        weight. FWG is a one stop solution for all your fitness /
                                        weight related problems. Our team of expert nutritionists
                                        will help you in your weight-loss journey and also offers
                                        the best online dietician for losing weight.
                                    </p>
                                </blockquote>
                            </div>
                        </div>
                ...
                <div className="container-fluid">
                    <div className="container">
                        <div className="describe">
                            <h2 className="h1-fs" style={{ color: "#333" }}>
                            ...
                            <p>
                                Wellbeing Educated While Performing An Exercise Increase The
                                Effectiveness Of Your Workout. For Eg: If You Are Performing
                                Squats And Don't Know Which Muscle Will Be Targeted By That
                                Then That Will Be Useless For You Therefore, A Fitness
                                Trainer/fitness Coach For The Gym Is The One Who Guides You On
                                What To Do, How To Do It, And How Much To Do An Exercise So That
                                Your Body Can Give You Optimum Results That Will Help You In
                                Your Transformation. A Fitness Trainer/fitness Coach Will Teach
                                You The Right Posture To Lower The Risk Of Injury, Demonstrate
                                The Exercise And Make Sure Your Routine Is Perfect And You
                                Achieve Your Goal.
                            </p>
                            <p>
                                A Lot Of You May Be Searching For "Personal Trainer Near Me" Or
                                "Gyms Near Me" Or We Can Say "Gyms In Surat" Fitness With Gomzi
                                Is The One-stop Solution For You. Offering You The Best Gym
                                Services With The Professionalized Online Personal Trainer. We
                                Offer Personal Fitness Trainer At Home And Fitness Trainer For
                                Gym, We Are Considered As One Of The Most Elite Gyms In Surat.
                            </p>
                        </div>
                    </div>
                </div>
...
export default RapidWeightLoss;
