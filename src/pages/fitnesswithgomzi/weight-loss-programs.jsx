...
import GlobalJourney from "../../components/fwg/globalJourney";
...
import FitnessGoals from "../../components/fwg/fitness-goals";
import FitnessProgram from "../../components/fwg/fitness-program";
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Control your weight and get healthier today with our different types of fitness transformation programs meeting your specific needs." />
        ...
        <meta property="og:description" content="Control your weight and get healthier today with our different types of fitness transformation programs meeting your specific needs." />
      ...
      />
      <section className="banner" id="fwg-section-1">
          ...
          <div className="row mx-0">
            ...
            <div className="col-md-8 px-0">
              <div className="ml-5">
                ...
                <ul className="banner-cta pl-0 d-md-flex">
                  <li style={{ listStyle: "none" }}>
                    <a href="#explore" className="primary-btn md-btn">
                      Explore More Programs
                    </a>
                  </li>
                  <li className="ml-3" style={{ listStyle: "none" }}>
                    <Link
                      to="/fitnesswithgomzi/fwg-form-page"
                      className="secondary-btn md-btn"
                    >
      ...
      <section className="d-block d-md-none">
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-5 mt-3 order-2 order-md-1 m-hero">
              <div className="forh">
                <h2 className="h2-fs hero">Start Your Fitness Journey Today</h2>
              </div>
              <div className="describe">
                <p className="my-0 ml-0">
                  With our variety of transformation plans specifically designed
                  for people of differnt calibres, age groups and lifestyle
                  choices.
                </p>
              </div>
              <div className="text-center mt-4 mt-md-5">
                {/* <a href="#explore" className="btn w-100 primary-btn mb-3 mb-md-4">Explore More Programs</a> */}
                <Link
                  to="/fitnesswithgomzi/fwg-form-page"
                  className="text-center"
                >
                  <button type="button" className="primary-btn md-btn w-100">
                    Book a consultation now
                  </button>
                </Link>
              </div>
            </div>
            <div className="col-lg-7 col-12 px-0 order-1 order-md-2 text-center">
              <LazyLoadImage
                effect="blur"
                src={process.env.PUBLIC_URL + "/assets/images/icon/fwgmian.jpg"}
                alt="Fitness"
                className="img-fluid"
              />
            </div>
          ...
          <div className="container">
            <div className="group">
              ...
              <div className="descr d-none d-lg-block  pt-2">
                ...
                <p className="mb-3 comfortaa-font">Book a consultation with our experts now to get started</p>
              </div>
              <div className="d-block d-md-none  pt-3">
                <h2 className="h2-fs h1 fs-36">
                  Big changes need baby steps
                </h2>
                <p className="mb-3 comfortaa-font">Book a consultation with our experts now to get started</p>
              </div>
              <div className="mb-4 mt-2 d-block d-lg-none">
                <LazyLoadImage
                  effect="blur"
                  src={
                    process.env.PUBLIC_URL +
                ...
                <div>
                  <form className="row">
                    <div className="col-md-6 mb-3">
                      <label for="txt_form_name" className="form-label">
                        Name:
                      </label>
                      <input
                        type="text"
                    ...
                    <div className="col-md-6 mb-3">
                      <label for="txt_form_email" className="form-label">
                        Email:
                      </label>
                      <input
                        type="email"
                    ...
                    <div className="col-md-6 mb-3">
                      <label for="txt_form_mobile" className="form-label">
                        Phone no:
                      </label>
                      <input
                        type="number"
                    ...
                    <div className="col-md-6 mb-3">
                      <label for="txt_form_gender" className="form-label">
                        Gender:
                      </label>
                      <select
                        className="form-control fr"
                    ...
                    <div className="col-md-6 mb-3">
                      <label for="txt_form_age" className="form-label">
                        Age:
                      </label>
                      <input
                        type="number"
                    ...
                    <div className="col-md-6 mb-3">
                      <label for="txt_form_date" className="form-label">
                        Date:
                      </label>
                      <input
                        type="Date"
      ...
      <section className="margintop mt-5 mb-4">
        <img
          width="100%"
          effect="blur"
          className="img-contain"
          src={process.env.PUBLIC_URL + "/assets/images/fwg/fitness.png"}
          alt="Expert 1"
        />
      </section>
      <FitnessProgram />
        ...
        <div className="container-fluid">
          <div className="container">
            <div className="covid text-center">
              <h2 className='h2-fs' style={{ color: "#333" }}>Follow us on Instagram</h2>
            </div>
            ...
            <div className="text-center mt-5 mt-lg-5">
              <h2 className="d-block d-md-none h6-fs">
              ...
              <h2
                className="d-none d-md-block fs-25"
