...
function DietitianForClinicalIllness() {
    ...
    <>
      <Helmet>
        ...
        !function(f,b,e,v,n,t,s)
            ...
            fbq('init', '656519966066931');
            fbq('track', 'PageView');
      `}
        </script>
        <noscript>
          {
            '<img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=656519966066931&ev=PageView&noscript=1" />'
          }
        </noscript>
      </Helmet>
      <WhatsappHeaderApp
          ...
          <div className="container-fluid p-0">
            <LazyLoadImage
              ...
              src={
                ...
                "/assets/images/fwg/banner-mobile-baroda-3.webp"
              }
            ...
            <LazyLoadImage
              ...
              src={
                process.env.PUBLIC_URL +
                "/assets/images/fwg/banner-mobile-baroda-3-1.webp"
              }
                ...
                <div className="col-md-6 order-md-1 order-2">
                  <div className="design-h1 mt-3">
                    <h1 style={{ color: "#333" }} className="m-0">
                      Best Clinical Illness{" "}
                      <span className="m-0 text-blue-color">Program</span>
                    </h1>
                  </div>
                  <div className="design-describe mt-3">
                    <div className="logo-program-1">
                      <div>
                        <ul className="p-0 new-li news-li">
                          ...
                          <li>
                            <i className="fas fa-tape"></i> Monthly measurement
                          </li>
                          <li>
                            <i className="fas fa-dumbbell"></i> Exercise
                            Consultant Program
                          </li>
                          <li>
                            <i className="fas fa-child"></i> Free Full Body
                            Checkup
                          </li>
                          <li>
                    ...
                    <div className="Digital">
                      <div className="d-flex align-items-center">
                        <div className="d-flex align-items-center">
                          {/* <!-- <h2 className="h4-fs m-0" style="color:#00afef; font-size: 27px;">₹15,300/- + 18% GST</h2> --> */}
                          <h2 className="m-0 h4-fs text-blue-color fs-27">
                  ...
                  <div className="col-lg-6">
                    <div className="describe">
                      <p>
                        ...
                        population of India. And the disease is Fatty Liver,
                        there are lots of reasons for the fatty liver but the
                        main reasons are eating junk foods and drinking alcohol
                        more frequently. Fatty liver occurs when too much fat
                        builds up in liver cells. Although it is normal to have
                        a tiny amount of fat in these cells, the liver is
                        considered fatty if more than 5% of it is fat. If you
                        are suffering ....
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="Info">
                      <div className="tabata farttys">
                        ...
                        <p className="mt-0">
                          ...
                          untreated, it will cause severe liver issues likewise.
                          a person has to remember the causes, symptoms, and
                  ...
                  <div className="card border border-info">
                    ...
                    <div className="card-body">
                      <blockquote className="blockquote mb-0">
                        <p className="mt-3">
                          In medical terms, liver disease is understood as
                          viscus steatosis. The liver is that the second largest
                          organ within the flesh and is to blame for process
                          nutrients from food and drinks you ingest and for
                          filtering out harmful substances from the body. once
                          over 5-10% of the liver is fat, it's thought about to
                          be fatty.
                        </p>
                        <p className="mt-3">
                          <b>
                        ...
                        <p className="mt-3">
                          ...
                          generating its unable to get rid of toxins and turn
                          out gall because it is meant to. If your liver has an
            ...
            <div className="container-fluid">
              <div className="container blog2">
                <div className="describe demoo mt-5">
                  <h2 className="h2-fs text-center text-333-color">
                    <span className="m-0 text-blue-color">Symptoms Of</span>{" "}
                    Liver Disease
                  </h2>
                </div>
                ...
                <div className="row">
                  ...
                  <div className="col-lg-6">
                    <div className="tabata mt-lg-5 mt-2">
                      ...
                      <p className="mt-3">
                        <b>
                          For some, there aren't any noticeable symptoms of
                          liver disease. Regardless, once the symptoms do show
                          up, they include:
                        </b>
                      </p>
                      <p className="mt-3">
                ...
                <div className="tabata mt-3">
                  ...
                  <p className="mt-3 ml-4">
                    <b>
                      Some factors could contribute to the event of liver
                      disease, including:
                    </b>
                  </p>
                  <p className="mt-3"></p>
                  <ul>
                    ...
                    <li>
                      Consuming refined carbs additionally will increase liver
                      fat storage, particularly within the case of rotund
                      people.
                    </li>
                    <li>
                      Due to the high fruit sugar concentration, frequent
                      consumption of honied beverages like soda or energy drinks
                      can even push liver fat accumulation. this can be because
                      of the high fruit sugar concentration.
                    </li>
                    <li>
          ...
          <section className="margintop">
            <div className="container-fluid">
              <div className="covid mb-4 text-center">
                <h2 className="h2-fs">
                  <span className="m-0 text-blue-color">Comments</span>
                </h2>
              </div>
              <div className="thm-bg-clr dector"></div>
              <div className="container">
                <div className="panel blog blog-background">
                    ...
                    <div className="media-block">
                      ...
                      <div className="media-body">
                        <div className="mar-btm">
                          ...
                          <p className="text-muted text-sm">11 months ago</p>
                        </div>
                        <p>
                          Thanks a ton for this video sir as my self was
                          suffering from A Grade fatty liver due to his
                          alcoholic bad habits and after trying many treatments
                          he did don't get any relief but after following your
                          tips & using liver care pack of last 3 months and now
                          my reports are slowly but surely coming good
                        </p>
                        <div className="ml-5">
                          <div className="media-block">
                            <a
                            ...
                            <div className="media-body">
                              ...
                              <p>
                                That's really a great news, just follow the diet
                                and exercise properly and your fatty liver will
                                go away soon.
                              </p>
                            </div>
                          </div>
                  ...
                  <div className="panel-body">
                    <div className="media-block">
                      ...
                      <div className="media-body">
                        ...
                        <p>
                          Thank you so much for explaining and covering
                          everything that's related to fatty liver. Will follow
                          your instructions for 30 days and send you feedback
                        </p>
                        <div className="ml-5">
                          <div className="media-block">
                            <a
                            ...
                            <div className="media-body">
                              ...
                              <p>
                                Yes, follow these instructions for 30 days
                                properly and you will definitely see drastic
                                results.
                              </p>
                            </div>
                          </div>
                  ...
                  <div className="panel-body">
                    <div className="media-block">
                      ...
                      <div className="media-body">
                        ...
                        <p>
                          Thank you sir for the great information. I am
                          diagnosed fatty liver grade 2, yesterday. I am very
                          scared. My SGPT is 91 and SGOT is 50. What should I do
                          so that it can be reverse? I started to eat healthy
                          fruits and vegetables. Eat less healthy. Early morning
                          walking and running upto 5km.
                        </p>
                        <div className="ml-5">
                          <div className="media-block">
                            <a
                            ...
                            <div className="media-body">
                              ...
                              <p>
                                That really a great start, but if you want to
                                reverse your fatty liver disease completely, you
                                can follow the instructions I have provided in
                                this video for 30 days and you will see drastic
                                results in your SGPT & SGOT report.
                              </p>
                            </div>
                          </div>
                        </div>
                    ...
                    <div className="col-lg-6">
                      <div className="describe">
                        <p>
                          ...
                          Functions And Conjointly Flushes Out Toxins And Helps
                          In Metabolism. Taking Care Of The Liver Becomes Simple
                          After You Build A Healthy Mode Of Your Habit.
                          Following A Healthy Mode Keeps You Match And
                          Conjointly Keeps Your Liver Removed From Diseases.
                          Everything That You Just Consume, As Well As Medicines
                          And Alcohol, Is Filtered By Your Liver. Hence...
                        </p>
                      </div>
                    </div>
                    <div className="col-lg-6 d-none d-lg-block mt-4 mt-md-0">
                    ...
                    <div className="col-lg-12">
                      <div className="tabata mt-5">
                        ...
                        <p className="mt-3">
                          ...
                          conjointly keeps your liver removed from diseases.
                          Everything that you just consume, as well as medicines
                          and alcohol, is filtered by your liver. Hence, it's a
                          crucial organ for the body to perform properly.
                          hindrance is usually higher than cure, therefore
                          taking care of your liver will assist you in avoiding
                          treatments and complications. SGPT & SGOT square
                          measure the enzymes made by your liver & its cells.
                          High SGPT/SGOT is a sign of liver cell injury, they
                          have to be detected through regular health checkups.
                        </p>
                        <p className="mt-3">
                        ...
                        <p className="mt-3">
                          Keep a tab on everything you consume increase vitamin
                          D in your diet: vitamin D helps in preventing harm to
                          your liver and reducing SGPT levels. Oranges, soy
                          milk, mushrooms, apples, eggs, fortified cereals,
                          tofu, dairy farm merchandise, cod liver oil, oysters,
                          and inexperienced bifoliate vegetables square measure
                          ...
                          overwhelming an excessive amount of salt and
                          sodium-rich foods.
                        </p>
                        <p className="mt-3">
                          ...
                          pepper square measure sensible for your liver's
                          health.
                        </p>
                        <p className="mt-3">
                        ...
                        <p className="mt-3">
                          Restrict alcoholic beverages & quit smoking: Alcohol
                          is that the most harmful factor for the liver.
                          overwhelming vasoconstrictor of any kind will absorb
                          toxins like vasoconstrictor and ammonia into your
                          blood. The liver features a powerful time filtering
                          them and therefore turning into weak.
                        </p>
                        <p className="mt-3">
                        ...
                        <p className="mt-3">
                          Regular exercise is imperative for maintaining a
                          healthy liver. It reduces the strain on your liver and
                          will increase your energy levels. Exercise conjointly
                          aids in preventing avoirdupois that may be a risk
                          issue for liver diseases.
                        </p>
                      </div>
                      <div className="tabata mt-5">
                          ...
                          <div className="card-body">
                            <blockquote className="blockquote mb-0">
                              <p className="mt-3">
                                ...
                                time you get to understand concerning any harm
                                to your liver, it's already too late. It ends up
                                in high treatment prices and several cases
                                life-fatalities.
                              </p>
                              <p className="mt-3">
                                SGPT & SGOT square measure the enzymes made by
                                the liver & by different kinds of cells. High
                                SGPT or SGOT is typically a sign of liver cell
                                injury.
                              </p>
                              <p className="mt-3">
                                Adopting healthy modifications besides a
                                specially designed diet for healthy liver is
                                that the best resolution to the question of the
                                way to lower SGPT & SGOT.
                              </p>
                              <p className="mt-3">
                                This same diet is often the solution if you're
                                curious about the way to lower SGOT. drill on
                                top of mentioned sensible habits to guard your
                                liver against being broken.
                              </p>
                              <p className="mt-3">
                                However, obtaining your liver medical checkup
                                done often helps in avoiding health
                                complications. Get your check done by a sure
                                care organization.
                              </p>
                              <p className="mt-3">
                                The bottom line of a healthy body may be a
                                healthy liver. The liver assists in a very heap
                                of body functions and conjointly flushes out
                                toxins and helps in metabolism. Taking care of
                                the liver becomes simple after you build a
                                healthy mode of your habit. Following a healthy
                                mode keeps you match and conjointly keeps your
                                liver removed from diseases. Everything that you
                                just consume, as well as medicines and alcohol,
                                is filtered by your liver.
                              </p>
                              <p className="mt-3">
                                The liver will regenerate itself once it's
                                healing from a malady. However, if it suffers a
                                major injury, it loses its ability to
                                regenerate, and might additionally end in liver
                                failure. Preventive health checkups facilitate
                                in catching such complications at associate
                                early stage, once there's an occasion for
                                treatment and saving a life.
                              </p>
                              <p className="mt-3">
                                <b>
                                  Knowing the progression of the disease will
                                  assist you in understanding why preventive
                              ...
                              <p className="mt-3">
                                <ul>
                                  <li>
                                    ...
                                    why preventive screening tests area unit
                                    quite essential.
                                  </li>
                                  <li>
                                  ...
                                  <li>
                                    Chronic liver disease/Cirrhosis - Severe
                                    sort of pathology that may more cause cancer
                                    of the liver.
                                  </li>
                                  <li>
                                    Liver Cancer - Early detection will aid in
                                    forming a treatment arrangement that helps
                                    to get over cancer of the liver.
                                  </li>
                                  <li>
                ...
                <div className="d-flex justify-content-center">
                  <div className="col-lg-10">
                    <div className="tabata mt-4">
                      <h2 className="h2-fs">
                        Recovered Patients from SGPT SGOT
                      </h2>
                      ...
                      <blockquote className="blockquote mb-0">
                        <p className="mt-3">
                          <ul>
                            ...
                            <li>
                              Those who have a case history of the disease.
                            </li>
                            <li>
                ...
                <div className="tabata mt-5">
                  <div className="card border border-success">
                    ...
                    <div className="card-body">
                      <blockquote className="blockquote mb-0">
                        <p className="mt-3">
                          SGPT is a gift preponderantly within the liver and
                          once it's created in excess, it leaks into the blood.
                          the traditional vary of SGPT is regarding seven to
                          fifty-six units/liter of body fluid. a really high
                          level of SGPT within the blood indicates some injury
                          or problems associated with the liver.
                        </p>
                      </blockquote>
                    </div>
                  </div>
                      ...
                      <blockquote className="blockquote mb-0">
                        ...
                        <p className="mt-3">
                          <ul>
                            ...
                            <li>kidney malady</li>
                            <li>
                              liver injury from toxins like excess alcohol
                            </li>
                        ...
                        <p className="mt-3">
                          <ul>
                            ...
                            <li>
                              ...
                              attributable to prolonged inflammation of the
                              liver)
                            </li>
                            <li>liver injury from alcohol</li>
                            <li>
                              hemochromatosis (a genetic condition caused
                              because of long-standing liver damage), and
                              reduced blood flow to the liver (from shock or
                              heart failure).
                            </li>
                          </ul>
                        </p>
                    ...
                    <div className="media-block">
                      ...
                      <div className="media-body">
                        <div className="mar-btm">
                          ...
                          <p className="text-muted text-sm">1 month ago</p>
                        </div>
                        <p>
                          Sir I am 9 months pregnant. My SGPT level has
                          increased to 277 U / L. Lots of skin allergies. Could
                          it do any harm to my unborn child? What can I do in
                          this situation? I am speaking from Bangladesh. Please
                          help me....
                        </p>
                        <div className="ml-5">
                          <div className="media-block">
                            ...
                            <div className="media-body">
                              ...
                              <p>
                                In third trimester SGPT levels rise is dolmen so
                                don't worry consult your gynaecologist
                              </p>
                            </div>
                          </div>
                        </div>
                  ...
                  <div className="panel-body">
                    <div className="media-block">
                      ...
                      <div className="media-body">
                        ...
                        <p>
                          hello sir, 2 years back i got grade 2 fatty liver,
                          took 6 months medicine n then i m fine, but again for
                          last 2 months back i got my cholesterol test every
                          thing was ups n down, doctor didn't give medicine only
                          said do exercise n all will b fined, but for last 20
                          days m feeling nausea, appetite problem, I got my "
                          LFT" Report SGPT-52, SGOT-46, n ultrasound report...
                        </p>
                        <div className="ml-5">
                          <div className="media-block">
                            <a
                    ...
                    <div className="media-block">
                      ...
                      <div className="media-body">
                        <div className="mar-btm">
                          ...
                          <p className="text-muted text-sm">2 months ago</p>
                        </div>
                        <p>
                          Thanks a lot for your genuine suggestion, i am also
                          running with SGOT and SGPT issue and after watching
                          this video i immediately throw out the Tabaco and
                          trying not to take again and will follow your
                          suggested diet, Thanks again........
                        </p>
                        <div className="ml-5">
                          <div className="media-block">
                            <a
                            ...
                            <div className="media-body">
                              ...
                              <p>
                                It's a pleasure for me that you have changed
                                don't start again
                              </p>
                            </div>
                          </div>
                    ...
                    <div className="media-block">
                      ...
                      <div className="media-body">
                        <div className="mar-btm">
                          ...
                          <p className="text-muted text-sm">3 months ago</p>
                        </div>
                        <p>
                          sgot (41) & sgot(32) are normal but ratio of sgot/sgpt
                          is 1.28. Is that dangerous or liver cirroshis or
                          gallbladder problem ???
                        </p>
                        <div className="ml-5">
                          <div className="media-block">
                            ...
                            <div className="media-body">
                              ...
                              <p>
                                If your ratios are higher then its just the
                                beginning of liver damage. But it can easily
                                cured by Healthy Balanced diet
                              </p>
                            </div>
                          </div>
                        </div>
                  ...
                  <div className="panel-body">
                    <div className="media-block">
                      ...
                      <div className="media-body">
                        ...
                        <p>
                          sir sgpt -76 h <br /> sgot -116 h <br />
                          report me or me alcohol or kuc b nsa nhi krta mere fat
                          hai thodi to ky muje tlb soft LSF or baki medicine
                          lena chiye 15 din k liye likhi h doctor's ne
                        </p>
                        <div className="ml-5">
                          <div className="media-block">
                            <a
                            ...
                            <div className="media-body">
                              ...
                              <p>
                                Ha 15 days course karo but diet bhi karo SGPT
                                SGOT ke liye
                              </p>
                            </div>
                          </div>
                    ...
                    <div className="media-block">
                      ...
                      <div className="media-body">
                        <div className="mar-btm">
                          ...
                          <p className="text-muted text-sm">4 months ago</p>
                        </div>
                        <p>
                          I m taking "repatin tab" mfg by mankind farma...in the
                          past I was suffered from high sgpt sgot across 1000
                          than when I take rehaptin tab 1 week It reduce less
                          than 100...also life style change must important
                        </p>
                        ...
                        <div className="ml-5">
                          <div className="media-block">
                            ...
                            <div className="media-body">
                              ...
                              <p>
                                If it reduce in a week and this high means you
                                have any infection so from medicine it come down
                                it always is acute
                                <br />
                                If someone has due to lifestyle it takes time to
                                come down
                              </p>
                            </div>
                          </div>
              ...
              <div className="container blog2">
                      ...
                      <div className="col-lg-6">
                        <div className="describe">
                          <p className="mt-3 mt-lg-0">
                            Severe knee pain can occur in people of all ages for
                            a variety of reasons. Knowing the cause of severe
                            knee pain can help a person seek treatment, relieve
                            ...
                            as walking, running, crouching, jumping, and
                            turning.
                          </p>
                        </div>
                      </div>
                ...
                <div className="row align-items-center mt-md-5 mt-3">
                  ...
                  <div className="col-md-12 mt-4 ml-3">
                    <div className="tabata farttys">
                      <p className="">
                        Any of these parts are susceptible to disease and
                        injury, which can lead to severe knee pain.
                      </p>
                      ...
                      <p>
                        ...
                        fractured patella may also occur, causing intense pain
                        and swelling.
                      </p>
                      <p>
                      ...
                      <p className="mt-3">
                        ...
                        inflammation and swelling of your tendons. This
                      ...
                      <p>
                        ...
                        Runner's knee can also cause the knee to crack and
                        crush.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="card border border-info">
                    ...
                    <div className="card-body">
                      <blockquote className="blockquote mb-0">
                        ...
                        <p>
                          Other times, the cause of the injury is less
                          traumatic. For example, hitting the knee at the wrong
                          angle can tear the ACL.
                        </p>
                        <p>
                  ...
                  <div className="card border border-info">
                    ...
                    <div className="card-body">
                      <blockquote className="blockquote mb-0">
                        ...
                        <p>
                          Pain, tenderness, and inflammation of the knee are
                          signs that OA is starting to develop. In most cases,
                          knee pain does not appear suddenly. It is more likely
                          to cause a gradually increasing level of pain.
                        </p>
                        <p>
                          While OA can only affect one knee, it is more likely
                          to damage both knees.
                        </p>
                        ...
                        <p>
                          Repeated bending of the knees or bleeding into the
                          bursa can cause the sudden onset of bursitis symptoms.
                          Knee bursitis is not one of the most common places for
                          this condition to occur, but it is not rare.
                        </p>
                        <p>
                        ...
                        <p>
                          ...
                          This condition tends to affect only one knee at a
                          time.
                        </p>
                        <h2 className="h4-fs my-4">Infectious arthritis</h2>
                        <p>
                          Infectious arthritis is an acute form of arthritis
                          that develops from the infected fluid surrounding your
                          joint. If left untreated, the fluid can become septic.
                        </p>
                        <p>
                        ...
                        <p>
                          ...
                          immune system, you may increase your risk of
                    ...
                    <div className="media-block">
                      ...
                      <div className="media-body">
                        <div className="mar-btm">
                          ...
                          <p className="text-muted text-sm">1 year ago</p>
                        </div>
                        <p>
                          Thank you for this useful information...what we do to
                          recover this pain?...I'm waiting for your next
                          video...👍👍👍
                        </p>
                        <div className="ml-5">
                          <div className="media-block">
                            ...
                            <div className="media-body">
                              ...
                              <p>Thank you Nancy for this wonderful comment.</p>
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              <div className="row align-items-center mt-md-5 mt-3">
                ...
                <div className="col-lg-12 pl-4 pl-md-5">
                  <div className="tabata">
                    <h2 className="h2-fs mt-4 h5-fs">
                      If your ulcer perforates (tears open), it becomes a
                      bleeding ulcer. This can cause the following symptoms:
                    </h2>
                    <ul className="ul-sp pl-3">
                      <li>Nausea</li>
                    ...
                    <p className="mt-3">
                      ...
                      It is a bacterial infection. Acids from the foods we eat
                      can make pain and discomfort worse. Long-term use of
                      aspirin or anti-inflammatory drugs (ibuprofen) is also a
                      common cause of ulcers. Stress and spicy foods can make
                      the ulcer worse.
                    </p>
                    <p className="mt-3">
                      The ulcer diet is meant to help reduce the pain and
                      irritation that comes from a peptic ulcer, a painful ulcer
                      on the lining of the stomach, esophagus, or small
                      intestine.
                    </p>
                    <p className="mt-3">
                      Food or drink does not cause or heal ulcers. However, some
                      foods help repair damaged tissue, while others irritate
                      your ulcer and compromise the natural protective lining of
                    ...
                    <ul className="ul-sp pl-3">
                      <li>
                        Correct the nutritional deficiencies that are
                        contributing to your symptoms
                      </li>
                      <li>
                        Provide the protein and other nutrients your body needs
                        to heal
                      </li>
                      <li>
                    ...
                    <p className="mt-3">
                      ...
                      damage the lining of the digestive tract. Others are
                      caused by a bacterial infection known as Helicobacter
                      pylori. The ulcer diet adds foods with antibacterial
                      properties and compounds that promote healing in both
                      cases.
                    </p>
                  </div>
                </div>
                ...
                <div className="card border border-info">
                  ...
                  <div className="card-body">
                    <blockquote className="blockquote mb-0">
                      ...
                      <p className="mt-3">
                        These develop on the inside lining of the stomach and
                        the upper portion of the small intestine or esophagus.
                        They form when digestive juices damage the lining of the
                      ...
                      <p className="mt-3">
                        ...
                        ankle, feet, toes, and heels. They develop from damage
                        to blood vessels due to insufficient blood flow to the
                        tissue. Arterial ulcers appear red, yellow, or black
                        with hairless skin and leg pain.
                      </p>
                      <h2 className="mt-4 h5-fs">VENOUS ULCERS:</h2>
                      <p className="mt-3">
                        It is the most common type of leg ulcer and often forms
                        on the leg, below the knee, and on the inside of the
                        ankle. They occur as a result of damaged veins that are
                        caused by insufficient blood flow back to the heart. A
                        person may also have inflammation, swelling, itchy skin,
                        scabs, and a discharge.
                      </p>
                      <h2 className="mt-4 h5-fs">MOUTH ULCER:</h2>
                      <p className="mt-3">
                        These are small sores or lesions that develop in the
                        mouth or at the base of the gums. They are also known as
                        canker sores. Mouth ulcers are caused by biting the
                        inside of the face, harsh brushing, food allergies,
                        hormonal changes, vitamin deficiencies, bacterial
                        infections, and other serious illnesses.
                      </p>
                      <h2 className="mt-4 h5-fs">GENITAL ULCER:</h2>
                      <p className="mt-3">
                        These develop on the genitals including the vagina,
                        penis, anus, or surrounding areas. Genital ulcers
                        usually occur as a result of trauma, inflammatory
                        conditions, sexually transmitted infections, or allergic
                        reactions to skin care products. They are accompanied by
                        a rash, pain, itching, swelling of the nodes in the
                        groin, and fever.
                      </p>
                    </blockquote>
                  </div>
                  ...
                  <div className="panel-body">
                    <div className="media-block">
                      ...
                      <div className="media-body">
                        ...
                        <p>
                          Next Make video recordings pregnancy diet, what should
                          eat or not eat in india it's big question for pregnant
                          women and all family members gives their review but
                          not true ,proper guidance by any one. In india people
                          say this u can't eat, it causes miscarriage, this u
                          can't eat actually no one can give proper knowledge.
                        </p>
...
export default DietitianForClinicalIllness;
