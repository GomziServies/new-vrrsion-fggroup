  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://fggroup.in/book/injury-rehab" />
          ...
          <div className="container">
            <div className="row">
              <SingleBookPhotoSection
                ...
                englishbook={InjuryRehabBookData.englishbookImg}
              />
              <div className="col-lg-6 w" id="upforebook">
                <BookForm
                  booksData={InjuryRehabBookData}
                  ...
                  prizes={399}
                  BuyButton={InjuryRehabBookData.BuyButton}
                />
              </div>
            </div>
          </div>
      ...
      <ReviewSection book_id="61e9fe3e0c90317bf00039c9" />
      <section className="">
        <div className="container-fluid">
