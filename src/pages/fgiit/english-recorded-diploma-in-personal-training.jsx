...
function EnglishRecordedDiplomaInPersonalTraining() {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:title" content="Diploma in Personal Training Course: Become Trainer" />
        <meta property="og:description" content="Unlock your potential with FG Group's Diploma in Personal Training Course for just $9. This comprehensive 3-month program covers everything from human anatomy to dietetics, including practical exercise sessions and TRX workouts. Get expert tutoring, enjoy recorded lectures, e-books, and secure your job with our placement support. Register now to start your journey as a certified personal trainer." />
        <meta property="og:image" content="https://fggroup.in/assets/images/logo/fg_group.webp" />
        <meta property="og:url" content="https://fggroup.in/fgiit/english-recorded-diploma-in-personal-training" />
                ...
                <div className="ply1">
                  <LazyLoadImage
                    ...
                    src={
                      ...
                      "/assets/images/fgiit/CPT-thumbnail.webp"
                    }
                  />
                </div>
              </div>
                ...
                <div className="">
                  ...
                  <div className="mb-3 d-none d-xl-block read-more-span">
                    <span className="d-none d-xl-block mb-0 new-span">
                      This Course Helps You To Become Certified Personal Trainer
                      Which Every Client Wants. A Personal Trainer Creates
                      One-On-One Fitness Programs For Their Clients, Clients,
                      Motivating, And Guiding Them To Achieve Their Goals.
                      {showMore ? (
                        <span className="m-0">
                          Clients May Wish To Lose Weight Or Gain Muscle, And As
                          A Personal Trainer, You'll Instruct And Assist Them
                          With Exercising Appropriately Utilizing Exercises And
                          Explicit Plans.
                        </span>
                      ) : (
                        <span id="dotsx">...</span>
                  ...
                  <div>
                    ...
                    <p className="new-price pb-2">
                      $41/-<span>Include All Taxes</span>
                    </p>
                  </div>
                  <Button
                    className="btn btn-started mt-2 w-100"
                    style={{ backgroundColor: "#00afef" }}
                    onClick={() => handleOrder("65b80d6003257986161d09df")}
                    id="btn_purchase_6010e9f3eb38ac0a706af298"
                  >
                    Enroll Now
                  </Button>
                  <WhatsAppAnchor
                    message="Hello, I wanted to know more about Diploma In Personal Training Course."
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-4 col-md-6 mt-3 ">
              <div
                className="tabata blog2 imgty text-center"
            ...
            <div className="col-lg-4 col-md-6 mt-3 position-relative">
              ...
              >
                <LazyLoadImage
                  effect="blur"
                  src={
                    process.env.PUBLIC_URL + "/assets/images/img/sending.webp"
                  }
                  alt="FG Group"
                />
                <h2 className="h5-fs mt-0 mb-0">Get A Receipt And App Id Password</h2>
              </div>
            </div>
            <div className="col-lg-4 col-md-6 mt-3 position-relative">
              <div
            ...
            <div className="col-lg-4 col-md-6 mt-3 position-relative">
              ...
              >
                <LazyLoadImage
                  effect="blur"
                  src={
                    process.env.PUBLIC_URL + "/assets/images/img/open-book.webp"
                  }
                  alt="FG Group"
                />
            ...
            <div className="col-lg-4 col-md-6 mt-3 position-relative">
              ...
              >
                <LazyLoadImage
                  ...
                  alt="FG Group"
                />
                <h2 className="h5-fs mt-3">Give Exam And Project Over App</h2>
              </div>
            </div>
            <div className="col-lg-4 col-md-6 mt-3 position-relative">
              <div
      ...
      <section className="margintop">
        <div className="container-fluid">
          <div className="container">
            ...
            <div className="Info">
              <h2 className="mt-0 h2-fs">Course Info</h2>
            </div>
            <div className="Grocery1">
              <p>
                This course helps you to become certified personal trainer which
                every client wants. A personal trainer creates one-on-one
                fitness programs for their clients, motivating, and guiding them
                to achieve their goals.
                <br />
                <br /> Clients may wish to lose weight or gain muscle, and as a
                personal trainer, you'll instruct and assist them with
                exercising appropriately utilizing exercises and explicit plans.
                <br />
                <br /> Our personal training courses allow you to start your
                career &amp; advance through new CPT and CNC and{" "}
                <Link
              ...
              <div className="row new-li">
                <div className="col-md-6">
                  <ul>
                    <li><i className="fas fa-check-circle"></i>Human Anatomy</li>
                    <li><i className="fas fa-check-circle"></i>Human Physiology</li>
                    <li><i className="fas fa-check-circle"></i>Movements</li>
                    <li><i className="fas fa-check-circle"></i>Human Kinesiology</li>
                    <li><i className="fas fa-check-circle"></i>Muscle and exercise</li>
                    <li><i className="fas fa-check-circle"></i>Practical exercise sessions</li>
                    <li><i className="fas fa-check-circle"></i>Scheduling of exercise</li>
                    <li><i className="fas fa-check-circle"></i>Differ energy system</li>
                    <li><i className="fas fa-check-circle"></i>Types of Grips in exercises</li>
                    <li><i className="fas fa-check-circle"></i>Fundamentals of meal planning</li>
                    <li><i className="fas fa-check-circle"></i>Biomechanical implementation</li>
                  </ul>
                </div>
                <div className="col-md-6">
                  <ul>
                    <li><i className="fas fa-check-circle"></i>Principles of Exercises</li>
                    <li><i className="fas fa-check-circle"></i>Client responsibilities</li>
                    <li><i className="fas fa-check-circle"></i>Types of Bars</li>
                    <li><i className="fas fa-check-circle"></i>Functional Training</li>
                    <li><i className="fas fa-check-circle"></i>Posture Analysis and it's exercise prescription</li>
                    <li><i className="fas fa-check-circle"></i>Injuries</li>
                    <li><i className="fas fa-check-circle"></i>Sport specific training</li>
                    <li><i className="fas fa-check-circle"></i>TRX Workout</li>
                    <li><i className="fas fa-check-circle"></i>Anabolic Androgenic Steroids</li>
                    <li><i className="fas fa-check-circle"></i>Basics Of Dietetics</li>
                    <li><i className="fas fa-check-circle"></i>Job placement &amp; Interview training</li>
                  </ul>
                </div>
              </div>
            </div>
            <div className="Info">
              <h2 className="mt-3 h2-fs">Course Include</h2>
            </div>
            <div className="row">
              <div className="col-lg-4 col-md-6 mt-3 position-relative">
                <div
                        ...
                        <div className="item mx-md-3">
                          <div className="d-none d-md-block">
                            <iframe
                              width="560"
                              height="315"
                              src="https://www.youtube.com/embed/wnOMbs4F5vQ?si=zD1LuB__LjKDrTUP"
                        ...
                        <div className="item mx-md-3">
                          <div className="d-none d-md-block">
                            <iframe
                              width="560"
                              height="315"
                              src="https://www.youtube.com/embed/_itwoHP2dWA?si=XzCqbG0vaLc_KDMo"
                              title="YouTube video player"
                              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                              allowFullScreen
                            ></iframe>
                        ...
                        <div className="item mx-md-3">
                          <div className="d-none d-md-block">
                            <iframe
                              width="560"
                              height="315"
                              src="https://www.youtube.com/embed/EeQBTaMjqJQ?si=vNFyWaHmNBPqnoMM"
                              title="YouTube video player"
                              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                              allowFullScreen
                            ></iframe>
          ...
          <div className="container">
            ...
            <div className="row mt-4 align-items-center">
              ...
              <div className="col-lg-6">
                <div className="text-center">
                  <h2 className="h4-fs">DPT Demo Certificate</h2>
                  <img
                    className="lazy"
                    src={
                      process.env.PUBLIC_URL +
                      "/assets/images/certificate/english-course-dpt.webp"
                    }
                    width="80%"
      ...
      <CourseReviewSection course_id="65b80d6003257986161d09df" />
...
export default EnglishRecordedDiplomaInPersonalTraining;
