...
import { OnlineMixMartialArtsWorkshopCourseData } from "../../components/online-course/OnlineCourseDataLoader";
import { Helmet } from "react-helmet";
import { Link } from "react-router-dom";

function OnlineMartialArtsWorkshop() {
  ...
  const faqItems = [
    {
      ...
      answer:
        "Yes, this workshop is designed for all levels, including beginners. The techniques are taught progressively, allowing participants to learn at their own pace.",
    },
    {
      question: "Do I need any equipment for the workshop?",
      answer:
        "No specific equipment is required to participate in the workshop. However, a basic setup like gloves or a punching bag can enhance the learning experience, especially during striking drills.",
    },
    {
      question: "Will I learn both striking and grappling techniques?",
      answer:
        "Yes, this workshop covers a variety of martial arts techniques, including striking (punches and kicks) and grappling (takedowns and submissions), ensuring a comprehensive approach to MMA.",
    },
    {
      question: "Can this course help with self-defense?",
      answer:
        "Absolutely. The workshop incorporates essential self-defense techniques, such as blocking, evasion, and escape methods, to help you protect yourself in real-life scenarios.",
    },
    {
      question: "Will I receive a certificate after the workshop?",
      answer:
        "Yes, participants will receive a certificate of completion from FGIIT once the workshop is successfully finished.",
    },
    {
      question: "What if I miss a live session?",
      answer:
        "All live sessions will be recorded, so you can review them at your convenience. The recordings will be accessible throughout the duration of the course.",
    },
    {
      question: "How do sparring sessions work in an online format?",
      answer:
        "In the online format, sparring techniques are demonstrated, and participants can practice them with a partner or use shadow sparring methods to improve timing and reflexes. Feedback is provided during live sessions.",
    },
    {
      question: "Is there mentorship and ongoing support after the workshop?",
      answer:
        "Yes, live support and mentorship are available throughout the workshop. Participants also have access to team chat for additional guidance and post-workshop queries.",
    },
    {
      question: "How does MMA help with fitness?",
      answer:
        "MMA is an excellent way to improve overall fitness. It enhances cardiovascular endurance, strength, flexibility, and coordination while burning calories and building lean muscle.",
    },
    {
      question:
        "Are the grappling and self-defense techniques practical for real-life situations?",
      answer:
        "Yes, the grappling and self-defense techniques taught in this workshop are designed to be practical and effective in real-world situations, helping you protect yourself in a variety of scenarios.",
    },
  ];
  ...
  const reviewses = [
    {
      ...
      stars: 5,
      review:
        "The Martial Arts Workshop was an incredible experience! The online format made it easy to learn the basics, and the instructors were top-notch.",
    ...
    },
    {
      ...
      stars: 5,
      review:
        "FGIIT's online martial arts workshop is perfect for anyone looking to get fit and learn self-defense. The sessions were well-organized and fun!",
    ...
    },
    {
      ...
      stars: 5,
      review:
        "Really enjoyed the martial arts workshop! The trainers were highly skilled, and I learned a lot. Great way to stay active and improve focus from home.",
    ...
    },
    {
      ...
      stars: 5,
      review:
        "The martial arts workshop at FGIIT was a great mix of fitness and self-defense. The online classes were engaging, and the instructors were super motivating!",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:title" content="Online Mix Martial Arts Workshop" />
        <meta property="og:description" content="Join our Online Mix Martial Arts Workshop to master self-defense, discipline, and physical fitness. Learn from top instructors and elevate your martial arts skills from the comfort of your home." />
        <meta property="og:image" content="https://fggroup.in/assets/images/logo/fg_group.webp" />
        <meta property="og:url" content="https://fggroup.in/fgiit/online-martial-arts-workshop" />
          ...
          <div className="container">
            <div className="row">
                    ...
                    <div>
                      <LazyLoadImage
                        ...
                        src={
                          ...
                          "/assets/images/fgiit/mix-new.webp"
                        }
                      />
                    </div>
                    <div className="d-md-block d-none">
                      <div className="course-info">
                        ...
                        <ul className="course-list">
                          {OnlineMixMartialArtsWorkshopCourseData?.info ? (
                            <>
                              <li>
                                <i className="fas fa-clock"></i>
                                {OnlineMixMartialArtsWorkshopCourseData.info[0]}
                              </li>
                              <li>
                                <i className="fas fa-chalkboard-teacher"></i>
                                {OnlineMixMartialArtsWorkshopCourseData.info[1]}
                              </li>
                              <li>
                                <i className="fas fa-video"></i>
                                {OnlineMixMartialArtsWorkshopCourseData.info[2]}
                              </li>
                              <li>
                                <i className="fas fa-file-signature"></i>
                                {OnlineMixMartialArtsWorkshopCourseData.info[3]}
                              </li>
                            </>
                          ) : (
                            <>
              ...
              <div className="col-lg-5 px-md-0">
                <OnlineCourseForm
                  courseData={OnlineMixMartialArtsWorkshopCourseData}
                  openForm={openForm}
                  whatsappMessage="Hello, I wanted to know more about the Online Mix Martial Arts Workshop."
                />
              </div>
            </div>
          </div>
                    ...
                    <div className="mb-4 d-flex align-items-center justify-content-center flex-column flex-md-row">
                      <div className="col-md-6">
                        ...
                        <p className="text-muted">
                          This module provides an overview of Mixed Martial Arts
                          (MMA) and its various disciplines, including striking,
                          grappling, and self-defense. You'll learn about the
                          evolution of martial arts, the principles behind MMA,
                          and how it combines different fighting styles such as
                          boxing, Muay Thai, Brazilian Jiu-Jitsu, and wrestling.
                          <div className="row">
                            <ul className="col-md-6 p-3 mt-2">
                              <li className="list-unstyled text-dark">
                                <b>Basic Stances and Footwork</b>
                              </li>
                              <li className="list-unstyled text-dark">
                                <b>Hand Techniques</b>
                              </li>
                              <li className="list-unstyled text-dark">
                                <b>Kicking Techniques</b>
                              </li>
                              <li className="list-unstyled text-dark">
                                <b>Blocking and Defense</b>
                              </li>
                            </ul>
                            <ul className="col-md-6 p-3 mt-2">
                              <li className="list-unstyled text-dark">
                                <b>Basic Forms or Katas</b>
                              </li>
                              <li className="list-unstyled text-dark">
                                <b>Sparring Fundamentals</b>
                              </li>
                              <li className="list-unstyled text-dark">
                                <b>Grappling and Self-Defense</b>
                              </li>
                            </ul>
                          </div>
                        </p>
                    ...
                    <div>
                      ...
                      <p className="text-muted">
                        ...
                        {showMore[1] ? (
                          <>
                            grappling, and self-defense. You'll learn about the
                            evolution of martial arts, the principles behind
                            MMA, and how it combines different fighting styles
                            such as boxing, Muay Thai, Brazilian Jiu-Jitsu, and
                            wrestling.
                            <div className="row">
                              <ul className="col-md-6 p-2 mt-2">
                                <li className="list-unstyled text-dark">
                                  <b>Basic Stances and Footwork</b>
                                </li>
                                <li className="list-unstyled text-dark">
      ...
      <CourseReviewSection course_id="6509b66d1cdc4887d6951e76" />
...
export default OnlineMartialArtsWorkshop;
