...
function EnglishFunctionalTrainingWorkshop() {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:title" content="Online Functional Training Workshop - Fitness Expertise" />
        <meta property="og:description" content="Join FG Group's Online Functional Training Workshop to master the art of functional exercise. Discover the science behind effective exercise design for upper and lower body, optimize warm-ups, and learn fat loss and muscle building principles. This 2-day workshop includes live Zoom classes, e-books, and more. Perfect for fitness enthusiasts and professionals looking to expand their skills." />
        <meta property="og:image" content="https://fggroup.in/assets/images/logo/fg_group.webp" />
        <meta property="og:url" content="https://fggroup.in/fgiit/english-functional-training-workshop" />
                ...
                <div className="ply1">
                  <LazyLoadImage
                    ...
                    src={
                      ...
                      "/assets/images/fgiit/Functional-Training-Workshop.webp"
                    }
                  />
                </div>
              </div>
              <div className="col-lg-5 px-md-0">
                <div className="">
                  <div className="new-h3">
                    <h1 className="ml-0">Functional Training Workshop</h1>
                  </div>
                  <div className="mb-3 d-none d-xl-block read-more-span">
                    <span className="d-none d-xl-block mb-0 new-span">
                      Elevate your fitness expertise with our online Functional
                      Training Workshop. Explore the science,
                      {showMore ? (
                        <span className="new-span">
                          design effective exercises, target upper and lower
                          body, optimize warm-ups, and uncover principles for
                          fat loss and muscle building. Join us to master
                          functional training!
                        </span>
                      ) : (
                        <span id="dotsx">...</span>
                  ...
                  <div>
                    <ul className="p-0 new-li">
                      ...
                      <li>
                        <i className="fas fa-video"></i>Saturday and Sunday
                  ...
                  <Button
                    ...
                    onClick={() => handleOrder("65b80e4903257986161d0a0a")}
                    id="btn_purchase_6010e9f3eb38ac0a706af298"
                  >
                    Enroll Now
                  </Button>
                  <WhatsAppAnchor
                    message="Hello, I wanted to know more about Functional Training Workshop."
          ...
          <div className="container">
            ...
            <div className="row mt-4 align-items-center">
              ...
              <div className="col-lg-6">
                <div className="text-center">
                  <h2 className="h4-fs">Functional Training Workshop Demo Certificate</h2>
                  <img
                    className="lazy"
                    src={
                      process.env.PUBLIC_URL +
                      "/assets/images/certificate/english-course-tabata-funcationl.webp"
                    }
                    width="80%"
      ...
      <OurStudentsWords />
      <CourseReviewSection course_id="65b80e4903257986161d0a0a" />
...
export default EnglishFunctionalTrainingWorkshop;
