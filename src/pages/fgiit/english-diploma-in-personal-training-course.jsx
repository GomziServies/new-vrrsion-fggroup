...
function EnglishDiplomaInPersonalTrainingCourse() {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:title" content="Diploma in Personal Training Course - Live Classes" />
        <meta property="og:description" content="Enroll in FG Group's Diploma in Personal Training Course to become a certified personal trainer. Benefit from live Zoom classes, extensive e-books, and recorded sessions tailored to help you achieve your fitness training goals. With no cost EMI options, globally recognized accreditation, and support from industry experts, start your journey towards a rewarding fitness career today!" />
        <meta property="og:image" content="https://fggroup.in/assets/images/logo/fg_group.webp" />
        <meta property="og:url" content="https://fggroup.in/fgiit/english-diploma-in-personal-training-course" />
                ...
                <div className="">
                    ...
                    <span className="d-none d-xl-block mb-0 new-span">
                      ...
                      {showMore ? (
                        <span className="new-span">
                          ...
                          Goals. Clients May Wish To Lose Weight Or Gain Muscle,
                          And As A Personal Trainer, You'll Instruct And Assist
                          Them With Exercising Appropriately Utilizing Exercises
                          And Explicit Plans.
                        </span>
                      ) : (
                        <span id="dotsx">...</span>
                  ...
                  <div>
                    <ul className="p-0 new-li">
                      ...
                      <li>
                        <i className="fas fa-file-signature"></i>For More
                  ...
                  <Button
                    ...
                    onClick={() => handleOrder("65b80d5103257986161d09dd")}
      ...
      <OurStudentsWords />
      <CourseReviewSection course_id="65b80d5103257986161d09dd" />
...
export default EnglishDiplomaInPersonalTrainingCourse;
