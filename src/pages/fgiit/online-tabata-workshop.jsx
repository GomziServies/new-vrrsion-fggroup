...
import { OnlineTabataWorkshopCourseData } from "../../components/online-course/OnlineCourseDataLoader";
import StudentTestimonial from "../../components/fgiit/studentsvideoreview";
import { Helmet } from "react-helmet";
import { Link } from "react-router-dom";

function OnlineTabataWorkshop() {
  ...
  const faqItems = [
    {
      question: "What is the duration of the Tabata workshop?",
      answer:
        "The workshop is conducted online over the course of 1 month, with live Zoom sessions and access to recorded materials.",
    },
    {
      question: "Is Tabata suitable for beginners?",
      answer:
        "Yes, the workshop is designed for all fitness levels. Exercises can be modified to suit beginners as well as advanced participants.",
    },
    {
      question: "Do I need any equipment for the Tabata workshop?",
      answer:
        "No specific equipment is needed for the workshop. However, depending on your fitness level and goals, some exercises may incorporate dumbbells, resistance bands, or bodyweight only.",
    },

    {
      question: "Will I receive a certificate upon completion?",
      answer:
        "Yes, participants who complete the workshop will receive a certificate of completion from FGIIT.",
    },
    {
      question: "What happens if I miss a live session?",
      answer:
        "All live sessions are recorded and available for participants to review at their convenience.",
    },
    {
      question: "How many times a week should I do Tabata workouts?",
      answer:
        "Tabata can be performed 3–5 times a week, depending on your fitness level and goals. The Scheduling module will guide you in designing an appropriate workout routine.",
    },
    {
      question: "Can I use Tabata for fat loss and muscle building?",
      answer:
        "Yes, Tabata can be structured for both fat loss and muscle building. The workshop will cover how to adjust exercises and intensity to achieve specific fitness goals.",
    },
    {
      question: "What warm-up and stretching techniques will I learn?",
      answer:
        "You will learn dynamic warm-up routines to prepare your body for intense Tabata sessions,along with flexibility and recovery stretches to ensure proper muscle care and injury prevention.",
    },
    {
      question: " Will there be ongoing support after the workshop?",
      answer:
        "Yes, live support and mentorship are available throughout the workshop, and participants will have access to team chat for assistance after completion.",
    },
    {
      question: "Are the Tabata workouts customizable?",
      answer:
        "Yes, the workshop will teach you how to customize and design Tabata workouts tailored to individual fitness goals, whether for fat loss, muscle building, or overall conditioning",
    },
  ];
  const reviewImages = [
  ...
  const reviewses = [
    {
      ...
      stars: 5,
      review:
        "The Online Tabata Workshop was intense but super effective! The short, high-energy sessions pushed me to my limits. Loved every minute of it!",
    ...
    },
    {
      ...
      stars: 5,
      review:
        "FGIIT's Tabata workshop is perfect for a quick and powerful workout. The online format was convenient, and the results were incredible in just a few weeks!",
    ...
    },
    {
      ...
      stars: 5,
      review:
        "Excellent Tabata sessions! The workouts were challenging yet fun, and the trainers gave great tips for doing them at home. Highly recommend!",
    ...
    },
    {
      ...
      stars: 5,
      review:
        "The Tabata workshop at FGIIT was an excellent way to get fit quickly. The online setup was smooth, and the instructors kept me motivated throughout.",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:title" content="Online Tabata Workshop" />
        <meta property="og:description" content="Join our Online Tabata Workshop for a high-intensity fitness experience. Burn calories, boost endurance, and get in the best shape of your life. Don't miss out!" />
        <meta property="og:image" content="https://fggroup.in/assets/images/logo/fg_group.webp" />
        <meta property="og:url" content="https://fggroup.in/fgiit/online-tabata-workshop" />
          ...
          <div className="container">
            <div className="row">
                    ...
                    <div>
                      <LazyLoadImage
                        ...
                        src={
                          ...
                          "/assets/images/fgiit/tabata-new.webp"
                        }
                      />
                    </div>
                    <div className="d-md-block d-none">
                      <div className="course-info">
                        ...
                        <ul className="course-list">
                          {OnlineTabataWorkshopCourseData?.info ? (
                            <>
                              <li>
                                <i className="fas fa-clock"></i>
                                {OnlineTabataWorkshopCourseData.info[0]}
                              </li>
                              <li>
                                <i className="fas fa-chalkboard-teacher"></i>
                                {OnlineTabataWorkshopCourseData.info[1]}
                              </li>
                              <li>
                                <i className="fas fa-video"></i>
                                {OnlineTabataWorkshopCourseData.info[2]}
                              </li>
                              <li>
                                <i className="fas fa-file-signature"></i>
                                {OnlineTabataWorkshopCourseData.info[3]}
                              </li>
                            </>
                          ) : (
                            <>
                              <li>
                                <i className="fas fa-clock"></i>
                                {OnlineTabataWorkshopCourseData.secondInfo[0]}
                              </li>
                              <li>
                                <i className="fas fa-chalkboard-teacher"></i>
                                {OnlineTabataWorkshopCourseData.secondInfo[1]}
                              </li>
                              <li>
                                <i className="fas fa-video"></i>
                                {OnlineTabataWorkshopCourseData.secondInfo[2]}
                              </li>
                            </>
                          )}
                        </ul>
              ...
              <div className="col-lg-5 px-md-0">
                <OnlineCourseForm
                  courseData={OnlineTabataWorkshopCourseData}
                  openForm={openForm}
                  whatsappMessage="Hello, I wanted to know more about the Online Tabata Workshop."
                />
              </div>
            </div>
          </div>
                    ...
                    <div className="mb-4 d-flex align-items-center justify-content-center flex-column flex-md-row">
                      <div className="col-md-6">
                        ...
                        <p className="text-muted">
                          This module provides an overview of Tabata, a
                          high-intensity interval training (HIIT) method
                          designed for maximum efficiency in a short time.
                          You'll learn the history of Tabata, its principles,
                          and how it differs from other workout methods.
                          <div className="row">
                            <ul className="col-md-6 p-3 mt-2">
                              ...
                              <li className="list-unstyled text-dark">
                                <b>How to Create Tabata Exercises & Circuits</b>
                              </li>
                              <li className="list-unstyled text-dark">
      ...
      <CourseReviewSection course_id="6509b66d1cdc4887d6951e73" />
...
export default OnlineTabataWorkshop;
