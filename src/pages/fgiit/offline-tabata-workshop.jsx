...
import { OfflineTabataWorkshopCourseData } from "../../components/offline-course/OfflineCourseDataLoader";
import PageMeta from "../../components/PageMeta";
import StudentTestimonial from "../../components/fgiit/studentsvideoreview";
import { Helmet } from "react-helmet";
import { Link } from "react-router-dom";

function OfflineTabataWorkshop() {
  ...
  return (
    <>
      <Helmet>
        ...
        />
        <meta property="og:title" content="Offline Tabata Workshop" />
        <meta
        ...
        <meta
          property="og:url"
          content="https://fggroup.in/fgiit/offline-tabata-workshop"
        />
          ...
          <div className="container">
            <div className="row">
                    ...
                    <div className="d-md-block d-none">
                      <div className="course-info">
                        ...
                        <ul className="course-list">
                          {OfflineTabataWorkshopCourseData?.info ? (
                            <>
                              <li className="fs-1">
                                <i className="fas fa-clock"></i>
                                {OfflineTabataWorkshopCourseData.info[0]}
                              </li>
                              <li>
                                <i className="fas fa-chalkboard-teacher"></i>
                                {OfflineTabataWorkshopCourseData.info[1]}
                              </li>
                              <li>
                                <i className="fas fa-video"></i>
                                {OfflineTabataWorkshopCourseData.info[2]}
                              </li>
                              <li>
                                <i className="fas fa-file-signature"></i>
                                {OfflineTabataWorkshopCourseData.info[3]}
                              </li>
                            </>
                          ) : (
                            <>
                              <li>
                                <i className="fas fa-clock"></i>
                                {OfflineTabataWorkshopCourseData.secondInfo[0]}
                              </li>
                              <li>
                                <i className="fas fa-chalkboard-teacher"></i>
                                {OfflineTabataWorkshopCourseData.secondInfo[1]}
                              </li>
                              <li>
                                <i className="fas fa-video"></i>
                                {OfflineTabataWorkshopCourseData.secondInfo[2]}
                              </li>
                            </>
                          )}
                        </ul>
              ...
              <div className="col-lg-5 px-md-0">
                <OfflineCourseForm
                  courseData={OfflineTabataWorkshopCourseData}
                  whatsappMessage="Hello, I wanted to know more about the Offline Tabata Workshop."
                />
              </div>
            </div>
          </div>
            ...
            <div className="row mt-4 align-items-center">
              ...
              <div className="col-md-6">
                <div className="text-center">
                  <p className="mt-4 mb-md-4 mb-3">Demo Certificate</p>
                  <img
                    className="lazy"
                    src={
                      process.env.PUBLIC_URL +
      ...
      <CourseReviewSection course_id="6509b66d1cdc4887d6951e78" />
...
export default OfflineTabataWorkshop;
