...
function EnglishRecordedCoursePhysiotherapy() {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:title" content="Injury Rehabilitation Masterclass for Sports & Gym - Learn & Certify | FG Group" />
        <meta property="og:description" content="Embark on a learning journey with FG Group's Injury Rehabilitation Masterclass, just $9. Over 1 month, dive deep into preventing and treating sports and gym-related injuries. This course covers injury recognition, first aid, post-injury rehab, and more, offering recorded videos, e-books, and expert support. Gain the skills for lifelong body care and active lifestyle maintenance. Secure your spot now and get certified" />
        <meta property="og:image" content="https://fggroup.in/assets/images/logo/fg_group.webp" />
        <meta property="og:url" content="https://fggroup.in/fgiit/english-recorded-course-physiotherapy" />
                ...
                <div className="">
                  ...
                  <div className="mb-3 d-none d-xl-block read-more-span">
                    <span className="d-none d-xl-block mb-0 new-span">
                      ...
                      and treating injuries linked to sports and gym activities.
                      Gain invaluable insights into exercise rehab, injury
                      types, and reasons for rehabilitation. FGIIT
                      {showMore ? (
                        <span className="m-0">
                          {" "}
                          offers a wealth of knowledge covering injury
                  ...
                  <Button
                    ...
                    onClick={() => handleOrder("65b80dfd03257986161d09f9")}
        ...
        <div className="container-fluid">
          <div className="container">
            ...
            <div className="Grocery1">
              <p>
                This Course Basically Aims At Preventing And Treating Injuries
                Through Several Means. Injuries That Are Connected To Sports And
                Gym Can Cause Severe Pain Or Can Cause Impacts On Your Body For
                The Rest Of Your Life. The Knowledge Of Treating Them Is Equally
                Important For An Individual As To Train And Therefore, We Are
                Here With The Knowledge That You Need To Know About Each And
                Everything About Exercises Of Rehab, Reasons Of Rehab, Types Of
                Injuries, And Much More. So, Let's Dig In Right Away Other Than
                This FGIIT Provides You A Vast Knowledge On Courses Like
              </p>
              <div className="row">
                <div className="col-md-6">
                  <ul className="new-li">
                    <li><i className="fas fa-check-circle"></i>Recognizing and classifying injuries</li>
                    <li><i className="fas fa-check-circle"></i>What is first-aid</li>
                    <li><i className="fas fa-check-circle"></i>After injury rehab</li>
                    <li><i className="fas fa-check-circle"></i>Range of motion</li>
                    <li><i className="fas fa-check-circle"></i>Special techniques of rehab</li>
                    <li><i className="fas fa-check-circle"></i>Back to normal activity</li>
                    <li><i className="fas fa-check-circle"></i>Care for lifetime</li>
                  </ul>
                </div>
              </div>
            </div>
      ...
      <CourseReviewSection course_id="65b80dfd03257986161d09f9" />
...
export default EnglishRecordedCoursePhysiotherapy;
