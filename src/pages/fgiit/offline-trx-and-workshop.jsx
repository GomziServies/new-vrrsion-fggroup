...
import { OfflineTRXBandWorkshopCourseData } from "../../components/offline-course/OfflineCourseDataLoader";
  ...
  return (
    <>
      <Helmet>
        ...
        />
        <meta property="og:title" content="Offline TRX band workshop" />
        <meta
        ...
        <meta
          property="og:url"
          content="https://fggroup.in/fgiit/offline-trx-and-workshop"
        />
          ...
          <div className="container">
            <div className="row">
                    ...
                    <div className="d-md-block d-none">
                      <div className="course-info">
                        ...
                        <ul className="course-list">
                          {OfflineTRXBandWorkshopCourseData?.info ? (
                            <>
                              <li className="fs-1">
                                <i className="fas fa-clock"></i>
                                {OfflineTRXBandWorkshopCourseData.info[0]}
                              </li>
                              <li>
                                <i className="fas fa-chalkboard-teacher"></i>
                                {OfflineTRXBandWorkshopCourseData.info[1]}
                              </li>
                              <li>
                                <i className="fas fa-video"></i>
                                {OfflineTRXBandWorkshopCourseData.info[2]}
                              </li>
                              <li>
                                <i className="fas fa-file-signature"></i>
                                {OfflineTRXBandWorkshopCourseData.info[3]}
                              </li>
                            </>
                          ) : (
                            <>
                              <li>
                                <i className="fas fa-clock"></i>
                                {OfflineTRXBandWorkshopCourseData.secondInfo[0]}
                              </li>
                              <li>
                                <i className="fas fa-chalkboard-teacher"></i>
                                {OfflineTRXBandWorkshopCourseData.secondInfo[1]}
                              </li>
                              <li>
                                <i className="fas fa-video"></i>
                                {OfflineTRXBandWorkshopCourseData.secondInfo[2]}
                              </li>
                            </>
                          )}
                        </ul>
              ...
              <div className="col-lg-5 px-md-0">
                <OfflineCourseForm
                  courseData={OfflineTRXBandWorkshopCourseData}
