...
function EnglishAnabolicAndrogenicSteroids() {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:title" content="Anabolic-Androgenic Steroids Masterclass - Knowledge" />
        <meta property="og:description" content="Enroll in FG Group's Anabolic-Androgenic Steroids Masterclass to gain comprehensive knowledge on performance-enhancing drugs, their safe use, doses, and complications. Live Zoom classes, e-books, and recorded sessions available. Get certified and make informed decisions in sports and bodybuilding." />
        <meta property="og:image" content="https://fggroup.in/assets/images/logo/fg_group.webp" />
        <meta property="og:url" content="https://fggroup.in/fgiit/english-anabolic-androgenic-steroids" />
              ...
              <div className="col-lg-5 px-md-0">
                <div className="">
                    ...
                    <span className="d-none d-xl-block mb-0 new-span">
                      ...
                      {showMore ? (
                        <span className="new-span">
                          ...
                          win, you should not be left out from the victory or
                          make any decision that can harm your life. So our
                          objective is to spread the knowledge anabolic
                          substance, doses, safety, and complications to every
                          individual who is in sports - course for bodybuilding
                        </span>
                      ) : (
                        <span id="dotsx">...</span>
                      )}
                  ...
                  <Button
                    ...
                    onClick={() => handleOrder("65b80da703257986161d09e9")}
                    id="btn_purchase_6010e9f3eb38ac0a706af298"
                  >
                    Enroll Now
                  </Button>
                  <WhatsAppAnchor
                    message="Hello, I wanted to know more about Anabolic-Androgenic Steroids Masterclass."
                        ...
                        <div className="item mx-md-3">
                          <div className="d-none d-md-block">
                            <iframe
                              width="560"
                              height="315"
                              src="https://www.youtube.com/embed/OINNAOKC9JQ?si=W1bEF3OCgTElpefJ"
                        ...
                        <div className="item mx-md-3">
                          <div className="d-none d-md-block">
                            <iframe
                              width="560"
                              height="315"
                              src="https://www.youtube.com/embed/RrGB38VEDdE?si=OZwlaMYlr-dvvkdm"
                              title="YouTube video player"
                              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                              allowFullScreen
                            ></iframe>
                        ...
                        <div className="item mx-md-3">
                          <div className="d-none d-md-block">
                            <iframe
                              width="560"
                              height="315"
                              src="https://www.youtube.com/embed/vxbGmHCJV-Q?si=AunNXOTR9UTVWfQG"
                              title="YouTube video player"
                              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                              allowFullScreen
                            ></iframe>
          ...
          <div className="container">
            ...
            <div className="row mt-4 align-items-center">
              ...
              <div className="col-lg-6">
                <div className="text-center">
                  <h2 className="h4-fs">Anabolic Androgenic Steroids Demo Certificate</h2>
                  <LazyLoadImage
                    effect="blur"
                    className="lazy"
                    src={
                      process.env.PUBLIC_URL +
                      "/assets/images/certificate/english-course-aas.webp"
                    }
                    width="80%"
      ...
      <OurStudentsWords />
      <CourseReviewSection course_id="65b80da703257986161d09e9" />
...
export default EnglishAnabolicAndrogenicSteroids;
