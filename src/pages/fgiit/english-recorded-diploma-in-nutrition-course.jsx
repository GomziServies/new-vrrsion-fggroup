...
function EnglishRecordedDiplomaInNutritionCourse() {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:title" content="Diploma in Nutrition Course: Become a Nutritionist | FG Group" />
        <meta property="og:description" content="Transform your passion into a profession with FG Group's Diploma in Nutrition Course for just $9. This 3-month comprehensive program covers crucial topics like diet planning for clinical conditions, fat loss, muscle building, and more. Get access to recorded lectures, e-books, expert support, and secure your certification online. Start your journey towards becoming a certified nutritionist today." />
        <meta property="og:image" content="https://fggroup.in/assets/images/logo/fg_group.webp" />
        <meta property="og:url" content="https://fggroup.in/fgiit/english-recorded-diploma-in-nutrition-course" />
                ...
                <div className="ply1">
                  <LazyLoadImage
                    ...
                    src={
                      ...
                      "/assets/images/fgiit/dnc-thumbnail.webp"
                    }
                  />
                </div>
              </div>
              <div className="col-lg-5 px-md-0">
                <div className="">
                  <div className="new-h3">
                    <h1 className="ml-0">Diploma In Nutrition Course</h1>
                  </div>
                  <div className="mb-3 d-none d-xl-block read-more-span">
                    <span className="d-none d-xl-block mb-0 new-span">
                      ...
                      Motivating, And Guiding Them To
                      {showMore ? (
                        <span className="m-0">
                          {" "}
                          Achieve Their Goals. Clients May Wish To Lose Weight
                          Or Gain Muscle, And As A Personal Trainer, You'll
                          Instruct And Assist Them With Exercising Appropriately
                  ...
                  <Button
                    ...
                    onClick={() => handleOrder("65b80d8403257986161d09e3")}
                  >
                    Enroll Now
                  </Button>
                  <WhatsAppAnchor
        ...
        <div className="container-fluid">
          <div className="container">
            ...
            <div className="Grocery1">
              <p>
                Diploma in a nutritionist course diverse course where we are
                teaching our nutritionist students that how to make a diet for
                clinically ill patients for fat loss and muscle building or
                first aid kit. in this course, we are also teaching a diverse
                subject which is given below in syllabus segments.
                <a
                  href="/blogs/nutrition-course-india"
                  style={{ color: "#007bff!important" }}
                >
                  nutrition course india
                </a>
                <br />
                <br /> We take care that meanwhile pursuing your course with us
                you know how to consult with the clients, how to make a diet for
                clients, customize a diet, and how to get success in your field.
                so from basic to advance we are covering all the subjects and
                your soft skills which help you to archive great success in your
                career.
              </p>
              <div className="row">
                <div className="col-md-6 new-li">
                  <ul>
                    <li><i className="fas fa-check-circle"></i>Carbohydrates</li>
                    <li><i className="fas fa-check-circle"></i>Proteins</li>
                    <li><i className="fas fa-check-circle"></i>Lipids</li>
                    <li><i className="fas fa-check-circle"></i>Water most forgotten nutrient</li>
                    <li><i className="fas fa-check-circle"></i>Energy metabolism</li>
                    <li><i className="fas fa-check-circle"></i>Vitamin</li>
                    <li><i className="fas fa-check-circle"></i>Minerals</li>
                    <li><i className="fas fa-check-circle"></i>Liver disorders</li>
                    <li><i className="fas fa-check-circle"></i>Feblife disorders</li>
                    <li><i className="fas fa-check-circle"></i>Fundamentals of meal planning</li>
                    <li><i className="fas fa-check-circle"></i>Food groups</li>
                  </ul>
                </div>
                <div className="col-md-6 new-li">
                  <ul>
                    <li><i className="fas fa-check-circle"></i>Food exchange list</li>
                    <li><i className="fas fa-check-circle"></i>Nutrition in the life cycle</li>
                    <li><i className="fas fa-check-circle"></i>Therapeutic adaptations of normal diet</li>
                    <li><i className="fas fa-check-circle"></i>Metabolic disorders</li>
                    <li><i className="fas fa-check-circle"></i>Cardiovascular disorders</li>
                    <li><i className="fas fa-check-circle"></i>Introduction to living beings: physiology</li>
                    <li><i className="fas fa-check-circle"></i>Anatomy of our human body</li>
                    <li><i className="fas fa-check-circle"></i>Musculoskeletal disorders</li>
                    <li><i className="fas fa-check-circle"></i>Weight management &amp; obesity</li>
                    <li><i className="fas fa-check-circle"></i>Sports nutrition</li>
                    <li><i className="fas fa-check-circle"></i>supplement</li>
                  </ul>
                </div>
              </div>
            </div>
      ...
      <CourseReviewSection course_id="65b80d8403257986161d09e3" />
...
export default EnglishRecordedDiplomaInNutritionCourse;
