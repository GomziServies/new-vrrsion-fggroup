...
import { OfflineMixMartialArtsWorkshopCourseData } from "../../components/offline-course/OfflineCourseDataLoader";
import { Helmet } from "react-helmet";
import { Link } from "react-router-dom";

function OfflineMixMartialArtsWorkshop() {
  ...
  return (
    <>
      <Helmet>
        ...
        />
        <meta property="og:title" content="Offline Mix Martial Arts Workshop" />
        <meta
        ...
        <meta
          property="og:url"
          content="https://fggroup.in/fgiit/offline-mix-martial-arts-workshop"
        />
          ...
          <div className="container">
            <div className="row">
                    ...
                    <div className="d-md-block d-none">
                      <div className="course-info">
                        ...
                        <ul className="course-list">
                          {OfflineMixMartialArtsWorkshopCourseData?.info ? (
                            <>
                              <li className="fs-1">
              ...
              <div className="col-lg-5 px-md-0">
                <OfflineCourseForm
                  courseData={OfflineMixMartialArtsWorkshopCourseData}
                  whatsappMessage="Hello, I wanted to know more about the Offline Mix Martial Arts Workshop."
                />
              </div>
            </div>
          </div>
        ...
        <div className="container-fluid">
          <div className="container">
            ...
            <div className="row">
              ...
              <div className="col-lg-4 col-md-6 col-6 mt-3 position-relative d-none d-md-block">
                <div className="tabata blog2 blog2-height py-5 imgty text-center">
                  <LazyLoadImage
                    effect="blur"
                    className="lazy"
      ...
      <CourseReviewSection course_id="6509b66d1cdc4887d6951e7b" />
...
export default OfflineMixMartialArtsWorkshop;
