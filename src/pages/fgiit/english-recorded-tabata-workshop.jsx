...
function EnglishRecordedTabataWorkshop() {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:title" content="Group Instructor Masterclass: Tabata, Functional & TRX Workouts | FG Group" />
        <meta property="og:description" content="Transform into a skilled group instructor with FG Group's Masterclass for just $9. Learn the essentials of Tabata, Functional, and TRX Band Workouts in our 1-month course. Experience comprehensive training with recorded videos, e-books, and support, culminating in a certification. Ideal for those looking to lead with confidence in fitness." />
        <meta property="og:image" content="https://fggroup.in/assets/images/logo/fg_group.webp" />
        <meta property="og:url" content="https://fggroup.in/fgiit/english-recorded-tabata-workshop" />
              ...
              <div className="col-lg-5 px-md-0">
                <div className="">
                  <div className="new-h3">
                    <h1 className="ml-0">Group Instructor Masterclass</h1>
                  </div>
                  <div className="mb-3 d-none d-xl-block read-more-span">
                    <span className="d-none d-xl-block mb-0 new-span">
                      ...
                      Body Focus, Warm-Up, Fat Loss & Muscle Building
                      Principles, and Effective Scheduling.
                      {showMore ? (
                        <span className="m-0">
                          {" "}
                          Elevate your fitness with us!
                        </span>
                      ) : (
                        <span id="dotsx">...</span>
                      )}
                  ...
                  <Button
                    ...
                    onClick={() => handleOrder("65b80dc803257986161d09ef")}
        ...
        <div className="container-fluid">
          <div className="container">
            ...
            <div className="Grocery1">
              <p>
                Each exercise in a given Tabata workout lasts only four minutes,
                but it is likely to be one of the longest four minutes you have
                ever endured. The doctor designed a training where participants
                gave their maximum effort for 20 seconds, then 10 seconds for
                rest. They repeated this cycle for four minutes – in other
                words, eight 30-second cycles. That in a nutshell is a Tabata
                exercise. Forget the gym membership and fancy fitness
                accessories. Sometimes, all you need is 30 minutes and some
                space.
              </p>
              <ul className="new-li">
                <li><i className="fas fa-check-circle"></i>What Is Tabata, Functional &amp; TRX Band Workout?</li>
                <li><i className="fas fa-check-circle"></i>Scheduling</li>
                <li><i className="fas fa-check-circle"></i>Body Weight Functional Workout</li>
                <li><i className="fas fa-check-circle"></i>Gym Based Functional Workout</li>
                <li><i className="fas fa-check-circle"></i>Fat Loss and Muscle Building Functional Workout</li>
                <li><i className="fas fa-check-circle"></i>Music Base Tabata Workout</li>
                <li><i className="fas fa-check-circle"></i>Varieties of TRX Band Workouttime</li>
              </ul>
            </div>
            <div className="row">
              <div className="col-lg-4 col-md-6 mt-3 position-relative">
      ...
      <CourseReviewSection course_id="65b80dc803257986161d09ef" />
...
export default EnglishRecordedTabataWorkshop;
