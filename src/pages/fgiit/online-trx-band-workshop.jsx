...
import { OnlineTRXBandWorkshopCourseData } from "../../components/online-course/OnlineCourseDataLoader";
import StudentTestimonial from "../../components/fgiit/studentsvideoreview";
import { Helmet } from "react-helmet";
import { Link } from "react-router-dom";

function OnlineTrxBandWorkshop() {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:title" content="Online TRX band workshop" />
        <meta property="og:description" content="Elevate your fitness with our Online TRX Band Workshop. Learn effective suspension training techniques from experts. Join now for a stronger, fitter you!" />
        <meta property="og:image" content="https://fggroup.in/assets/images/logo/fg_group.webp" />
        <meta property="og:url" content="https://fggroup.in/fgiit/online-trx-band-workshop" />
          ...
          <div className="container">
            <div className="row">
                    ...
                    <div>
                      <LazyLoadImage
                        ...
                        src={
                          ...
                          "/assets/images/fgiit/trx-new.webp"
                        }
                      />
                    </div>
                    <div className="d-md-block d-none">
                      <div className="course-info">
                        ...
                        <ul className="course-list">
                          {OnlineTRXBandWorkshopCourseData?.info ? (
                            <>
                              <li>
                                <i className="fas fa-clock"></i>
                                {OnlineTRXBandWorkshopCourseData.info[0]}
                              </li>
                              <li>
                                <i className="fas fa-chalkboard-teacher"></i>
                                {OnlineTRXBandWorkshopCourseData.info[1]}
                              </li>
                              <li>
                                <i className="fas fa-video"></i>
                                {OnlineTRXBandWorkshopCourseData.info[2]}
                              </li>
                              <li>
                                <i className="fas fa-file-signature"></i>
                                {OnlineTRXBandWorkshopCourseData.info[3]}
                              </li>
                            </>
                          ) : (
                            <>
                              <li>
                                <i className="fas fa-clock"></i>
                                {OnlineTRXBandWorkshopCourseData.secondInfo[0]}
                              </li>
                              <li>
                                <i className="fas fa-chalkboard-teacher"></i>
                                {OnlineTRXBandWorkshopCourseData.secondInfo[1]}
                              </li>
                              <li>
                                <i className="fas fa-video"></i>
                                {OnlineTRXBandWorkshopCourseData.secondInfo[2]}
                              </li>
                            </>
                          )}
                        </ul>
              ...
              <div className="col-lg-5 px-md-0">
                <OnlineCourseForm
                  courseData={OnlineTRXBandWorkshopCourseData}
                  openForm={openForm}
                ...
                <div className="col-lg-12 order-2 order-lg-1">
                    ...
                    <div className="mb-4 d-flex align-items-center justify-content-center flex-column flex-md-row">
                      <div className="col-md-6">
                        ...
                        <p className="text-muted">
                          This module introduces participants to the TRX band
                          and its history. You'll learn the unique benefits of
                          TRX suspension training and why it is an effective
                          tool for full-body workouts, suitable for all fitness
                          levels.
                          <div className="row">
                            <ul className="p-3 mt-2">
                              <li className="list-unstyled text-dark">
                                <b>How to Use the TRX Band</b>
                              </li>
                              <li className="list-unstyled text-dark">
                                <b>Upper Body TRX Band Training</b>
                              </li>
                              <li className="list-unstyled text-dark">
                                <b>Lower Body TRX Band Training</b>
                              </li>
                            </ul>
                            <ul className="p-3 mt-2">
                              <li className="list-unstyled text-dark">
                                <b>Stretching via TRX Band</b>
                              </li>
                              <li className="list-unstyled text-dark">
                                <b>Fat Loss Principle with TRX</b>
                              </li>
                              <li className="list-unstyled text-dark">
                                <b>Muscle Building Principle with TRX</b>
                              </li>
                            </ul>
                          </div>
                        </p>
                  ...
                  <blockquote className="blockquote d-md-none d-block mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted">
                        This module introduces participants to the TRX band and
                        its history. You'll learn the unique benefits of
                        {showMore[1] ? (
                          <>
                            TRX suspension training and why it is an effective
                            tool for full-body workouts, suitable for all
                            fitness levels.
                            <div className="row">
...
export default OnlineTrxBandWorkshop;
