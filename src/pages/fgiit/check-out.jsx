...
import { createPaymentCourses } from "../../assets/js/utils/fitness_course_payment.js";
...
function CourseCheckOut() {
  ...
  const productData = localStorage.getItem("corsesData");
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      const cart_id = JSON.parse(productData);
      try {
        const coupon_ids = [
          storeCouponData._id,
        ...
        await createPaymentCourses(
          productDatas,
          updatedUserData,
          coupon_ids,
          payment_mode,
          cart_id.serverDataID
        );
      } catch (error) {
