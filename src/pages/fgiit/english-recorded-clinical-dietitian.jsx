...
function EnglishRecordedClinicalDietitian() {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:title" content="Advance Clinical Nutrition Course: Become a Wellness Consultant" />
        <meta property="og:description" content="Embark on a transformative journey with FG Group's Advanced Clinical Nutrition Course for just $9. Over 1 month, delve into human physiology, lifestyle diseases, and the power of alternative therapies like intermittent fasting and keto diets. This course prepares you to craft personalized health plans, helping you become a certified health and wellness consultant. Includes recorded video, e-books, and certification." />
        <meta property="og:image" content="https://fggroup.in/assets/images/logo/fg_group.webp" />
        <meta property="og:url" content="https://fggroup.in/fgiit/english-recorded-clinical-dietitian" />
              ...
              <div className="col-lg-5 px-md-0">
                <div className="">
                  <div className="new-h3">
                    <h1 className="ml-0">Advance Clinical Nutrition</h1>
                  </div>
                  <div className="mb-3 d-none d-xl-block read-more-span">
                    <span className="d-none d-xl-block mb-0 new-span">
                      Embark on a transformative journey with our Wellness
                      Consultant course, where you'll delve into human
                      physiology, lifestyle diseases, and nutrition essentials.
                      Discover the power of alternative therapies like
                      intermittent fasting,
                      {showMore ? (
                        <span className="m-0">
                          {" "}
                          low-carb, and keto diets, coupled with exercise
                          approaches. Learn to combat diseases through holistic
                          health strategies, equipping you to craft personalized
                          health plans as a certified Health and Wellness
                          Consultant.
                        </span>
                      ) : (
                        <span id="dotsx">...</span>
                  ...
                  <Button
                    ...
                    onClick={() => handleOrder("65b80e2103257986161d0a00")}
                    id="btn_purchase_65b80e2103257986161d0a00"
                  >
                    Enroll Now
                  </Button>
                  <WhatsAppAnchor
            ...
            <div className="Grocery1">
              ...
              <div className="row new-li">
                <div className="col-md-6">
                  <ul>
                    <li><i className="fas fa-check-circle"></i>Human physiology and function of cell</li>
                    <li><i className="fas fa-check-circle"></i>Definition of health</li>
                    <li><i className="fas fa-check-circle"></i>What is life style diseases?</li>
                    <li><i className="fas fa-check-circle"></i>Food macro and micro elements</li>
                    <li><i className="fas fa-check-circle"></i>Food digestion system</li>
                    <li><i className="fas fa-check-circle"></i>Weight management</li>
                    <li><i className="fas fa-check-circle"></i>Blood sugar control</li>
                    <li><i className="fas fa-check-circle"></i>Important hormones of the body</li>
                    <li><i className="fas fa-check-circle"></i>Worst food elements</li>
                    <li><i className="fas fa-check-circle"></i>Essential food element</li>
                    <li><i className="fas fa-check-circle"></i>Anti-aging process</li>
                  </ul>
                </div>
                <div className="col-md-6">
                  <ul>
                    <li><i className="fas fa-check-circle"></i>Bone health</li>
                    <li><i className="fas fa-check-circle"></i>Stress control</li>
                    <li><i className="fas fa-check-circle"></i>Important blood test which ensure sound health</li>
                    <li><i className="fas fa-check-circle"></i>High uric acid and gout</li>
                    <li><i className="fas fa-check-circle"></i>Auto immune diseases</li>
                    <li><i className="fas fa-check-circle"></i>Perfect plan to achieve best health</li>
                    <li><i className="fas fa-check-circle"></i>Exercise plan</li>
                    <li>
                      <i className="fas fa-check-circle"></i>How to protect heart diseases, control blood pressure,
                      and high cholesterol
                    </li>
                    <li>
                      <i className="fas fa-check-circle"></i>Role of health and wellness consultant and how to
                      prepare health plan
                    </li>
                  </ul>
                </div>
      ...
      <CourseReviewSection course_id="65b80e2103257986161d0a00" />
...
export default EnglishRecordedClinicalDietitian;
