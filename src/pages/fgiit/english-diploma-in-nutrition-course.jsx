...
import onlinecoursednc from "./pdf/online/online_course_dnc.pdf";
...
function EnglishDiplomaInNutritionCourse() {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:title" content="Diploma in Nutrition Course - Live Classes | FG Group" />
        <meta property="og:description" content="Master the art of diet planning with FG Group's Diploma in Nutrition Course. Offering live Zoom classes and a rich curriculum for fat loss, muscle building, and clinical patient diets. Gain internationally recognized certification, expert support. Transform your passion into a profession." />
        <meta property="og:image" content="https://fggroup.in/assets/images/logo/fg_group.webp" />
        <meta property="og:url" content="https://fggroup.in/fgiit/english-diploma-in-nutrition-course" />
                ...
                <div className="">
                  ...
                  <div className="mb-3 d-none d-xl-block read-more-span">
                    <span className="d-none d-xl-block mb-0 new-span">
                      Diploma In A Nutritionist Course Diverse Course WhereWe
                      Are Teaching Our Nutritionist Students That How To Make A
                      Diet
                      {showMore ? (
                        <span className="new-span">
                          For Clinically Ill Patients For Fat Loss And Muscle
                          Building Or First Aid Kit. In This Course, We Are Also
                          Teaching A Diverse Subject Which Is Given Below In
                          Syllabus Segments. Nutrition Course India
                        </span>
                      ) : (
                        <span id="dotsx">...</span>
                      )}
                  ...
                  <Button
                    ...
                    onClick={() => handleOrder("65b80d8d03257986161d09e5")}
                    id="btn_purchase_6010e9f3eb38ac0a706af298"
                  >
                    Enroll Now
                  </Button>
                  <WhatsAppAnchor
                    message="Hello, I wanted to know more about English Diploma In Nutrition Course."
                    options={{ pageRef: true }}
                  />
                  <a
                    href={onlinecoursednc}
                    download
                    className="btn btn-started mt-2 w-100"
                        ...
                        <div className="item mx-md-3">
                          <div className="d-none d-md-block">
                            <iframe
                              width="560"
                              height="315"
                              src="https://www.youtube.com/embed/kwx2qSk_g5A?si=J4me-UFeRtj_1sjB"
                        ...
                        <div className="item mx-md-3">
                          <div className="d-none d-md-block">
                            <iframe
                              width="560"
                              height="315"
                              src="https://www.youtube.com/embed/BpW3Jy16zQ4?si=3qiHQxYIlHuFLPRo"
                              title="YouTube video player"
                              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                              allowFullScreen
                            ></iframe>
                        ...
                        <div className="item mx-md-3">
                          <div className="d-none d-md-block">
                            <iframe
                              width="560"
                              height="315"
                              src="https://www.youtube.com/embed/w1HW58vK58Y?si=kIZZjs8HcyFbcaUR"
                              title="YouTube video player"
                              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                              allowFullScreen
                            ></iframe>
        ...
        <div className="container-fluid">
          <div className="container">
            <div className="col-lg-12 px-0 px-md-3">
              <div className="text-center">
                <h2 className="h2-fs new-h2">Course Info</h2>
              </div>
              <div className="Grocery1 grocery_1">
                <p>
                  ...
                  Subject Which Is Given Below In Syllabus Segments. Nutrition
                  Course India
                </p>
                <p className="mt-3">
                  We Take Care That Meanwhile Pursuing Your Course With Us You
                  Know How To Consult With The Clients, How To Make A Diet For
                  Clients, Customize A Diet, And How To Get Success In Your
                  Field. So From Basic To Advance We Are Covering All The
                  Subjects And Your Soft Skills Which Help You To Archive Great
                ...
                <div className="d-none d-md-block mt-5">
                  <div className="row">
                    <div className="col-md-6">
                      <ul className="p-0 new-li">
                        <li>
                          <i className="fas fa-check-circle"></i> Carbohydrates
                        </li>
                        <li>
                          <i className="fas fa-check-circle"></i> Proteins
                        </li>
                        <li>
                          <i className="fas fa-check-circle"></i> Lipids
                        </li>
                        <li>
                          <i className="fas fa-check-circle"></i> Water - most
                          forgotten nutrient
                        </li>
                        <li>
                          <i className="fas fa-check-circle"></i> Energy
                          metabolism
                        </li>
                        <li>
                          <i className="fas fa-check-circle"></i> Vitamin
                        </li>
                        <li>
                          <i className="fas fa-check-circle"></i> Minerals
                        </li>
                        <li>
                          <i className="fas fa-check-circle"></i> Liver
                          disorders
                        </li>
                        <li>
                          <i className="fas fa-check-circle"></i> Feblife
                          disorders
                        </li>
                        <li>
                          <i className="fas fa-check-circle"></i> Fundamentals
                          of meal planning
                        </li>
                        <li>
                          <i className="fas fa-check-circle"></i> Food groups
                        </li>
                      </ul>
                    </div>
                    <div className="col-md-6">
                      <ul className="p-0 new-li">
                        <li>
                          <i className="fas fa-check-circle"></i> Food exchange
                          list
                        </li>
                        <li>
                          <i className="fas fa-check-circle"></i> Nutrition in
                          the life cycle
                        </li>
                        <li>
                          <i className="fas fa-check-circle"></i> Therapeutic
                          adaptations of normal diet
                        </li>
                        <li>
                          <i className="fas fa-check-circle"></i> Metabolic
                          disorders
                        </li>
                        <li>
                          <i className="fas fa-check-circle"></i> Cardiovascular
                          disorders
                        </li>
                        <li>
                          <i className="fas fa-check-circle"></i> Introduction
                          to living beings: physiology
                        </li>
                        <li>
                          <i className="fas fa-check-circle"></i> Anatomy of our
                          human body
                        </li>
                        <li>
                        ...
                        <li>
                          <i className="fas fa-check-circle"></i> Sports
                          nutrition
                        </li>
                        <li>
                          <i className="fas fa-check-circle"></i> supplement
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div className="d-block d-md-none">
                  <div className="mb-3">
                    ...
                    <span id="morex" className="new-span">
                      <span className="m-0">
                        <ul className="p-0 new-li">
                          <li>
                            <i className="fas fa-check-circle"></i> Vitamin
                          ...
                          <li>
                            <i className="fas fa-check-circle"></i> Food
                            exchange list
                          </li>
                          <li>
                            <i className="fas fa-check-circle"></i> Nutrition in
                          ...
                          <li>
                            <i className="fas fa-check-circle"></i> Anatomy of
                            our human body
                          </li>
                          <li>
                            <i className="fas fa-check-circle"></i>{" "}
          ...
          <div className="container">
            ...
            <div className="row mt-4 align-items-center">
              ...
              <div className="col-lg-6">
                <div className="text-center">
                  <h2 className="h4-fs">DNC Demo Certificate</h2>
                  <LazyLoadImage
                    effect="blur"
                    className="lazy"
                    src={
                      process.env.PUBLIC_URL +
                      "/assets/images/certificate/english-course-dnc.webp"
                    }
                    width="80%"
            ...
            >
              ...
              <div className="item mx-3">
                <img
                  ...
                  src={
                    process.env.PUBLIC_URL +
                    "/assets/images/fgiit/student-2.webp"
                  }
                  alt="Pass out Student"
                  width="100%"
                  style={{ borderRadius: "10px" }}
              ...
              <div className="item mx-3">
                <img
                  ...
                  src={
                    process.env.PUBLIC_URL +
                    "/assets/images/fgiit/student-1.webp"
                  }
                  alt="Pass out Student"
                  width="100%"
                  style={{ borderRadius: "10px" }}
              ...
              <div className="item mx-3">
                <img
                  ...
                  src={
                    process.env.PUBLIC_URL +
                    "/assets/images/img/cnc-certi-1.webp"
                  }
                  alt="Pass out Student"
                  width="100%"
                  style={{ borderRadius: "10px" }}
              ...
              <div className="item mx-3">
                <img
                  ...
                  src={
                    process.env.PUBLIC_URL +
                    "/assets/images/img/cnc-certi-7.webp"
                  }
                  alt="Pass out Student"
                  width="100%"
                  style={{ borderRadius: "10px" }}
              ...
              <div className="item mx-3">
                <img
                  ...
                  src={
                    process.env.PUBLIC_URL +
                    "/assets/images/img/cnc-certi-8.webp"
                  }
                  alt="Pass out Student"
                  width="100%"
                  style={{ borderRadius: "10px" }}
      ...
      <OurStudentsWords />
      <CourseReviewSection course_id="65b80d8d03257986161d09e5" />
...
export default EnglishDiplomaInNutritionCourse;
