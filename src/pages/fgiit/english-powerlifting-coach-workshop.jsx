...
function EnglishPowerliftingCoachWorkshop() {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:title" content="Powerlifting Coach Workshop: Elevate Your Coaching Career | FG Group" />
        <meta property="og:description" content="Unlock the secrets of powerlifting with FG Group's Powerlifting Coach Workshop. This intensive 2-day online workshop covers everything from biomechanics and strength principles to coaching ethics and practical training. Perfect for aspiring coaches looking to elevate their career. Live Zoom classes available." />
        <meta property="og:image" content="https://fggroup.in/assets/images/logo/fg_group.webp" />
        <meta property="og:url" content="https://fggroup.in/fgiit/english-powerlifting-coach-workshop" />
                ...
                <div className="ply1">
                  <LazyLoadImage
                    ...
                    src={
                      ...
                      "/assets/images/fgiit/Powerlifting-Coach-Workshop.webp"
                    }
                  />
                </div>
              </div>
              <div className="col-lg-5 px-md-0">
                <div className="">
                  <div className="new-h3">
                    <h1 className="ml-0">Powerlifting Coach Workshop</h1>
                  </div>
                    ...
                    <span className="d-none d-xl-block mb-0 new-span">
                      ...
                      {showMore ? (
                        <span className="new-span">
                          practical training. Elevate your coaching career.
                        </span>
                      ) : (
                        <span id="dotsx">...</span>
                      )}
                  ...
                  <Button
                    ...
                    onClick={() => handleOrder("65b80e6003257986161d0a12")}
                  >
                    Enroll Now
                  </Button>
                  <WhatsAppAnchor
                    message="Hello, I wanted to know more about Powerlifting Coach Workshop."
          ...
          <div className="container">
            ...
            <div className="row mt-4 align-items-center">
              ...
              <div className="col-lg-6">
                <div className="text-center">
                  <h2 className="h4-fs">Powerlifting Coach Workshop Demo Certificate</h2>
                  <img
                    className="lazy"
                    src={
                      process.env.PUBLIC_URL +
                      "/assets/images/certificate/english-course-powerlifting.webp"
                    }
                    width="80%"
      ...
      <OurStudentsWords />
      <CourseReviewSection course_id="65b80e6003257986161d0a12" />
...
export default EnglishPowerliftingCoachWorkshop;
