...
function EnglishTrxAndWorkshop() {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          property="og:title"
          content="TRX Band Workshop: Master Resistance Training for Fitness | FG Group"
        />
        <meta
        ...
        />
        <meta property="og:url" content="https://fggroup.in/fgiit/english-trx-and-workshop" />
                ...
                <div className="ply1">
                  <LazyLoadImage
                    ...
                    src={
                      ...
                      "/assets/images/fgiit/TRX-band-workshop.webp"
                    }
                  />
                </div>
              </div>
              <div className="col-lg-5 px-md-0">
                <div className="">
                  <div className="new-h3">
                    <h1 className="ml-0">TRX band workshop</h1>
                  </div>
                  <div className="mb-3 d-none d-xl-block read-more-span">
                    <span className="d-none d-xl-block mb-0 new-span">
                      ...
                      Resistance Training, TRX Basics,
                      {showMore ? (
                        <span className="new-span">
                          Upper & Lower Body Workouts, Stretching, Fat Loss, and
                          Muscle Building. Achieve your fitness goals!
                        </span>
                      ) : (
                        <span id="dotsx">...</span>
                      )}
                  ...
                  <Button
                    ...
                    onClick={() => handleOrder("65b80e3a03257986161d0a06")}
                  >
                    Enroll Now
                  </Button>
                  <WhatsAppAnchor
                    message="Hello, I wanted to know more about TRX band workshop."
          ...
          <div className="container">
            ...
            <div className="row mt-4 align-items-center">
              ...
              <div className="col-lg-6">
                <div className="text-center">
                  <h2 className="h4-fs">TRX and Workshop Demo Certificate</h2>
                  <img
                    className="lazy"
                    src={
                      process.env.PUBLIC_URL +
                      "/assets/images/certificate/english-course-trx.webp"
                    }
                    width="80%"
      ...
      <OurStudentsWords />
      <CourseReviewSection course_id="65b80e3a03257986161d0a06" />
...
export default EnglishTrxAndWorkshop;
