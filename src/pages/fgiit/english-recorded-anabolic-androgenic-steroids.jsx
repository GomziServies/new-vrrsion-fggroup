...
function EnglishRecordedAnabolicAndrogenicSteroids() {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:title" content="Anabolic Androgenic Steroids Masterclass | FG Group" />
        <meta property="og:description" content="Enroll in FG Group's Anabolic Androgenic Steroids Masterclass for just $9. Learn everything about steroids, from human anatomy, physiology, introduction to steroids, compounds, doses, safety, and cycle making. This 1-month course includes recorded lectures, e-books, expert support, and certification. Equip yourself with the knowledge to make informed decisions in sports and fitness." />
        <meta property="og:image" content="https://fggroup.in/assets/images/logo/fg_group.webp" />
        <meta property="og:url" content="https://fggroup.in/fgiit/english-recorded-anabolic-androgenic-steroids" />
                ...
                <div className="ply1">
                  <LazyLoadImage
                    ...
                    src={
                      ...
                      "/assets/images/fgiit/AAS-thumbnail.webp"
                    }
                  />
                </div>
              </div>
                ...
                <div className="">
                  ...
                  <div className="mb-3 d-none d-xl-block read-more-span">
                    <span className="d-none d-xl-block mb-0 new-span">
                      ...
                      One-On-One Fitness Programs For Their Clients, Motivating,
                      And Guiding Them To Achieve
                      {showMore ? (
                        <span className="m-0">
                          Their Goals. Clients May Wish To Lose Weight Or Gain
                          Muscle, And As A Personal Trainer, You'll Instruct And
                          Assist Them With Exercising Appropriately Utilizing
                          Exercises And Explicit Plans.
                        </span>
                      ) : (
                        <span id="dotsx">...</span>
                      )}
                  ...
                  <Button
                    ...
                    onClick={() => handleOrder("65b80db703257986161d09eb")}
                    id="btn_purchase_65b80db703257986161d09eb"
                  >
                    Enroll Now
                  </Button>
                  <WhatsAppAnchor
        ...
        <div className="container-fluid">
          <div className="container">
            ...
            <div className="Grocery1">
              <p>
                Anabolic-androgenic steroids are the most important thing to
                know for athletes these days. In the era, where everyone is
                ...
                life. So our objective is to spread the knowledge anabolic
                substance, doses, safety, and complications to every individual
                who is in sports.
                <br /> Syllabus,
              </p>
              <ul className="new-li">
                <li><i className="fas fa-check-circle"></i>Human Anatomy</li>
                <li><i className="fas fa-check-circle"></i>Physiology</li>
                <li><i className="fas fa-check-circle"></i>Introduction Of Steroid</li>
                <li><i className="fas fa-check-circle"></i>Anabolic Androgenic Steroid Compounds</li>
                <li><i className="fas fa-check-circle"></i>Pepdes</li>
                <li><i className="fas fa-check-circle"></i>SARMS</li>
                <li><i className="fas fa-check-circle"></i>Hormone Balance And Estrogen Control</li>
                <li><i className="fas fa-check-circle"></i>Supplements</li>
                <li><i className="fas fa-check-circle"></i>Praccal Cycle Making</li>
                <li><i className="fas fa-check-circle"></i>Safety Protocols</li>
              </ul>
            </div>
            <div className="row">
              <div className="col-lg-4 col-md-6 mt-3 position-relative">
      ...
      <CourseReviewSection course_id="65b80db703257986161d09eb" />
...
export default EnglishRecordedAnabolicAndrogenicSteroids;
