...
function EnglishTabataWorkshop() {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:title" content="Tabata Workshop - Intensive 2-Day Training" />
        <meta property="og:description" content="Join FG Group's Tabata Workshop for an in-depth exploration into Tabata training. Over two full days via live Zoom classes, learn the science behind Tabata, create effective exercises, and master warm-up and workout scheduling for optimal fat loss and muscle building. Gain certification and elevate your fitness regimen now!" />
        <meta property="og:image" content="https://fggroup.in/assets/images/logo/fg_group.webp" />
        <meta property="og:url" content="https://fggroup.in/fgiit/english-tabata-workshop" />
                ...
                <div className="ply1">
                  <LazyLoadImage
                    ...
                    src={
                      ...
                      "/assets/images/fgiit/tabata-workshop.webp"
                    }
                  />
                </div>
              </div>
              <div className="col-lg-5 px-md-0">
                <div className="">
                  <div className="new-h3">
                    <h1 className="ml-0">Tabata Workshop</h1>
                  </div>
                    ...
                    <span className="d-none d-xl-block mb-0 new-span">
                      ...
                      {showMore ? (
                        <span className="new-span">
                          Warm-Up, Fat Loss & Muscle Building Principles, and
                          Effective Scheduling. Elevate your fitness with us!
                        </span>
                      ) : (
                        <span id="dotsx">...</span>
                      )}
                  ...
                  <Button
                    ...
                    onClick={() => handleOrder("65b80dce03257986161d09f1")}
                    id="btn_purchase_6010e9f3eb38ac0a706af298"
                  >
                    Enroll Now
                  </Button>
                  <WhatsAppAnchor
                    message="Hello, I wanted to know more about Tabata Workshop."
          ...
          <div className="container">
            ...
            <div className="row mt-4 align-items-center">
              ...
              <div className="col-lg-6">
                <div className="text-center">
                  <h2 className="h4-fs">Tabata Workshop Demo Certificate</h2>
                  <img
                    className="lazy"
                    src={
                      process.env.PUBLIC_URL +
                      "/assets/images/certificate/english-course-tabata-workshop.webp"
                    }
                    width="80%"
      ...
      <OurStudentsWords />
      <CourseReviewSection course_id="65b80dce03257986161d09f1" />
...
export default EnglishTabataWorkshop;
