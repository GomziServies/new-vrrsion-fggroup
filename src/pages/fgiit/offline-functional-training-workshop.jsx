...
import { OfflineFunctionalWorkshopCourseData } from "../../components/offline-course/OfflineCourseDataLoader";
import StudentTestimonial from "../../components/fgiit/studentsvideoreview";
import { Helmet } from "react-helmet";
import { Link } from "react-router-dom";

function OfflineFunctionalTrainingWorkshop() {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          property="og:title"
          content="Offline Functional Training Workshop"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://fggroup.in/fgiit/offline-functional-training-workshop"
        />
          ...
          <div className="container">
            <div className="row position-relative">
                    ...
                    <div className="d-md-block d-none">
                      <div className="course-info">
                        ...
                        <ul className="course-list">
                          {OfflineFunctionalWorkshopCourseData?.info ? (
                            <>
                              <li className="fs-1">
                                <i className="fas fa-clock"></i>
                                {OfflineFunctionalWorkshopCourseData.info[0]}
                              </li>
                              <li>
                                <i className="fas fa-chalkboard-teacher"></i>
                                {OfflineFunctionalWorkshopCourseData.info[1]}
                              </li>
                              <li>
                                <i className="fas fa-video"></i>
                                {OfflineFunctionalWorkshopCourseData.info[2]}
                              </li>
                              <li>
                                <i className="fas fa-file-signature"></i>
                                {OfflineFunctionalWorkshopCourseData.info[3]}
                              </li>
                            </>
                          ) : (
                            <>
              ...
              <div className="col-lg-5 px-md-0">
                <OfflineCourseForm
                  courseData={OfflineFunctionalWorkshopCourseData}
                  whatsappMessage="Hello, I wanted to know more about the Offline Functional Training Workshop."
                />
              </div>
            </div>
          </div>
                    ...
                    <div className="mb-4 d-flex align-items-center justify-content-center flex-column flex-md-row">
                      <div className="col-md-6">
                        ...
                        <p className="text-muted">
                          ...
                          strength training.
                          <div className="row">
                            <ul className="col-md-5 p-3 mt-2">
      ...
      <CourseReviewSection course_id="6509b66d1cdc4887d6951e7c" />
...
export default OfflineFunctionalTrainingWorkshop;
