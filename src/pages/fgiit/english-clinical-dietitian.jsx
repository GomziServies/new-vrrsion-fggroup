...
function EnglishClinicalDietitian() {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:title" content="Advance Clinical Nutrition Workshop | FG Group" />
        <meta property="og:description" content="Join FG Group's Advance Clinical Nutrition workshop to embark on a transformative journey into wellness consulting. This 2-day intensive course covers human physiology, lifestyle diseases, nutrition essentials, and alternative therapies like intermittent fasting and keto diets. Learn holistic health strategies and exercise approaches to craft personalized health plans. Become a certified Health and Wellness Consultant ready to combat diseases through nutrition." />
        <meta property="og:image" content="https://fggroup.in/assets/images/logo/fg_group.webp" />
        <meta property="og:url" content="https://fggroup.in/fgiit/english-clinical-dietitian" />
                ...
                <div className="">
                  ...
                  <div>
                    <ul className="p-0 new-li">
                      <li>
                        <i className="fas fa-clock"></i>2 Days, Full Day
                        Workshop
                      </li>
                      <li>
                  ...
                  <Button
                    ...
                    onClick={() => handleOrder("65b80e2603257986161d0a02")}
                    id="btn_purchase_6010e9f3eb38ac0a706af298"
                  >
                    Enroll Now
                  </Button>
                  <WhatsAppAnchor
                    message="Hello, I wanted to know more about Advance Clinical Nutrition."
                    ...
                    <div className="mt-4 pb-md-5 pb-4">
                      <div className="d-none d-md-block">
                        <iframe
                          width="560"
                          height="315"
                          src="https://www.youtube.com/embed/wdS3MY37S1I?si=iYtCA8oqTCyxJ8ES"
          ...
          <div className="container">
            ...
            <div className="row mt-4 align-items-center">
              ...
              <div className="col-lg-6">
                <div className="text-center">
                  <h2 className="h4-fs">Advance Clinical Nutrition Demo Certificate</h2>
                  <LazyLoadImage
                    effect="blur"
                    className="lazy"
                    src={
                      process.env.PUBLIC_URL +
                      "/assets/images/certificate/english-course-advance-clinical.webp"
                    }
                    width="80%"
      ...
      <OurStudentsWords />
      <CourseReviewSection course_id="65b80e2603257986161d0a02" />
...
export default EnglishClinicalDietitian;
