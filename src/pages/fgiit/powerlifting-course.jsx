...
import { OfflinePowerliftingCoachWorkshopCourseData } from "../../components/offline-course/OfflineCourseDataLoader";
...
function PowerliftingCourse() {
  ...
  const faqItems = [
    {
      ...
      answer:
        "The workshop spans 1 full days, held on Sunday from 10:00 AM to 05:00 PM.",
    },
    {
  ...
  return (
    <>
      <Helmet>
        <title>Join a Powerlifting Course & Maximize Your Performance</title>
        <meta name="description" content="Enhance strength and technique with a top powerlifting course. Learn from experts and maximize your performance today!" />
        <meta name="keyword" content="Offline Powerlifting Coach Workshop, Powerlifting Coach Workshop Offline, Powerlifting Coach Workshop, Fgiit Offline Powerlifting Coach Workshop, Fgiit Powerlifting Coach Workshop, powerlifting coach, powerlifting, fitness workout, powerlifting training, strength training near me, powerlifting program, fitness training, strength training, fitness coaches, powerlifting coach near me, powerlifting training program, fitness trainer classes, best powerlifting program, certified personal fitness trainer, weight lifting training, power lifting coach, weight lifting training program, strength training programme, Powerlifting Coach Certification, Certified Powerlifting Coach, Powerlifting Training Program, Best Powerlifting Program, Powerlifting Coach Near Me, Strength and Powerlifting Coach Workshop, Powerlifting Certification Course, Strength and Conditioning Coach Course, Fitness and Strength Training Program, Powerlifting Personal Trainer Course, Best Powerlifting Training, Weightlifting Coach Certification, Strength and Power Training, Strength Training Near Me, Best Powerlifting Gym, Powerlifting Instructor Certification, Powerlifting Strength Training Course, Olympic Weightlifting Course, Strength Training Coach Certification, Fitness Trainer Certification, Powerlifting Program for Beginners, Powerlifting Strength Training Program, Powerlifting Workshop Near Me, Advanced Powerlifting Course, Personal Training Powerlifting Course, Strength and Conditioning Training Course, Fitness and Strength Training Certification, Powerlifting Coaching Program, Weightlifting Training Near Me, Best Powerlifting Course, Gym Coach Certification, Strength and Fitness Instructor Course, Professional Powerlifting Coach Training, Certified Strength Coach, Personal Trainer and Powerlifting Coach, Weightlifting Coach Near Me, Powerlifting Coach Training Course, Best Strength Training Program, Personal Trainer Powerlifting Certification, Powerlifting Strength Training Masterclass, Strength Training Certification Course" />
        <meta property="og:title" content="Join a Powerlifting Course & Maximize Your Performance" />
        <meta property="og:description" content="Enhance strength and technique with a top powerlifting course. Learn from experts and maximize your performance today!" />
        <meta property="og:image" content="https://fggroup.in/assets/images/logo/fg_group.webp" />
        <meta property="og:url" content="https://fggroup.in/fgiit/powerlifting-course" />
      ...
      <p className="d-none">
     Offline Powerlifting Coach Workshop, Powerlifting Coach Workshop Offline, Powerlifting Coach Workshop, Fgiit Offline Powerlifting Coach Workshop, Fgiit Powerlifting Coach Workshop, powerlifting coach, powerlifting, fitness workout, powerlifting training, strength training near me, powerlifting program, fitness training, strength training, fitness coaches, powerlifting coach near me, powerlifting training program, fitness trainer classes, best powerlifting program, certified personal fitness trainer, weight lifting training, power lifting coach, weight lifting training program, strength training programme, Powerlifting Coach Certification, Certified Powerlifting Coach, Powerlifting Training Program, Best Powerlifting Program, Powerlifting Coach Near Me, Strength and Powerlifting Coach Workshop, Powerlifting Certification Course, Strength and Conditioning Coach Course, Fitness and Strength Training Program, Powerlifting Personal Trainer Course, Best Powerlifting Training, Weightlifting Coach Certification, Strength and Power Training, Strength Training Near Me, Best Powerlifting Gym, Powerlifting Instructor Certification, Powerlifting Strength Training Course, Olympic Weightlifting Course, Strength Training Coach Certification, Fitness Trainer Certification, Powerlifting Program for Beginners, Powerlifting Strength Training Program, Powerlifting Workshop Near Me, Advanced Powerlifting Course, Personal Training Powerlifting Course, Strength and Conditioning Training Course, Fitness and Strength Training Certification, Powerlifting Coaching Program, Weightlifting Training Near Me, Best Powerlifting Course, Gym Coach Certification, Strength and Fitness Instructor Course, Professional Powerlifting Coach Training, Certified Strength Coach, Personal Trainer and Powerlifting Coach, Weightlifting Coach Near Me, Powerlifting Coach Training Course, Best Strength Training Program, Personal Trainer Powerlifting Certification, Powerlifting Strength Training Masterclass, Strength Training Certification Course
      </p>
      <ModalVideo
        channel="youtube"
        isOpen={isVideoOpen}
          ...
          <div className="container">
            <div className="row">
                    ...
                    <div className="d-md-block d-none">
                      <div className="course-info">
                        ...
                        <ul className="course-list">
                          {OfflinePowerliftingCoachWorkshopCourseData?.info ? (
                            <>
                              <li className="fs-1">
              ...
              <div className="col-lg-5 px-md-0">
                <OfflineCourseForm
                  courseData={OfflinePowerliftingCoachWorkshopCourseData}
                  whatsappMessage="Hello, I wanted to know more about the Offline Powerlifting Coach Workshop."
                />
              </div>
            </div>
          </div>
            ...
            <div className="">
              <div className="covid text-center">
                <h2 className="mt-2 h2-fs">
                  Boost Your Strength with a{" "}
                  <span className="m-0 text-blue-color">Powerlifting Course</span>
                </h2>
              </div>
              ...
              <div className="row">
                <div className="col-lg-12">
                  <div className="describe">
                    <p>
                      Enrolling in a powerlifting course is the best way to develop strength, master lifting techniques, and enhance overall performance. Whether you are a beginner or an experienced lifter, structured powerlifting training provides expert guidance on form, technique, and progression to help you lift heavier and reduce injury risks.
                    </p>
                    <p>
                      A well-designed powerlifting program focuses on the three main lifts—squat, bench press, and deadlift. These movements require proper execution and training strategies to maximize strength gains. Through a powerlifting course, you will learn essential skills such as periodization, progressive overload, mobility work, and recovery methods to optimize results.
                    </p>
                    <p>
                      Many courses also provide insights into nutrition, supplementation, and mental conditioning, ensuring a well-rounded approach to strength training. Whether you aim to compete in powerlifting events or simply improve your strength, following a structured powerlifting training plan will accelerate your progress.
                    </p>
                    <p>
                      Choosing a certified powerlifting course from reputable trainers or organizations ensures you receive expert coaching and effective programming. With the right powerlifting program, you can build muscle, increase endurance, and achieve your strength goals. Start your journey today and take your lifting performance to the next level!
                    </p>
                  </div>
                </div>
              </div>
      ...
      <CourseReviewSection course_id="6509b66d1cdc4887d6951e7a" />
...
export default PowerliftingCourse;
