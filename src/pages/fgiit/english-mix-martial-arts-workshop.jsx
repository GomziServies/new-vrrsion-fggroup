...
function EnglishMixMartialArtsWorkshop() {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:title" content="Mix Martial Arts Workshop: Master Techniques & Self-Defense" />
        <meta property="og:description" content="Boost your martial arts skills with FG Group's Online Mix Martial Arts Workshop. Learn essential stances, hand & kicking techniques, defense forms, sparring, and self-defense over a 2-day full-day workshop via live Zoom classes. Whether beginner or advanced, elevate your abilities and confidence in martial arts. Enroll now!" />
        <meta property="og:image" content="https://fggroup.in/assets/images/logo/fg_group.webp" />
        <meta property="og:url" content="https://fggroup.in/fgiit/english-mix-martial-arts-workshop" />
                ...
                <div className="ply1">
                  <LazyLoadImage
                    ...
                    src={
                      ...
                      "/assets/images/fgiit/Mix-Martial-Arts-Workshop.webp"
                    }
                  />
                </div>
              </div>
              <div className="col-lg-5 px-md-0">
                <div className="">
                  <div className="new-h3">
                    <h1 className="ml-0">Mix Martial Arts Workshop</h1>
                  </div>
                  <div className="mb-3 d-none d-xl-block read-more-span">
                    <span className="d-none d-xl-block mb-0 new-span">
                      ...
                      techniques, defense, forms, sparring,
                      {showMore ? (
                        <span className="new-span">
                          and self-defense. Elevate your skills!
                        </span>
                      ) : (
                        <span id="dotsx">...</span>
                      )}
                  ...
                  <Button
                    ...
                    onClick={() => handleOrder("65b80e5503257986161d0a0e")}
                    id="btn_purchase_6010e9f3eb38ac0a706af298"
                  >
                    Enroll Now
                  </Button>
                  <WhatsAppAnchor
                    message="Hello, I wanted to know more about Mix Martial Arts Workshop."
          ...
          <div className="container">
            ...
            <div className="row mt-4 align-items-center">
              ...
              <div className="col-lg-6">
                <div className="text-center">
                  <h2 className="h4-fs">Mix Martial Arts Demo Certificate</h2>
                  <img
                    className="lazy"
                    src={
                      process.env.PUBLIC_URL +
                      "/assets/images/certificate/english-course-martial-art.webp"
                    }
                    width="80%"
      ...
      <OurStudentsWords />
      <CourseReviewSection course_id="65b80e5503257986161d0a0e" />
...
export default EnglishMixMartialArtsWorkshop;
