...
function PowerGauge() {
  ...
  const product = [
    ...
    "/assets/images/equipment/power-gauge-inner-2.webp",
    "/assets/images/equipment/power-gauge-inner-3.webp",
    "/assets/images/equipment/power-gauge-inner-4.webp",
  ];
  useEffect(() => {
    const $ = window.$;
  ...
  return (
    <>
      <Helmet>
        <title>Power guage machine | Gomzi Fitness Equipment</title>
        <meta name="description" content="Maximize strength training with Gomzi's Power Gauge. A cornerstone of our fitness equipment, ideal for comprehensive cardio and strength workouts." />
        ...
        <meta property="og:title" content="Power guage machine | Gomzi Fitness Equipment" />
        <meta property="og:description" content="Maximize strength training with Gomzi's Power Gauge. A cornerstone of our fitness equipment, ideal for comprehensive cardio and strength workouts." />
        <meta property="og:image" content="https://fggroup.in/assets/images/logo/fg_group.webp" />
        <meta property="og:url" content="https://fggroup.in/equipments/power-gauget" />
      ...
      <main className="page--content p-0">
        ...
        >
          <div
            ...
            style={{
              backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/equipment/power-gauge-banner.webp)`,
            }}
          ></div>
          <div
          ...
          <section className="rich-text--section p-relative px-sides pb-48 800:pt-72 800:pb-72 d-none d-lg-block">
            <div className="row">
              ...
              <div className="col-lg-6 mt-4">
                ...
                >
                  <h2 className="h2-fs">
                    <b>Power Gauge: Your Strength Companion</b>
                  </h2>
                  <p>
                    The Power Gauge machine is a state-of-the-art strength
                    training equipment designed to measure and display real-time
                    power output during workouts. Its advanced technology
                    provides users with instant feedback on their performance,
                    including metrics such as power, force, velocity, and more.
                    By quantifying these variables, users can optimize their
                    training intensity, track progress, and identify areas for
                    improvement.
                  </p>
                  <p>
                    The machine offers various resistance settings and exercise
                    options to accommodate different fitness levels and goals.
                    With its user-friendly interface and accurate data
                    monitoring capabilities, the Power Gauge machine empowers
                    users to maximize their workouts and achieve their strength
                    and fitness objectives efficiently and effectively.
                  </p>
                  <ul>
                    <li className="mt-2">
                      Real-time Feedback: Provides instant feedback on power
                      output, force, velocity, and more during workouts.
                    </li>
                    <li className="mt-2">
                      Performance Tracking: Enables users to monitor progress
                      and make adjustments to their training intensity and
                      technique.
                    </li>
                    <li className="mt-2">
                      Optimal Training Intensity: Helps users optimize their
                      workouts by quantifying performance metrics and
                      identifying areas for improvement.
                    </li>
                    <li className="mt-2">
                      Versatile Exercise Options: Offers a diverse range of
                      exercises to target different muscle groups and fitness
                      goals.
                    </li>
                    <li className="mt-2">
                      Enhanced Motivation: Empowers users with data-driven
                      insights to stay motivated and committed to their fitness
                      journey.
                    </li>
                    <li className="mt-2">
                      Efficient Workouts: Maximizes the effectiveness of
                      workouts by ensuring users are training at the appropriate
                      intensity level to achieve their desired results.
                    </li>
                  </ul>
                </div>
              </div>
          ...
          >
            ...
            >
              <div
                ...
                style={{
                  backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/equipment/power-gauge-description-1.webp)`,
                }}
              ></div>
              <div
                ...
                >
                  <h2 className="h2-fs type--heading text-white">
                    ...
                    <span className="type--main-heading d-block h1 text-32-40 mt-4 text-white">
                      <b>Strength Elevated, Results Amplified</b>
                    </span>
                  </h2>
                  <div
                  ...
                  >
                    <p>
                      The Power Gauge machine revolutionizes strength training
                      with its cutting-edge technology, providing users with
                      precise measurements of power output in real-time. This
                      innovative equipment offers comprehensive feedback,
                      including metrics like force and velocity, enabling users
                      to fine-tune their workouts for optimal results. With
                      adjustable resistance settings and a versatile range of
                      exercises, the Power Gauge machine caters to individuals
                      of all fitness levels and training objectives. Its
                      intuitive interface and accurate data tracking
                      capabilities empower users to monitor progress, adjust
                      intensity, and optimize performance. Incorporating the
                      Power Gauge machine into workouts enhances accountability,
                      motivation, and overall training effectiveness, unlocking
                      the full potential of strength training regimens.
                    </p>
                  </div>
                </div>
              </div>
          ...
          >
            ...
            >
              <div
                ...
                style={{
                  backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/equipment/power-gauge-description-2.webp)`,
                }}
              ></div>
              <div
              ...
              >
                ...
                >
                  <h2 className="h2-fs type--heading text-white">
                    {/* <span className="type--sub-heading d-block h2 text-white"><b>TOTAL FITNESS</b></span> */}
                    <span className="type--main-heading d-block h1 text-32-40 mt-4 text-white">
                      <b>Precision Metrics, Powerful Results</b>
                    </span>
                  </h2>
                  <div
                    className="rich-text contains-links text-15-18 leading-140 font-sans text-white brand-colorway-red colorway-dark links-white contains-tables mt-24"
                  ...
                  >
                    <p>
                      The Power Gauge machine represents a paradigm shift in
                      strength training, providing users with unparalleled
                      insights into their performance. This advanced equipment
                      offers real-time data on power output, force, and
                      velocity, empowering users to optimize their training
                      intensity and technique. With customizable resistance
                      settings and a diverse range of exercises, the Power Gauge
                      machine accommodates various fitness levels and goals. Its
                      user-friendly interface and precise feedback foster
                      accountability and motivation, driving users to push their
                      limits and achieve optimal results. By integrating the
                      Power Gauge machine into their workouts, individuals can
                      unlock new levels of strength, performance, and overall
                      fitness prowess.
                    </p>
                  </div>
                </div>
