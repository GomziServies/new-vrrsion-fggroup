...
function BackBlaster() {
  ...
  const handleApplyForInquiry = async () => {
    try {
      ...
      await sendInquiry(
        ...
        email,
        phoneNumber,
        "FG Equipment Back Blaster page",
        modifiedMessage,
  ...
  const product = [
    ...
    "/assets/images/equipment/back-blaster-inner-2.webp",
    "/assets/images/equipment/back-blaster-inner-3.webp",
    "/assets/images/equipment/back-blaster-inner-4.webp",
  ];
  ...
  return (
    <>
      <Helmet>
        <title>Back Blaster Machine | Gomzi Equipment</title>
        <meta
          name="description"
          content="Reinvent your back workouts with Gomzi's Back Blaster Machine. A pivotal piece in our cardio equipment collection for superior upper body strength."
        />
        <meta
          name="keyword"
        ...
        <meta
          property="og:title"
          content="Back Blaster Machine | Gomzi Equipment"
        />
        <meta
        ...
        />
        <meta property="og:url" content="https://fggroup.in/equipments/back-blaster" />
      ...
      <main className="page--content p-0">
        ...
        >
          <div
            ...
            style={{
              backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/equipment/back-blaster-banner.webp)`,
            }}
          ></div>
          <div
          ...
          <section className="rich-text--section p-relative px-sides pb-48 800:pt-72 800:pb-72 d-none d-lg-block">
            <div className="row">
              ...
              <div className="col-lg-6 mt-4">
                ...
                >
                  <h2 className="h2-fs">
                    <b>Every moment matters</b>
                  </h2>
                  <p>
                    A back blaster machine is a versatile piece of exercise
                    equipment designed specifically to target and strengthen the
                    muscles of the back. It typically features an adjustable
                    padded seat and backrest for optimal comfort and support
                    during workouts. With handles or grips strategically placed,
                    users can perform a variety of exercises including lat
                    pull-downs, rows, and lower back extensions. These machines
                    often incorporate a weight stack or resistance system,
                    allowing users to customize their workout intensity.
                  </p>
                  <p>
                    Safety features such as secure locking mechanisms and
                    adjustable safety bars ensure exercises are performed
                    safely. Constructed from durable materials, back blaster
                    machines offer stability and longevity for consistent
                    training sessions.
                  </p>
                  <ul>
                    <li className="mt-2">
                      Enhances back muscle strength for better functionality.
                    </li>
                    <li className="mt-2">
                      Targets specific back muscles for balanced development.
                    </li>
                    <li className="mt-2">
                      Supports spine health by strengthening surrounding
                      muscles.
                    </li>
                    <li className="mt-2">
                      Reduces the risk of back injuries during daily activities.
                    </li>
                    <li className="mt-2">
                      Promotes better body alignment and spinal stability.
                    </li>
                    <li className="mt-2">
          ...
          >
            ...
            >
              <div
                ...
                style={{
                  backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/equipment/back-blaster-description-1.webp)`,
                }}
              ></div>
              <div
              ...
              >
                ...
                >
                  ...
                  >
                    <p>
                      The back blaster machine holds significant importance in
                      fitness regimes for several reasons. Primarily, it targets
                      and strengthens the often neglected muscles of the back,
                      promoting overall balance and stability in the body. By
                      enhancing back muscle strength, it contributes to better
                      posture, reducing the risk of back pain and injury.
                      Additionally, a strong back is crucial for various daily
                      activities and sports performance, improving functional
                      fitness and athleticism. Moreover, the back blaster
                      machine aids in spine health by supporting the surrounding
                      muscles, thereby promoting better alignment and reducing
                      strain on the spine. Overall, it plays a pivotal role in
          ...
          >
            ...
            >
              <div
                ...
                style={{
                  backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/equipment/back-blaster-description-2.webp)`,
                }}
              ></div>
              <div
              ...
              >
                ...
                >
                  ...
                  >
                    <p>
                      The back blaster machine is indispensable in fitness
                      routines due to its targeted focus on strengthening the
                      back muscles, which are often overlooked. Its importance
                      lies in its ability to enhance back muscle strength,
                      contributing to better posture, reduced risk of back pain,
                      and improved spinal stability. By fortifying the back, it
                      fosters overall body balance and functionality, crucial
                      for daily activities and athletic performance.
                      Additionally, the back blaster machine aids in preventing
                      injuries by strengthening supportive muscles around the
                      spine. Its inclusion in workout regimens ensures holistic
                      fitness, promoting a resilient and healthy back for a
