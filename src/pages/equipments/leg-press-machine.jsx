...
function LegPressMachine() {
  ...
  const handleApplyForInquiry = async () => {
    try {
      ...
      await sendInquiry(
        ...
        email,
        phoneNumber,
        "FG Equipment leg press machine Page",
        modifiedMessage,
  ...
  const product = [
    "/assets/images/equipment/leg-press-inner-1.webp",
    "/assets/images/equipment/leg-press-inner-2.webp",
    "/assets/images/equipment/leg-press-inner-3.webp",
    "/assets/images/equipment/leg-press-inner-4.webp",
  ];
  useEffect(() => {
    const $ = window.$;
  ...
  return (
    <>
      <Helmet>
        <title>Leg Press Machine | Gomzi equipment</title>
        <meta name="description" content="Enhance lower body strength with Gomzi's Leg Press Machine. A vital component of our cardio equipment lineup, perfect for effective leg workouts." />
        ...
        <meta property="og:title" content="Leg Press Machine | Gomzi equipment" />
        <meta property="og:description" content="Enhance lower body strength with Gomzi's Leg Press Machine. A vital component of our cardio equipment lineup, perfect for effective leg workouts." />
        <meta property="og:image" content="https://fggroup.in/assets/images/logo/fg_group.webp" />
        <meta property="og:url" content="https://fggroup.in/equipments/leg-press-machine" />
      ...
      <main className="page--content p-0">
        ...
        >
          <div
            ...
            style={{
              backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/equipment/leg-press-banner.webp)`,
            }}
          ></div>
          <div
          ...
          <section className="rich-text--section p-relative px-sides pb-48 800:pt-72 800:pb-72 d-none d-lg-block">
            <div className="row">
              ...
              <div className="col-lg-6 mt-4">
                ...
                >
                  <h2 className="h2-fs">
                    <b>Rise with leg strength</b>
                  </h2>
                  <p>
                    The leg press machine is a staple in strength training,
                    targeting the muscles of the lower body, particularly the
                    quadriceps, hamstrings, and glutes. Its ergonomic design
                    typically consists of a seat, backrest, and footplate, with
                    adjustable weight plates for resistance. Users sit on the
                    seat and push against the footplate to extend their legs,
                    lifting the loaded weight.
                  </p>
                  <p>
                    This exercise effectively mimics functional movements like
                    squatting and lunging while providing support for the back
                    and knees. The leg press machine offers a safe and efficient
                    way to build lower body strength, improve muscle tone, and
          ...
          >
            ...
            >
              <div
                ...
                style={{
                  backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/equipment/leg-press-description-1.webp)`,
                }}
              ></div>
              <div
                ...
                >
                  <h2 className="h2-fs type--heading text-white">
                    ...
                    <span className="type--main-heading d-block h1 text-32-40 mt-4 text-white">
                      <b>Forge stronger, resilient legs</b>
                    </span>
                  </h2>
                  <div
                  ...
                  >
                    <p>
                      The leg press machine is a versatile piece of gym
                      equipment designed to target the major muscle groups of
                      the lower body. With its adjustable seat and footplate,
                      users can customize their workout to their specific needs
                      and fitness level. By pushing against the footplate, users
                      engage their quadriceps, hamstrings, glutes, and calves,
                      promoting muscle growth and strength. This exercise is
                      particularly beneficial for individuals looking to build
                      lower body strength without putting excess strain on the
                      back or knees. The leg press machine offers a safe and
                      effective way to improve leg strength, enhance muscular
                      endurance, and support functional movements in daily life.
                    </p>
                  </div>
                </div>
              </div>
          ...
          >
            ...
            >
              <div
                ...
                style={{
                  backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/equipment/leg-press-description-2.webp)`,
                }}
              ></div>
              <div
              ...
              >
                ...
                >
                  ...
                  >
                    <p>
                      The leg press machine provides a controlled and effective
                      way to strengthen the lower body muscles, including the
                      quadriceps, hamstrings, and glutes. With its ergonomic
                      design and adjustable settings, users can perform the
                      exercise comfortably and safely, regardless of their
                      fitness level. By pushing against the footplate,
                      individuals can increase resistance gradually, challenging
                      their muscles and promoting growth over time.
                    </p>
                    <p>
                      This machine is particularly beneficial for athletes
                      looking to improve their leg strength and power for sports
                      performance, as well as for individuals seeking to tone
                      and sculpt their lower body muscles. Incorporating the leg
                      press machine into a workout routine can help enhance
                      overall lower body strength, stability, and muscular
                      endurance.
                    </p>
                  </div>
                </div>
