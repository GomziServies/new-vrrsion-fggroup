...
function PlateLoader() {
  ...
  const handleApplyForInquiry = async () => {
    try {
      ...
      await sendInquiry(
        ...
        email,
        phoneNumber,
        "FG Equipment Plate Loader Page",
        modifiedMessage,
  ...
  const product = [
    "/assets/images/equipment/plate-loader-inner-1.webp",
    "/assets/images/equipment/plate-loader-inner-2.webp",
    "/assets/images/equipment/plate-loader-inner-3.webp",
    "/assets/images/equipment/plate-loader-inner-4.webp",
  ];
  useEffect(() => {
    const $ = window.$;
  ...
  return (
    <>
      <Helmet>
        <title>Plate Loader Machine - Gomzi Ftiness Equiptment</title>
        <meta name="description" content="The Gomzi Fitness Plate Loader Machine Is A Versatile Strength Fitness Equipment, Allowing Users To Add Or Remove Plates For Resistance During Exercises - Gomzi Ftiness Equiptment." />
        ...
        <meta property="og:title" content="Plate Loader Machine - Gomzi Ftiness Equiptment" />
        <meta property="og:description" content="The Gomzi Fitness Plate Loader Machine Is A Versatile Strength Fitness Equipment, Allowing Users To Add Or Remove Plates For Resistance During Exercises - Gomzi Ftiness Equiptment." />
        <meta property="og:image" content="https://fggroup.in/assets/images/logo/fg_group.webp" />
        <meta property="og:url" content="https://fggroup.in/equipments/plate-loader" />
      ...
      <main className="page--content p-0">
        ...
        >
          <div
            ...
            style={{
              backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/equipment/plate-loader-banner.webp)`,
            }}
          ></div>
          <div
          ...
          <section className="rich-text--section p-relative px-sides pb-48 800:pt-72 800:pb-72 d-none d-lg-block">
            <div className="row">
              ...
              <div className="col-lg-6 mt-4">
                ...
                >
                  <h2 className="h2-fs">
                    <b>Strength forged with plates</b>
                  </h2>
                  <p>
                    Weight plate loaders are essential gym equipment used to
                    organize and secure weight plates on weightlifting bars.
                    These devices come in various designs, including
                    Olympic-style plate loaders and standard plate loaders, each
                    designed to accommodate specific bar sizes and plate types.
                    Weight plate loaders simplify the process of loading and
                    unloading weight plates onto bars, enhancing workout
                    efficiency and safety.
                  </p>
                  <p>
                    With their sturdy construction and easy-to-use features,
                    weight plate loaders ensure secure attachment of plates to
                    the bar, minimizing the risk of accidents during lifting
                    sessions. They are indispensable tools in strength training
                    facilities, providing convenience and reliability for
                    weightlifting enthusiasts of all levels.
                  </p>
                  <ul>
                    <li className="mt-2">
                      Versatility: Weight plate exercises offer a wide range of
                      movements targeting various muscle groups.
                    </li>
                    <li className="mt-2">
                      Strength Building: They promote muscle growth and
                      development, enhancing overall strength.
                    </li>
                    <li className="mt-2">
                      Functional Fitness: Weight plate exercises mimic real-life
                      movements, improving functional strength and mobility.
                    </li>
                    <li className="mt-2">
                      Core Engagement: Many weight plate exercises engage the
                      core muscles, promoting stability and balance.
                    </li>
                    <li className="mt-2">
                      Cardiovascular Endurance: Incorporating weight plate
                      exercises into circuits or intervals can boost heart rate
                      and improve cardiovascular health.
                    </li>
                    <li className="mt-2">
                      Coordination and Balance: These exercises challenge
                      coordination and balance, enhancing overall athleticism.
                    </li>
                  </ul>
                </div>
              </div>
          ...
          >
            ...
            >
              <div
                ...
                style={{
                  backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/equipment/plate-loader-description-1.webp)`,
                }}
              ></div>
              <div
              ...
              >
                ...
                >
                  ...
                  >
                    <p>
                      Weight plate loaders are indispensable tools in gym
                      environments, facilitating the efficient loading and
                      unloading of weight plates onto bars. Their ergonomic
                      designs streamline the process, reducing the time spent
                      preparing equipment for workouts. Whether Olympic-style or
                      standard loaders, these devices offer compatibility with
                      various bar sizes and plate types, ensuring versatility in
                      use. With sturdy construction and user-friendly features,
                      weight plate loaders prioritize safety, securely holding
                      plates in place during lifts. They enhance the overall gym
                      experience by promoting organization, convenience, and
                      ease of use. Weight plate loaders are essential components
                      of strength training setups, catering to the needs of
                      lifters at all skill levels.
                    </p>
                  </div>
                </div>
              </div>
          ...
          >
            ...
            >
              <div
                ...
                style={{
                  backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/equipment/plate-loader-description-2.webp)`,
                }}
              ></div>
              <div
              ...
              >
                ...
                >
                  ...
                  >
                    <p>
                      Weight plate exercises encompass a diverse array of
                      dynamic movements using weighted plates, offering a
                      comprehensive workout targeting multiple muscle groups.
                      From classic exercises like squats, lunges, and deadlifts
                      to more specialized movements like plate twists and
                      overhead presses, weight plate exercises promote strength,
                      endurance, and overall fitness.
                    </p>
                    <p>
                      The versatility of weight plates allows for progressive
                      resistance training, accommodating users of all fitness
                      levels and goals. These exercises enhance muscle
                      development, improve functional strength, and contribute
                      to better athletic performance. Incorporating weight plate
                      exercises into a fitness routine adds variety, challenges
                      the body in new ways, and fosters continual growth and
                      improvement.
                    </p>
                  </div>
                </div>
