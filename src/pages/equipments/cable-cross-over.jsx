...
function CableCrossOver() {
  ...
  const handleApplyForInquiry = async () => {
    try {
      ...
      await sendInquiry(
        ...
        email,
        phoneNumber,
        "FG Equipment Cable Cross Over Page",
        modifiedMessage,
  ...
  const product = [
    "/assets/images/equipment/cable-cross-over-inner-1.webp",
    "/assets/images/equipment/cable-cross-over-inner-2.webp",
    "/assets/images/equipment/cable-cross-over-inner-3.webp",
  ...
  return (
    <>
      <Helmet>
        <title>Multi purpose Cable cross over | Gomzi equipment</title>
        <meta
          name="description"
          content="Elevate your fitness routine with Gomzi's Multi-Purpose Cable Crossover. Cardio equipment for dynamic workouts targeting multiple muscle group."
        />
        <meta
          name="keyword"
        ...
        <meta
          property="og:title"
          content="Multi purpose Cable cross over | Gomzi equipment"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://fggroup.in/equipments/cable-cross-over"
        />
      ...
      <main className="page--content p-0">
        ...
        >
          <div
            ...
            style={{
              backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/equipment/multi-purpose-cable-banner.webp)`,
            }}
          ></div>
          <div
          ...
          <section className="rich-text--section p-relative px-sides pb-48 800:pt-72 800:pb-72 d-none d-lg-block">
            <div className="row">
              ...
              <div className="col-lg-6 mt-4">
                ...
                >
                  <h2 className="h2-fs">
                    <b>Power in Precision</b>
                  </h2>
                  <p>
                    The Cable Cross Over machine is a versatile piece of gym
                    equipment designed to target multiple muscle groups
                    simultaneously. By using adjustable cable pulleys, it allows
                    for a wide range of exercises that work the chest,
                    shoulders, and arms. Its design enables smooth and
                    controlled movements in various planes of motion, promoting
                    muscle activation and development from different angles.
                  </p>
                  <p>
                    The machine's versatility makes it suitable for users of all
                    fitness levels and goals, from muscle building to toning and
                    endurance training. Incorporating Cable Cross Over exercises
                    into workouts can lead to improved muscle definition,
                    strength, and overall upper body fitness.
                  </p>
                  <ul>
                    <li className="mt-2">
                      Versatile: Allows for a wide range of exercises targeting
                      multiple muscle groups.
                    </li>
                    <li className="mt-2">
                      Smooth Motion: Provides smooth and controlled movements,
                      minimizing strain on joints and muscles.
                    </li>
                    <li className="mt-2">
                      Muscle Engagement: Promotes optimal muscle activation and
                      development from various angles.
                    </li>
                    <li className="mt-2">
                      Muscle Definition: Helps sculpt and define muscles for a
                      toned and aesthetic physique.
                    </li>
                    <li className="mt-2">
                      Suitable for All Levels: Suitable for beginners to
                      advanced athletes, allowing progression over time.
                    </li>
                  </ul>
                </div>
              </div>
          ...
          >
            ...
            >
              <div
                ...
                style={{
                  backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/equipment/cable-cross-over-description-1.webp)`,
                }}
              ></div>
              <div
                ...
                >
                  <h2 className="h2-fs type--heading text-white">
                    ...
                    <span className="type--main-heading d-block h1 text-32-40 mt-4 text-white">
                      <b>Versatile Strength, Targeted Precision</b>
                    </span>
                  </h2>
                  <div
                  ...
                  >
                    <p>
                      The Cable Cross Over machine offers unparalleled
                      versatility in strength training, providing an array of
                      exercises to target the chest, shoulders, and arms with
                      precision. Its adjustable pulleys allow for customizable
                      resistance levels, catering to users of all fitness levels
                      and goals. With its smooth and fluid motion, this machine
                      promotes muscle engagement and development across multiple
                      planes, enhancing overall upper body strength and
                      stability. Whether aiming for muscle hypertrophy, toning,
                      or functional strength, incorporating Cable Cross Over
                      exercises into routines yields noticeable improvements in
                      muscle definition, endurance, and athletic performance
                      over time, making it a staple in any comprehensive
          ...
          >
            ...
            >
              <div
                ...
                style={{
                  backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/equipment/cable-cross-over-description-2.webp)`,
                }}
              ></div>
              <div
              ...
              >
                ...
                >
                  <h2 className="h2-fs type--heading text-white">
                    {/* <span className="type--sub-heading d-block h2 text-white"><b>TOTAL FITNESS</b></span> */}
                    <span className="type--main-heading d-block h1 text-32-40 mt-4 text-white">
                      <b>Unleash Your Upper Body Potential</b>
                    </span>
                  </h2>
                  <div
                    className="rich-text contains-links text-15-18 leading-140 font-sans text-white brand-colorway-red colorway-dark links-white contains-tables mt-24"
                  ...
                  >
                    <p>
                      The Cable Cross Over machine revolutionizes upper body
                      workouts with its adaptable design, facilitating countless
                      exercise variations for comprehensive muscle development.
                      Its intuitive pulley system ensures smooth resistance
                      throughout each movement, fostering optimal muscle
                      engagement and growth. Its versatility makes it a valuable
                      asset for individuals seeking to sculpt their chest,
                      shoulders, and arms, regardless of their fitness level or
                      training goals. Whether aiming to build muscle mass,
                      enhance definition, or improve functional strength, this
                      machine offers unparalleled effectiveness and efficiency.
                      Incorporating Cable Cross Over exercises into regular
                      routines delivers measurable results, empowering users to
                      achieve their desired physique and performance objectives
