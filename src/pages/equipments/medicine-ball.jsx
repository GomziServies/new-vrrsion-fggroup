...
function MedicineBall() {
  ...
  const handleApplyForInquiry = async () => {
    try {
      ...
      await sendInquiry(
        ...
        email,
        phoneNumber,
        "FG Equipment Medicine Ball Page",
        modifiedMessage,
  ...
  const product = [
    "/assets/images/equipment/medicine-ball-inner-1.webp",
    "/assets/images/equipment/medicine-ball-inner-2.webp",
    "/assets/images/equipment/medicine-ball-inner-3.webp",
    "/assets/images/equipment/medicine-ball-inner-4.webp",
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://fggroup.in/equipments/medicine-ball" />
      ...
      <main className="page--content p-0">
        ...
        >
          <div
            ...
            style={{
              backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/equipment/medicine-ball-banner.webp)`,
            }}
          ></div>
          <div
          ...
          <section className="rich-text--section p-relative px-sides pb-48 800:pt-72 800:pb-72 d-none d-lg-block">
            <div className="row">
              ...
              <div className="col-lg-6 mt-4">
                ...
                >
                  <h2 className="h2-fs">
                    <b>Elevate Your Fitness Game</b>
                  </h2>
                  <p>
                    Medicine ball exercises are dynamic and effective additions
                    to any workout routine, offering a versatile way to improve
                    strength, power, and coordination. These exercises involve
                    using a weighted ball, typically ranging from 2 to 25
                    pounds, to perform various movements such as throws, twists,
                    and slams. They engage multiple muscle groups
                    simultaneously, making them efficient for full-body
                    workouts.
                  </p>
                  <p>
                    Medicine ball exercises can be tailored to suit individual
                    fitness levels and goals, making them suitable for beginners
                    and advanced athletes alike. Additionally, they can be
                    integrated into circuit training or HIIT workouts for an
                    added cardiovascular challenge. Incorporating medicine ball
                    exercises into your regimen enhances overall functional
                    fitness and athletic performance.
                  </p>
                  <ul>
                    <li className="mt-2">
                      Full-body Workout: Engages multiple muscle groups
                      simultaneously, providing comprehensive training.
                    </li>
                    <li className="mt-2">
                      Improved Strength: Builds muscle strength and endurance,
                      particularly in the core, arms, and legs.
                    </li>
                    <li className="mt-2">
                      Enhanced Power: Develops explosive strength and power,
                      beneficial for sports performance and functional
                      movements.
                    </li>
                    <li className="mt-2">
                      Improved Coordination and Balance: Challenges coordination
                      and balance due to the dynamic nature of the exercises.
                    </li>
                    <li className="mt-2">
                      Functional Fitness: Mimics real-life movements, improving
          ...
          >
            ...
            >
              <div
                ...
                style={{
                  backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/equipment/medicine-ball-description-1.webp)`,
                }}
              ></div>
              <div
                ...
                >
                  <h2 className="h2-fs type--heading text-white">
                    ...
                    <span className="type--main-heading d-block h1 text-32-40 mt-4 text-white">
                      <b>Dynamic Fitness with Medicine Balls</b>
                    </span>
                  </h2>
                  <div
                  ...
                  >
                    <p>
                      Medicine ball exercises provide a dynamic and functional
                      approach to fitness, engaging multiple muscle groups while
                      improving coordination and balance. These versatile
                      workouts can be adapted to suit various fitness levels and
                      goals, making them accessible to beginners and challenging
                      for seasoned athletes. From explosive throws to rotational
                      twists and core-strengthening slams, the possibilities are
                      endless. Additionally, medicine ball exercises can be
                      incorporated into circuit training or interval workouts to
                      boost cardiovascular endurance and calorie burn. Whether
                      used for rehabilitation, sports-specific training, or
                      general fitness, medicine ball exercises offer a fun and
                      effective way to enhance overall strength, power, and
                      agility.
                    </p>
                  </div>
                </div>
          ...
          >
            ...
            >
              <div
                ...
                style={{
                  backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/equipment/medicine-ball-description-2.webp)`,
                }}
              ></div>
              <div
              ...
              >
                ...
                >
                  <h2 className="h2-fs type--heading text-white">
                    {/* <span className="type--sub-heading d-block h2 text-white"><b>TOTAL FITNESS</b></span> */}
                    <span className="type--main-heading d-block h1 text-32-40 mt-4 text-white">
                      <b>Medicine Ball Workouts: Elevate Your Fitness</b>
                    </span>
                  </h2>
                  <div
                    className="rich-text contains-links text-15-18 leading-140 font-sans text-white brand-colorway-red colorway-dark links-white contains-tables mt-24"
                  ...
                  >
                    <p>
                      Medicine ball exercises offer a dynamic and engaging way
                      to build strength, power, and agility. With a range of
                      movements including throws, twists, and slams, they target
                      multiple muscle groups simultaneously, providing a
                      full-body workout. Whether you're a beginner or an
                      experienced athlete, medicine ball exercises can be
                      tailored to your fitness level and goals. They not only
                      improve muscle strength but also enhance coordination,
                      balance, and flexibility. Additionally, incorporating
                      medicine ball exercises into your routine can help boost
                      cardiovascular fitness and burn calories. Versatile and
                      effective, these exercises are a valuable addition to any
                      fitness regimen, promoting overall health and well-being.
                    </p>
                  </div>
                </div>
              </div>
