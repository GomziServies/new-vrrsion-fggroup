...
function ChestPress() {
  ...
  const handleApplyForInquiry = async () => {
    try {
      ...
      await sendInquiry(
        ...
        email,
        phoneNumber,
        "FG Equipment Chest Press Machine Page",
        modifiedMessage,
  ...
  const product = [
    ...
    "/assets/images/equipment/chest-press-inner-2.webp",
    "/assets/images/equipment/chest-press-inner-3.webp",
    "/assets/images/equipment/chest-press-inner-4.webp",
  ];
  useEffect(() => {
    const $ = window.$;
  ...
  return (
    <>
      <Helmet>
        <title>Machine chest press machine | Gomzi equipment</title>
        <meta name="description" content="Experience superior chest workouts with Gomzi's chest press machine, an essential part of our cardio equipment lineup for total upper body strength." />
        ...
        <meta property="og:title" content="Machine chest press machine | Gomzi equipment" />
        <meta property="og:description" content="Experience superior chest workouts with Gomzi's chest press machine, an essential part of our cardio equipment lineup for total upper body strength." />
        <meta property="og:image" content="https://fggroup.in/assets/images/logo/fg_group.webp" />
        <meta property="og:url" content="https://fggroup.in/equipments/chest-press" />
      ...
      <main className="page--content p-0">
        ...
        >
          <div
            ...
            style={{
              backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/equipment/machine-chest-press-banner.webp)`,
            }}
          ></div>
          <div
          ...
          <section className="rich-text--section p-relative px-sides pb-48 800:pt-72 800:pb-72 d-none d-lg-block">
            <div className="row">
              ...
              <div className="col-lg-6 mt-4">
                ...
                >
                  <h2 className="h2-fs">
                    <b>Sculpt Your Strength</b>
                  </h2>
                  <p>
                    The Chest Press machine is a fundamental component of
                    strength training, focusing on developing the chest,
                    shoulders, and triceps muscles. Its ergonomic design
                    provides stability and support, ensuring proper form and
                    maximizing muscle engagement. By pushing weighted resistance
                    away from the body, it targets the pectoralis major and
                    minor muscles, leading to increased strength and definition
                    in the chest region. With adjustable settings to accommodate
                    various fitness levels, this machine is suitable for
                    beginners to advanced athletes.
                  </p>
                  <p>
                    Regular use of the Chest Press machine contributes to
                    improved upper body strength, muscle tone, and overall
                    functional fitness, making it a cornerstone of any
                    comprehensive workout routine.
                  </p>
                  <ul>
                    <li className="mt-2">
                      Targeted Muscle Development: Focuses on strengthening the
                      chest, shoulders, and triceps muscles.
                    </li>
                    <li className="mt-2">
                      Optimal Muscle Engagement: Provides stability and
                      precision, ensuring proper alignment and maximum muscle
                      activation.
                    </li>
                    <li className="mt-2">
                      Adjustable Resistance: Allows for customizable resistance
                      levels to accommodate different fitness levels and goals.
                    </li>
                    <li className="mt-2">
                      Muscle Growth and Definition: Effectively targets the
                      pectoral muscles, promoting both size and definition.
                    </li>
                    <li className="mt-2">
                      Versatility: Accommodates users of all fitness levels,
                      fostering progression over time.
                    </li>
                  </ul>
                </div>
              </div>
          ...
          >
            ...
            >
              <div
                ...
                style={{
                  backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/equipment/chest-press-description-1.webp)`,
                }}
              ></div>
              <div
                ...
                >
                  <h2 className="h2-fs type--heading text-white">
                    ...
                    <span className="type--main-heading d-block h1 text-32-40 mt-4 text-white">
                      <b>Strength, Precision, Results</b>
                    </span>
                  </h2>
                  <div
                  ...
                  >
                    <p>
                      The Chest Press machine stands as a cornerstone of upper
                      body strength training, meticulously crafted to hone the
                      chest, shoulders, and triceps. Its ergonomic design
                      ensures stability and precision, optimizing muscle
                      engagement with every rep. By exerting force against
                      adjustable resistance, it targets the pectoral muscles,
                      fostering growth and definition. Versatile settings
                      accommodate users of all fitness levels, from novices to
                      seasoned athletes, fostering progression over time.
                      Consistent utilization of the Chest Press machine yields
                      tangible results: heightened upper body strength, sculpted
                      muscles, and enhanced functional fitness. Elevate your
                      workout regimen with this essential machine, empowering
                      your journey to a stronger, more resilient physique.
                    </p>
                  </div>
                </div>
              </div>
          ...
          >
            ...
            >
              <div
                ...
                style={{
                  backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/equipment/chest-press-description-2.webp)`,
                }}
              ></div>
              <div
              ...
              >
                ...
                >
                  <h2 className="h2-fs type--heading text-white">
                    {/* <span className="type--sub-heading d-block h2 text-white"><b>TOTAL FITNESS</b></span> */}
                    <span className="type--main-heading d-block h1 text-32-40 mt-4 text-white">
                      <b>Unlock Your Upper Body Power</b>
                    </span>
                  </h2>
                  <div
                    className="rich-text contains-links text-15-18 leading-140 font-sans text-white brand-colorway-red colorway-dark links-white contains-tables mt-24"
                  ...
                  >
                    <p>
                      The Chest Press machine is a pinnacle of upper body
                      training, meticulously engineered to sculpt and strengthen
                      the chest, shoulders, and triceps. Its intuitive design
                      ensures stability and proper alignment, facilitating
                      optimal muscle activation and growth. By pushing against
                      adjustable resistance, it effectively targets the pectoral
                      muscles, promoting both size and definition. With
                      customizable settings to accommodate diverse fitness
                      levels, it caters to beginners and seasoned athletes
                      alike, fostering continual progress. Regular incorporation
                      of the Chest Press machine into your routine yields
                      tangible benefits: enhanced upper body strength, sculpted
                      muscles, and improved functional capacity. Elevate your
                      fitness journey with this indispensable tool, and unlock
                      your full potential.
                    </p>
                  </div>
                </div>
