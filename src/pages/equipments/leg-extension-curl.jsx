...
function LegExtensionCurl() {
  ...
  const handleApplyForInquiry = async () => {
    try {
      ...
      await sendInquiry(
        ...
        email,
        phoneNumber,
        "FG Equipment Leg extension & curl Page",
        modifiedMessage,
  ...
  const product = [
    "/assets/images/equipment/leg-extension-curl-inner-1.webp",
    "/assets/images/equipment/leg-extension-curl-inner-2.webp",
    "/assets/images/equipment/leg-extension-curl-inner-3.webp",
    "/assets/images/equipment/leg-extension-curl-inner-4.webp",
  ];
  useEffect(() => {
    const $ = window.$;
  ...
  return (
    <>
      <Helmet>
        <title>Leg Extension & Curl Machine - Gomzi Ftiness Equiptment</title>
        <meta name="description" content="The Gomzi Fitness Leg Extension & Curl Machine Is A Robust Workout Gym Gear  Lower Body Muscles,  Ensures Support During Leg Exercises, Gomzi Ftiness Equiptment." />
        ...
        <meta property="og:title" content="Leg Extension & Curl Machine - Gomzi Ftiness Equiptment" />
        <meta property="og:description" content="The Gomzi Fitness Leg Extension & Curl Machine Is A Robust Workout Gym Gear  Lower Body Muscles,  Ensures Support During Leg Exercises, Gomzi Ftiness Equiptment." />
        <meta property="og:image" content="https://fggroup.in/assets/images/logo/fg_group.webp" />
        <meta property="og:url" content="https://fggroup.in/equipments/leg-extension-curl" />
      ...
      <main className="page--content p-0">
        ...
        >
          <div
            ...
            style={{
              backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/equipment/leg-extension-curl-banner.webp)`,
            }}
          ></div>
          <div
          ...
          <section className="rich-text--section p-relative px-sides pb-48 800:pt-72 800:pb-72 d-none d-lg-block">
            <div className="row">
              ...
              <div className="col-lg-6 mt-4">
                ...
                >
                  <h2 className="h2-fs">
                    <b>Leg Strength Defined</b>
                  </h2>
                  <p>
                    The Leg Extension Curl machine is a staple in leg
                    strengthening routines, targeting the quadriceps and
                    hamstring muscles. With its adjustable settings, it caters
                    to users of all fitness levels, facilitating progression
                    over time. The leg extension component isolates the
                    quadriceps, promoting muscle growth and definition, while
                    the leg curl focuses on the hamstrings, enhancing strength
                    and stability.
                  </p>
                  <p>
                    Its ergonomic design ensures proper alignment and support,
                    minimizing strain on the joints and reducing injury risk.
                    Incorporating the Leg Extension Curl machine into workouts
                    leads to improved lower body strength, muscle balance, and
                    functional fitness, essential for optimal athletic
                    performance and overall well-being.
                  </p>
                  <ul>
                    <li className="mt-2">
                      Quadriceps Strengthening: Targets and strengthens the
                      quadriceps muscles located in the front of the thigh.
                    </li>
                    <li className="mt-2">
                      Hamstring Activation: Engages the hamstrings, promoting
                      strength and stability in the posterior chain.
                    </li>
                    <li className="mt-2">
                      Muscle Balance: Helps achieve a balanced lower body by
                      targeting both the front and back thigh muscles.
                    </li>
                    <li className="mt-2">
                      Joint Stability: Enhances stability around the knee joint,
                      reducing the risk of injuries.
                    </li>
                    <li className="mt-2">
                      Improved Muscle Definition: Promotes muscle definition and
                      tone in the thighs.
                    </li>
                    <li className="mt-2">
                      Performance Enhancement: Improves athletic performance in
                      activities such as running, jumping, and squatting.
                    </li>
                  </ul>
                </div>
              </div>
          ...
          >
            ...
            >
              <div
                ...
                style={{
                  backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/equipment/leg-extension-curl-description-1.webp)`,
                }}
              ></div>
              <div
              ...
              >
                ...
                >
                  ...
                  >
                    <p>
                      The Leg Extension Curl machine is a versatile piece of
                      equipment designed to target specific muscle groups in the
                      lower body. Its leg extension function isolates and
                      strengthens the quadriceps, aiding in muscle definition
                      and development. Conversely, the leg curl component
                      targets the hamstrings, improving strength and stability
                      in the posterior chain. This machine's adjustable settings
                      accommodate users of varying fitness levels, ensuring
                      progressive overload for continued growth and improvement.
                      By promoting proper alignment and providing adequate
                      support, it minimizes the risk of injury while maximizing
                      muscle engagement. Regular use of the Leg Extension Curl
                      machine enhances lower body strength, muscle balance, and
          ...
          >
            ...
            >
              <div
                ...
                style={{
                  backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/equipment/leg-extension-curl-description-2.webp)`,
                }}
              ></div>
              <div
              ...
              >
                ...
                >
                  <h2 className="h2-fs type--heading text-white">
                    {/* <span className="type--sub-heading d-block h2 text-white"><b>TOTAL FITNESS</b></span> */}
                    <span className="type--main-heading d-block h1 text-32-40 mt-4 text-white">
                      <b>Legs of Steel, Unleashed Potential</b>
                    </span>
                  </h2>
                  <div
                    className="rich-text contains-links text-15-18 leading-140 font-sans text-white brand-colorway-red colorway-dark links-white contains-tables mt-24"
                  ...
                  >
                    <p>
                      The Leg Extension Curl machine offers tailored training
                      for both the quadriceps and hamstrings, crucial muscle
                      groups in lower body strength and stability. Its leg
                      extension feature isolates and strengthens the front thigh
                      muscles, fostering definition and power. Meanwhile, the
                      leg curl function targets the rear thigh muscles,
                      enhancing strength and coordination.
                    </p>
                    <p>
                      This machine's customizable settings accommodate users of
                      diverse fitness levels, ensuring a progressive and
                      effective workout experience. With its ergonomic design
                      promoting proper alignment and support, it minimizes
                      strain on joints, reducing injury risks. Regular
                      utilization of the Leg Extension Curl machine leads to
                      enhanced lower body strength, muscle symmetry, and overall
                      functional capacity.
                    </p>
                  </div>
                </div>
...
export default LegExtensionCurl;
