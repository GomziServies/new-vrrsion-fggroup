...
function MachineChestFlies() {
  ...
  const handleApplyForInquiry = async () => {
    try {
      ...
      await sendInquiry(
        ...
        email,
        phoneNumber,
        "FG Equipment Chest Flies Machine Page",
        modifiedMessage,
  ...
  const product = [
    "/assets/images/equipment/machine-chest-flies-inner-1.webp",
    "/assets/images/equipment/machine-chest-flies-inner-2.webp",
    "/assets/images/equipment/machine-chest-flies-inner-3.webp",
    "/assets/images/equipment/machine-chest-flies-inner-4.webp",
  ];
  useEffect(() => {
    const $ = window.$;
  ...
  return (
    <>
      <Helmet>
        <title>Machine Chest Files - Gomzi Ftiness Equiptment</title>
        <meta name="description" content="The Gomzi Fitness Chest Fly Machine Is Designed For Targeted Chest Workouts Gear, Comfortable Padding For Optimal Muscles - Gomzi Ftiness Equiptment." />
        ...
        <meta property="og:title" content="Machine Chest Files - Gomzi Ftiness Equiptment" />
        <meta property="og:description" content="The Gomzi Fitness Chest Fly Machine Is Designed For Targeted Chest Workouts Gear, Comfortable Padding For Optimal Muscles - Gomzi Ftiness Equiptment." />
        <meta property="og:image" content="https://fggroup.in/assets/images/logo/fg_group.webp" />
        <meta property="og:url" content="https://fggroup.in/equipments/machine-chest-flies" />
      ...
      <main className="page--content p-0">
        ...
        >
          <div
            ...
            style={{
              backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/equipment/machine-chest-flies-banner.webp)`,
            }}
          ></div>
          <div
          ...
          <section className="rich-text--section p-relative px-sides pb-48 800:pt-72 800:pb-72 d-none d-lg-block">
            <div className="row">
              ...
              <div className="col-lg-6 mt-4">
                ...
                >
                  <h2 className="h2-fs">
                    <b>Mastering Chest Strength with Flies</b>
                  </h2>
                  <p>
                    The Chest Flies machine is a fundamental component of
                    chest-focused workouts, targeting the pectoral muscles. Its
                    design allows for a controlled and isolated movement,
                    effectively engaging the chest muscles. By mimicking the
                    motion of a fly exercise with dumbbells, this machine
                    provides constant tension throughout the range of motion,
                    promoting muscle growth and definition.
                  </p>
                  <p>
                    Adjustable settings accommodate users of varying fitness
                    levels and preferences, ensuring a personalized workout
                    experience. Incorporating the Chest Flies machine into
                    routines enhances chest strength, improves muscle balance,
                    and contributes to a well-rounded upper body development.
                    It's an essential tool for achieving a sculpted and powerful
                    chest.
                  </p>
                  <ul>
                    <li className="mt-2">
                      Targeted Chest Development: Effectively targets and
                      strengthens the pectoral muscles.
                    </li>
                    <li className="mt-2">
                      Improved Muscle Definition: Promotes muscle growth and
                      definition in the chest area.
                    </li>
                    <li className="mt-2">
                      Increased Muscle Activation: Provides a full range of
                      motion, engaging the chest muscles throughout.
                    </li>
                    <li className="mt-2">
                      Reduced Risk of Imbalances: Contributes to muscle balance
                      by targeting both sides of the chest equally.
                    </li>
                    <li className="mt-2">
                      Injury Prevention: Strengthens supporting muscles,
                      reducing the risk of chest-related injuries.
                    </li>
                    <li className="mt-2">
                      Versatility: Can be performed using various equipment,
                      including dumbbells, cables, or a chest fly machine.
                    </li>
                  </ul>
                </div>
              </div>
          ...
          >
            ...
            >
              <div
                ...
                style={{
                  backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/equipment/chest-flies-description-1.webp)`,
                }}
              ></div>
              <div
                ...
                >
                  <h2 className="h2-fs type--heading text-white">
                    ...
                    <span className="type--main-heading d-block h1 text-32-40 mt-4 text-white">
                      <b>Maximize Your Chest Definition</b>
                    </span>
                  </h2>
                  <div
                  ...
                  >
                    <p>
                      The Chest Flies machine is a cornerstone of chest
                      training, offering targeted isolation for pectoral
                      muscles. Its smooth, controlled motion ensures effective
                      engagement throughout the exercise. Mimicking the natural
                      fly movement, this machine provides consistent tension,
                      fostering muscle growth and definition. Adjustable
                      settings cater to diverse fitness levels, accommodating
                      beginners to advanced users. Regular use enhances chest
                      strength, improves muscle balance, and contributes to
                      overall upper body development. Incorporating the Chest
                      Flies machine into workouts leads to a sculpted, powerful
                      chest, essential for a balanced physique and functional
                      strength. Elevate your chest training with this essential
                      gym equipment.
                    </p>
                  </div>
                </div>
          ...
          >
            ...
            >
              <div
                ...
                style={{
                  backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/equipment/chest-flies-description-2.webp)`,
                }}
              ></div>
              <div
              ...
              >
                ...
                >
                  <h2 className="h2-fs type--heading text-white">
                    {/* <span className="type--sub-heading d-block h2 text-white"><b>TOTAL FITNESS</b></span> */}
                    <span className="type--main-heading d-block h1 text-32-40 mt-4 text-white">
                      <b>Define Your Chest Potential</b>
                    </span>
                  </h2>
                  <div
                    className="rich-text contains-links text-15-18 leading-140 font-sans text-white brand-colorway-red colorway-dark links-white contains-tables mt-24"
                  ...
                  >
                    <p>
                      The Chest Flies machine is a vital tool for sculpting and
                      strengthening the chest muscles. Its unique design allows
                      for precise targeting of the pectorals, ensuring maximum
                      muscle engagement with each repetition. By simulating the
                      fly motion, this machine provides a full range of motion,
                      promoting muscle growth and definition. With adjustable
                      resistance settings, it accommodates users of all fitness
                      levels, allowing for progressive overload and continual
                      improvement. Regular incorporation of the Chest Flies
                      machine into workouts leads to enhanced chest strength,
                      improved muscle balance, and a more symmetrical upper body
                      appearance. Transform your chest workouts and unlock your
                      full potential with this essential gym equipment.
                    </p>
                  </div>
                </div>
              </div>
...
export default MachineChestFlies;
