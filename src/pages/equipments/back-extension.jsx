...
function BackExtension() {
  ...
  const handleApplyForInquiry = async () => {
    try {
      ...
      await sendInquiry(
        ...
        email,
        phoneNumber,
        "FG Equipment Back Extension Page",
        modifiedMessage,
  ...
  const product = [
    "/assets/images/equipment/back-extension-inner-1.webp",
    "/assets/images/equipment/back-extension-inner-2.webp",
    "/assets/images/equipment/back-extension-inner-3.webp",
    "/assets/images/equipment/back-extension-inner-4.webp",
  ];
  ...
  return (
    <>
      <Helmet>
        <title>Back Extension Machine - Gomzi Ftiness Equiptment</title>
        <meta
          name="description"
          content="The Gomzi Fitness Back Seated Machine Is Designed As Best Gym Equipment, With Adjustable Settings And Ergonomic Support Muscle During Exercises - Gomzi Ftiness Equiptment."
        />
        <meta
          name="keyword"
        ...
        <meta
          property="og:title"
          content="Back Extension Machine - Gomzi Ftiness Equiptment"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://fggroup.in/equipments/back-extension"
        />
      ...
      <main className="page--content p-0">
        ...
        >
          <div
            ...
            style={{
              backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/equipment/back-extension-banner.webp)`,
            }}
          ></div>
          <div
          ...
          <section className="rich-text--section p-relative px-sides pb-48 800:pt-72 800:pb-72 d-none d-lg-block">
            <div className="row">
              ...
              <div className="col-lg-6 mt-4">
                ...
                >
                  <h2 className="h2-fs">
                    <b>Core Stability, Backbone Health</b>
                  </h2>
                  <p>
                    In addition to its core benefits, the back extension machine
                    promotes flexibility and range of motion in the lower back,
                    contributing to overall mobility. By targeting the posterior
                    chain muscles, including the hamstrings and glutes, it
                    offers comprehensive strength development for functional
                    movements like bending, lifting, and twisting.
                  </p>
                  <p>
                    Regular use of the back extension machine can also alleviate
                    tension and discomfort in the lower back region, providing
                    relief from sedentary lifestyle-related issues. Furthermore,
                    it enhances body awareness and proprioception, improving
                    coordination and reducing the risk of falls or accidents.
                    Incorporating the back extension machine into fitness
                    routines ensures holistic back health and optimal physical
                    performance.
                  </p>
                  <ul>
                    <li className="mt-2">Strengthening lower back muscles.</li>
                    <li className="mt-2">Improving posture.</li>
                    <li className="mt-2">Enhancing spinal stability.</li>
                    <li className="mt-2">
                      Promoting flexibility and range of motion in the lower
                      back.
                    </li>
                    <li className="mt-2">Developing a strong core.</li>
                    <li className="mt-2">
          ...
          >
            ...
            >
              <div
                ...
                style={{
                  backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/equipment/back-extension-description-1.webp)`,
                }}
              ></div>
              <div
              ...
              >
                ...
                >
                  ...
                  >
                    <p>
                      The back extension machine holds significant importance in
                      fitness routines due to its targeted focus on
                      strengthening the muscles of the lower back and core. By
                      specifically targeting these muscle groups, it helps
                      improve spinal stability, posture, and overall back
                      health. Strengthening the lower back muscles is crucial
                      for supporting the spine and reducing the risk of injury,
                      particularly for individuals who engage in activities that
                      involve bending or lifting. Additionally, a strong lower
                      back enhances athletic performance, promotes better body
                      mechanics, and contributes to overall functional fitness.
                      Incorporating the back extension machine into workouts
                      ensures a balanced and resilient body, essential for
          ...
          >
            ...
            >
              <div
                ...
                style={{
                  backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/equipment/back-extension-description-2.webp)`,
                }}
              ></div>
              <div
              ...
              >
                ...
                >
                  <h2 className="h2-fs type--heading text-white">
                    {/* <span className="type--sub-heading d-block h2 text-white"><b>TOTAL FITNESS</b></span> */}
                    <span className="type--main-heading d-block h1 text-32-40 mt-4 text-white">
                      <b>Enhance Posture, Prevent Injury</b>
                    </span>
                  </h2>
                  <div
                    className="rich-text contains-links text-15-18 leading-140 font-sans text-white brand-colorway-red colorway-dark links-white contains-tables mt-24"
                  ...
                  >
                    <p>
                      The back extension machine is indispensable for overall
                      fitness due to its targeted strengthening of the lower
                      back and core muscles. It plays a pivotal role in
                      improving posture by strengthening the muscles that
                      support the spine, reducing the risk of back pain and
                      injury. Strengthening the lower back also enhances
                      stability and balance, essential for daily activities and
                      sports performance. Moreover, the back extension machine
                      aids in developing a strong core, which is vital for
                      maintaining proper body alignment and preventing injuries
                      in various physical pursuits. Its inclusion in workout
                      routines fosters a resilient and functional body for a
