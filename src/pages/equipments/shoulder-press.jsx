...
function ShoulderPress() {
  ...
  const handleApplyForInquiry = async () => {
    try {
      ...
      await sendInquiry(
        ...
        email,
        phoneNumber,
        "FG Equipment Shoulder Press Machine Page",
        modifiedMessage,
  ...
  const product = [
    "/assets/images/equipment/shoulder-press-inner-1.webp",
    "/assets/images/equipment/shoulder-press-inner-2.webp",
    "/assets/images/equipment/shoulder-press-inner-3.webp",
    "/assets/images/equipment/shoulder-press-inner-4.webp",
  ];
  useEffect(() => {
    const $ = window.$;
  ...
  return (
    <>
      <Helmet>
        <title>Machine Shoulder chest | Gomzi equipment</title>
        ...
        <meta property="og:title" content="Machine Shoulder chest | Gomzi equipment" />
        ...
        <meta property="og:url" content="https://fggroup.in/equipments/shoulder-press" />
      ...
      <main className="page--content p-0">
        ...
        >
          <div
            ...
            style={{
              backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/equipment/machine-shoulder-press-banner.webp)`,
            }}
          ></div>
          <div
          ...
          <section className="rich-text--section p-relative px-sides pb-48 800:pt-72 800:pb-72 d-none d-lg-block">
            <div className="row">
              ...
              <div className="col-lg-6 mt-4">
                ...
                >
                  <h2 className="h2-fs">
                    <b>Precision Soldering, Reliable Connections</b>
                  </h2>
                  <p>
                    The solder press machine is a vital tool in electronics
                    manufacturing, facilitating the soldering process for
                    various components on circuit boards. It typically consists
                    of a sturdy frame with a heated soldering iron mounted above
                    a platform. Operators use the machine to precisely position
                    and apply solder to electronic components, ensuring secure
                    connections and reliable functionality.
                  </p>
                  <p>
                    The machine's adjustable settings allow for precise control
                    of temperature and pressure, accommodating different
                    soldering requirements and materials. With its efficiency
                    and accuracy, the solder press machine streamlines
                    production processes, reduces assembly time, and ensures
                    consistent soldering quality, making it indispensable in
                    electronics manufacturing environments.
                  </p>
                  <ul>
                    <li className="mt-2">
                      Consistent Quality: Provides reliable solder connections,
                      leading to consistent performance and product reliability.
                    </li>
                    <li className="mt-2">
                      Versatility: Accommodates various soldering requirements
                      and component sizes, offering flexibility in assembly
                      tasks.
                    </li>
                    <li className="mt-2">
                      Reduced Labor Costs: Automates soldering tasks, reducing
                      the need for manual labor and associated costs.
                    </li>
                    <li className="mt-2">
                      Improved Safety: Minimizes the risk of burns and injuries
                      associated with manual soldering techniques.
                    </li>
                    <li className="mt-2">
                      Enhanced Productivity: Enables operators to focus on other
                      tasks while soldering is performed automatically.
                    </li>
                    <li className="mt-2">
                      Quality Assurance: Helps maintain consistent soldering
                      standards and compliance with industry regulations.
                    </li>
                  </ul>
                </div>
              </div>
          ...
          >
            ...
            >
              <div
                ...
                style={{
                  backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/equipment/shoulder-press-description-1.webp)`,
                }}
              ></div>
              <div
                ...
                >
                  <h2 className="h2-fs type--heading text-white">
                    ...
                    <span className="type--main-heading d-block h1 text-32-40 mt-4 text-white">
                      <b>Efficiency in Soldering Excellence</b>
                    </span>
                  </h2>
                  <div
                  ...
                  >
                    <p>
                      The solder press machine is a cornerstone of electronics
                      assembly, providing efficient and precise soldering for
                      circuit board components. Its robust design and adjustable
                      features enable operators to control temperature,
                      pressure, and solder flow, ensuring consistent and
                      reliable connections. With its ergonomic layout and
                      user-friendly interface, the machine enhances productivity
                      and minimizes errors during the soldering process. Whether
                      used in small-scale workshops or large manufacturing
                      facilities, the solder press machine streamlines
                      production workflows, reduces labor costs, and improves
                      overall assembly quality. Its versatility and reliability
                      make it an essential tool for electronics manufacturers
                      striving for efficiency and excellence in their
                      operations.
                    </p>
                  </div>
                </div>
          ...
          >
            ...
            >
              <div
                ...
                style={{
                  backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/equipment/shoulder-press-description-2.webp)`,
                }}
              ></div>
              <div
              ...
              >
                ...
                >
                  <h2 className="h2-fs type--heading text-white">
                    {/* <span className="type--sub-heading d-block h2 text-white"><b>TOTAL FITNESS</b></span> */}
                    <span className="type--main-heading d-block h1 text-32-40 mt-4 text-white">
                      <b>Efficient Electronics Assembly Solutions</b>
                    </span>
                  </h2>
                  <div
                    className="rich-text contains-links text-15-18 leading-140 font-sans text-white brand-colorway-red colorway-dark links-white contains-tables mt-24"
                  ...
                  >
                    <p>
                      The solder press machine revolutionizes electronics
                      manufacturing, offering precise soldering solutions for
                      intricate circuit board assemblies. Its advanced features,
                      including adjustable temperature and pressure settings,
                      ensure optimal soldering conditions for various
                      components. With a robust frame and intuitive controls,
                      operators can efficiently position and solder electronic
                      parts with precision and consistency.
                    </p>
                    <p>
                      The machine's versatility accommodates a wide range of
                      soldering applications, from intricate microelectronics to
                      larger-scale projects. By streamlining the soldering
                      process, the machine enhances production efficiency,
                      reduces defects, and ensures the reliability of electronic
                      devices. Incorporating the solder press machine into
                      manufacturing workflows empowers businesses to meet
                      stringent quality standards and deliver superior products
                      to customers.
                    </p>
                  </div>
                </div>
