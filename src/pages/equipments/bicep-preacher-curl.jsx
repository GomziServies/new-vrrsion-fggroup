...
function BicepPreacherCurl() {
  ...
  const handleApplyForInquiry = async () => {
    try {
      ...
      await sendInquiry(
        ...
        email,
        phoneNumber,
        "FG Equipment Bicep Preacher Curl Page",
        modifiedMessage,
  ...
  const product = [
    "/assets/images/equipment/bicep-preacher-curl-inner-1.webp",
    "/assets/images/equipment/bicep-preacher-curl-inner-2.webp",
    "/assets/images/equipment/bicep-preacher-curl-inner-3.webp",
    "/assets/images/equipment/bicep-preacher-curl-inner-4.webp",
  ];
  ...
  return (
    <>
      <Helmet>
        <title>Bicep Preacher curl machine | Gomzi equipment</title>
        <meta
          name="description"
          content="Define arm muscles effectively with Gomzi's Bicep Preacher Curl Machine. Essential for targeted workouts, a must-have in any fitness equipment lineup."
        />
        <meta
          name="keyword"
        ...
        <meta
          property="og:title"
          content="Bicep Preacher curl machine | Gomzi equipment"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://fggroup.in/equipments/bicep-preacher-curl"
        />
      ...
      <main className="page--content p-0">
        ...
        >
          <div
            ...
            style={{
              backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/equipment/bicep-preacher-curl-banner.webp)`,
            }}
          ></div>
          <div
          ...
          <section className="rich-text--section p-relative px-sides pb-48 800:pt-72 800:pb-72 d-none d-lg-block">
            <div className="row">
              ...
              <div className="col-lg-6 mt-4">
                ...
                >
                  <h2 className="h2-fs">
                    <b>Maximize Your Bicep Potential</b>
                  </h2>
                  <p>
                    The Bicep Preacher Curl machine is a vital component in
                    strength training, focusing specifically on developing the
                    biceps muscles. By isolating the biceps brachii, this
                    machine ensures targeted and effective muscle engagement,
                    leading to increased strength and size in the biceps. Its
                    angled design provides support for the upper arms,
                    minimizing cheating and maximizing muscle tension throughout
                    the entire range of motion.
                  </p>
                  <p>
                    Regular use of the Bicep Preacher Curl machine not only
                    enhances bicep definition but also improves overall arm
                    strength and stability. Elevate Your Biceps.
                  </p>
                  <ul>
                    <li className="mt-2">
                      Targeted bicep growth with minimized cheating.
                    </li>
                    <li className="mt-2">
                      Improved muscle engagement for enhanced definition.
                    </li>
                    <li className="mt-2">
                      Injury prevention through controlled, stable movements.
                    </li>
                    <li className="mt-2">
                      Convenient, efficient bicep workouts for busy schedules.
                    </li>
                    <li className="mt-2">
                      Versatile machine adaptable to different fitness levels.
                    </li>
                    <li className="mt-2">
                      Trackable progress with adjustable resistance and
                      settings.
                    </li>
                  </ul>
                </div>
          ...
          >
            ...
            >
              <div
                ...
                style={{
                  backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/equipment/bicep-preacher-curl-description-1.webp)`,
                }}
              ></div>
              <div
                ...
                >
                  <h2 className="h2-fs type--heading text-white">
                    ...
                    <span className="type--main-heading d-block h1 text-32-40 mt-4 text-white">
                      <b>Biceps Refined: Precision Strength Training</b>
                    </span>
                  </h2>
                  <div
                  ...
                  >
                    <p>
                      The Bicep Preacher Curl machine is a specialized piece of
                      equipment designed to isolate and strengthen the biceps
                      muscles. Its angled pad provides support for the arms,
                      reducing strain on the joints and enabling strict form
                      throughout the exercise. By minimizing momentum, it
                      ensures that the biceps bear the brunt of the workload,
                      leading to targeted muscle growth and definition. This
                      machine is particularly beneficial for individuals looking
                      to sculpt their arms, improve aesthetics, and enhance
                      overall upper body strength. Incorporating the Bicep
                      Preacher Curl machine into workouts can result in
                      significant gains in bicep size, strength, and muscular
                      endurance over time.
                    </p>
                  </div>
                </div>
          ...
          >
            ...
            >
              <div
                ...
                style={{
                  backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/equipment/bicep-preacher-curl-description-2.webp)`,
                }}
              ></div>
              <div
              ...
              >
                ...
                >
                  <h2 className="h2-fs type--heading text-white">
                    {/* <span className="type--sub-heading d-block h2 text-white"><b>TOTAL FITNESS</b></span> */}
                    <span className="type--main-heading d-block h1 text-32-40 mt-4 text-white">
                      <b>Bicep Mastery: Precision in Strength</b>
                    </span>
                  </h2>
                  <div
                    className="rich-text contains-links text-15-18 leading-140 font-sans text-white brand-colorway-red colorway-dark links-white contains-tables mt-24"
                  ...
                  >
                    <p>
                      The Bicep Preacher Curl machine is a cornerstone of
                      strength training, honing in on bicep development with
                      precision. Its design provides stability and support,
                      minimizing momentum and ensuring strict form for maximal
                      muscle isolation. By targeting the biceps brachii
                      directly, this machine facilitates efficient and effective
                      muscle engagement, fostering increased strength and size.
                      Its user-friendly setup makes it accessible to individuals
                      of all fitness levels, promoting proper technique and
                      reducing the risk of injury. Regular use of the Bicep
                      Preacher Curl machine yields noticeable improvements in
                      bicep definition and overall arm strength, making it an
                      essential tool in any comprehensive strength training
                      regimen.
                    </p>
                  </div>
                </div>
...
export default BicepPreacherCurl;
