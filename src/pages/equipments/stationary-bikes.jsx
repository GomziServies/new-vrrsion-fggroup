...
function StationaryBikes() {
  ...
  const handleApplyForInquiry = async () => {
    try {
      ...
      await sendInquiry(
        ...
        email,
        phoneNumber,
        "FG Equipment Stationary Bikes Page",
        modifiedMessage,
  ...
  const product = [
    "/assets/images/equipment/stationary-bikes-inner-1.webp",
    "/assets/images/equipment/stationary-bikes-inner-2.webp",
    "/assets/images/equipment/stationary-bikes-inner-3.webp",
    "/assets/images/equipment/stationary-bikes-inner-4.webp",
  ];
  useEffect(() => {
    const $ = window.$;
  ...
  return (
    <>
      <Helmet>
        <title>Stationary Bike Machine - Gomzi Ftiness Equiptment</title>
        <meta name="description" content="The Gomzi Fitness Stationary Bike Is A Sleek And Sturdy Exercise Fitness Equipment  For Cardio Workouts, Making It Ideal For Users Of All Fitness Levels - Gomzi Ftiness Equiptment." />
        ...
        <meta property="og:title" content="Stationary Bike Machine - Gomzi Ftiness Equiptment" />
        <meta property="og:description" content="The Gomzi Fitness Stationary Bike Is A Sleek And Sturdy Exercise Fitness Equipment  For Cardio Workouts, Making It Ideal For Users Of All Fitness Levels - Gomzi Ftiness Equiptment." />
        <meta property="og:image" content="https://fggroup.in/assets/images/logo/fg_group.webp" />
        <meta property="og:url" content="https://fggroup.in/equipments/stationary-bikes" />
      ...
      <main className="page--content p-0">
        ...
        >
          <div
            ...
            style={{
              backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/equipment/stationary-bikes-banner.webp)`,
            }}
          ></div>
          <div
          ...
          <section className="rich-text--section p-relative px-sides pb-48 800:pt-72 800:pb-72 d-none d-lg-block">
            <div className="row">
              ...
              <div className="col-lg-6 mt-4">
                ...
                >
                  <h2 className="h2-fs">
                    <b>Ride towards a healthier you</b>
                  </h2>
                  <p>
                    Stationary bikes, also known as exercise bikes, are popular
                    fitness equipment designed for indoor cycling workouts.
                    These bikes mimic the motion of outdoor cycling but are
                    stationary, making them ideal for home gyms and fitness
                    centers. They typically feature adjustable resistance
                    levels, allowing users to customize their workouts according
                    to their fitness goals and preferences.
                  </p>
                  <p>
                    Stationary bikes offer low-impact cardiovascular exercise,
                    promoting heart health and endurance. With features like
                    adjustable seats and handlebars, they accommodate users of
                    various sizes and fitness levels. Stationary bikes provide a
                    convenient and effective way to improve cardiovascular
                    fitness, burn calories, and enhance lower body strength and
                    endurance.
                  </p>
                  <ul>
                    <li className="mt-2">
                      Low-Impact Cardiovascular Workout: Stationary bikes
                      provide a cardiovascular workout without putting excessive
                      stress on the joints, making them suitable for individuals
                      with joint issues or injuries.
                    </li>
                    <li className="mt-2">
                      Improved Heart Health: Regular cycling on a stationary
                      bike helps strengthen the heart muscles, improve blood
                      circulation, and lower the risk of cardiovascular
                      diseases.
                    </li>
                    <li className="mt-2">
                      Weight Management: Cycling on a stationary bike can help
                      burn calories and assist in weight loss or weight
                      management efforts when combined with a balanced diet.
                    </li>
                    <li className="mt-2">
                      Leg Muscle Strength: Pedaling on a stationary bike
                      strengthens the muscles in the legs, including the
          ...
          <section className="rich-text--section p-relative px-sides pb-48 800:pt-72 800:pb-72 d-block d-lg-none">
            <div className="row">
              ...
              <div className="col-lg-6 mt-5">
                ...
                >
                  <h2 className="h2-fs">
                    <b>Pedal with purpose, feel the power</b>
                  </h2>
                  <p>
                    Stationary bikes, also known as exercise bikes, are popular
                    fitness equipment designed for indoor cycling workouts.
          ...
          >
            ...
            >
              <div
                ...
                style={{
                  backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/equipment/stationary-bikes-description-1.webp)`,
                }}
              ></div>
              <div
              ...
              >
                ...
                >
                  ...
                  >
                    <p>
                      Stationary bikes, also known as exercise bikes, are
                      versatile fitness machines designed for indoor cycling
                      workouts. These bikes simulate the experience of outdoor
                      cycling, offering users a low-impact cardiovascular
                      exercise option. With adjustable resistance settings,
                      users can tailor their workouts to suit their fitness
                      levels and goals, whether aiming for endurance training,
                      fat burning, or interval workouts. Stationary bikes are
                      suitable for users of all fitness levels and ages,
                      providing a safe and effective way to improve
                      cardiovascular health, strengthen leg muscles, and burn
                      calories. Their compact design makes them ideal for home
                      gyms, enabling users to enjoy convenient and efficient
                      workouts anytime.
                    </p>
                  </div>
                </div>
          ...
          >
            ...
            >
              <div
                ...
                style={{
                  backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/equipment/stationary-bikes-description-2.webp)`,
                }}
              ></div>
              <div
              ...
              >
                ...
                >
                  <h2 className="h2-fs type--heading text-white">
                    {/* <span className="type--sub-heading d-block h2 text-white"><b>TOTAL FITNESS</b></span> */}
                    <span className="type--main-heading d-block h1 text-32-40 mt-4 text-white">
                      <b>Sweat today, smile tomorrow</b>
                    </span>
                  </h2>
                  <div
                    className="rich-text contains-links text-15-18 leading-140 font-sans text-white brand-colorway-red colorway-dark links-white contains-tables mt-24"
                  ...
                  >
                    <p>
                      Stationary bikes are highly accessible fitness equipment,
                      offering a convenient and effective way to stay active
                      indoors. With features such as adjustable seats,
                      handlebars, and resistance levels, users can customize
                      their riding experience for optimal comfort and challenge.
                    </p>
                    <p>
                      These bikes provide a low-impact cardiovascular workout,
                      ideal for individuals with joint issues or those
                      recovering from injuries. Moreover, stationary bikes offer
                      a versatile workout platform, allowing users to engage in
                      various cycling routines, such as steady-state cardio,
                      interval training, or hill climbs. Whether used for
                      warm-ups, cool-downs, or full workouts, stationary bikes
                      are a reliable choice for improving cardiovascular health,
...
export default StationaryBikes;
