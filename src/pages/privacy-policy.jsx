...
function PrivacyPolicy() {
  ...
  return (
    <>
      <Helmet>
        <title>Privacy Policy | FG Group</title>
        ...
        <meta property="og:title" content="Privacy Policy | FG Group" />
        ...
        <meta property="og:url" content="https://fggroup.in/privacy-policy" />
          ...
          <div className="container">
            ...
            <div className="describe">
              <p>
                <br />
                <br />
                <h2 className="h4-fs">SECTION 1 - WHAT DO WE DO WITH YOUR INFORMATION?</h2>
                When you purchase something from our store, as part of the
                buying and selling process, we collect the personal information
                you give us such as your name, address and email address. When
                you browse our store, we also automatically receive your
                ...
                <br />
                <br />
                <h2 className="h4-fs">SECTION 2 - CONSENT</h2>
                ...
                <br />
                <br />
                <h2 className="h4-fs">SECTION 5 - THIRD-PARTY SERVICES</h2>
                ...
                are located. Once you leave our store's website or are
                ...
                Service. Links When you click on links on our store, they may
                ...
                <br />
                <br />
                <h2 className="h4-fs">SECTION 6 - SECURITY</h2>
                ...
                <br />
                <br />
                <h2 className="h4-fs">SECTION 9 - CHANGES TO THIS PRIVACY POLICY</h2>
                ...
                info@fggroup.in or by mail at Address:- A- 301, Ambrosia
