...
function YellowSmoothie() {
  ...
  return (
    <>
    <Helmet>
        <title>Yellow Smoothie Recipe | Pre - Post Workout Smoothie | FG Meals</title>
        <meta name="description" content="Yellow Smoothie is prepared in Just 5 mins and serves you the optimum amount of carbs and protein that your body needs before or after a workout." />
        <meta name="keyword" content="" />
        <meta property="og:title" content="Yellow Smoothie Recipe | Pre - Post Workout Smoothie | FG Meals" />
        <meta property="og:description" content="Yellow Smoothie is prepared in Just 5 mins and serves you the optimum amount of carbs and protein that your body needs before or after a workout." />
        <meta property="og:image" content="https://fggroup.in/assets/images/logo/fg_group.webp" />
        <meta property="og:url" content="https://fggroup.in/recipe/yellow-smoothie" />
          ...
          <div className="container">
            <div className="row resip">
                  ...
                  <div className="ply1">
                    <LazyLoadImage
                      ...
                      src={
                        ...
                        "/assets/images/img/yellow-smoothie.webp"
                      }
                      width="100%"
                    ...
                    <div className="ply3">
                      <a aria-label="Fg Group"
                        className="custom"
                        onClick={() => openVideoModal("zNAEXuUU1kI")}
                      >
                        <i
              ...
              <div className="col-lg-6 w">
                ...
                <div>
                  <div className="Info">
                    <h2 className="h2-fs">About Yellow Smoothie </h2>
                  </div>
                  <p>
                    This is the healthy drink which your body needs after a
                    workout or as a Pre-workout, Serves right with the best
                    combination of Mango and pineapple to flavour up your taste
                    buds. It is prepared in Just 5 mins and serves you the
                    optimum amount of carbs and protein that your body needs.{" "}
                  </p>
                  <div className="Info">
                    ...
                    <ul>
                      ...
                      <li>
                        <LazyLoadImage
                          ...
                          src={
                            process.env.PUBLIC_URL +
                            "/assets/images/img/pineapplesquash.webp"
                          }
                          width="90px"
                          height="90px"
                          alt="fggroup"
                        />
                        <div className="d-inline-block ml-2">
                          <h2 className="h5-fs">Pineapple Squash</h2>
                          <h2 className="h6-fs">1 tablespoon</h2>
                        </div>
                      </li>
                    </ul>
                  ...
                  <div className="Grocery1 float-left">
                    <ul>
                      <li>
                        Take 1 tablespoon of mango yogurt and add it in a
                        blender bowl.
                      </li>
                      <li>Add 2 tabsp of Greek yogurt in the blender bowl.</li>
                      <li>
                        Now, for more flavor, we will add 1 tabsp of Pineapple
                        Squash and 1 tabsp of orange Squash.
                      </li>
                      <li>
                        Add 1 Teaspoon of Cinamon Powder in the bowl where the
                        rest of ingredients are added as well.
                      </li>
                      <li>
                        Now add 250 ml milk to the ingredients jar and blend it
                        well.
                      </li>
                    </ul>
                  </div>
                  <div className="Info">
                    <h2 className="h2-fs">Benefits of Yellow Smoothie</h2>
                  </div>
