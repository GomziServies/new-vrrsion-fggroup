...
function StrawberriesBananaSmoothie() {
  ...
  return (
    <>
    <Helmet>
        <title>Strawberries And Banana Smoothie | FG Meals</title>
        <meta name="description" content="This easy and delicious Strawberry Smoothie recipe combines strawberries, milk, bananas, and yogurt giving you a refreshing burst of flavor." />
        <meta name="keyword" content="" />
        <meta property="og:title" content="Strawberries And Banana Smoothie | FG Meals" />
        <meta property="og:description" content="This easy and delicious Strawberry Smoothie recipe combines strawberries, milk, bananas, and yogurt giving you a refreshing burst of flavor." />
        <meta property="og:image" content="https://fggroup.in/assets/images/logo/fg_group.webp" />
        <meta property="og:url" content="https://fggroup.in/recipe/strawberries-banana-smoothie" />
            ...
            <div className="row resip">
                  ...
                  <div className="ply1">
                    <LazyLoadImage
                      ...
                      src={
                        ...
                        "/assets/images/img/strawberries-banana-smoothie.webp"
                      }
                      width="100%"
                    ...
                    <div className="ply3">
                      <a aria-label="Fg Group"
                        className="custom"
                        onClick={() => openVideoModal("C3Sheurxmog")}
                      >
                        <i
              ...
              <div className="col-lg-6 w">
                <div className="tabata d-inline-block">
                  <h1>Strawberries & banana Smoothie</h1>
                </div>
                ...
                <div>
                  <div className="Info">
                    <h2 className="h2-fs">About Strawberries & banana Smoothie</h2>
                  </div>
                  <p>
                    Works as a perfect snack that can be handy and easily
                    accessible by you. One don't need to learn how to cook and
                    stuff which can be made by anyone with this recipe
                  </p>
                  <div className="Info">
                  ...
                  <div className="Grocery">
                    ...
                    <ul>
                      ...
                      <li>
                        ...
                        />
                        <div className="d-inline-block ml-2">
                          <h2 className="h5-fs">Protein Powder</h2>
                          <h2 className="h6-fs">if you have it</h2>
                        </div>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="Grocery1 float-left">
                    <ul>
                      ...
                      <li>
                        Furthermore add 200 ml of milk to complete your smoothie
                      </li>
                      <li>
                        You can add Protein Powder for garnishing and more
                        flavoring
                      </li>
                      <li>
                        And Here is Your Strawberry banana smoothie ready to be
                        consumed
                      </li>
                    </ul>
                  </div>
                  <div className="Info">
                    <h2 className="h2-fs">Benefits of Strawberry banana smoothie</h2>
                  </div>
...
export default StrawberriesBananaSmoothie;
