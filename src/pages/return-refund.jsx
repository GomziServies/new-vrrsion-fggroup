...
function ReturnRefund() {
  ...
  return (
    <>
      <Helmet>
        <title>Return & Refunds policy for your safety.</title>
        <meta name="description" content="here we have represented our return & refunds policy details and please read to know more about it" />
        <meta name="keyword" content="" />
        <meta property="og:title" content="Return & Refunds policy for your safety." />
        <meta property="og:description" content="here we have represented our return & refunds policy details and please read to know more about it" />
        <meta property="og:image" content="https://fggroup.in/assets/images/logo/fg_group.webp" />
        <meta property="og:url" content="https://fggroup.in/return-refund" />
        ...
        <div className="container-fluid">
          <div className="container">
            ...
            <div className="describe">
              ...
              <p className="mb-3">
                <br />
                <h2 className="h4-fs mt-2 mb-2">Sale items (if applicable)</h2>
                <br /> Only regular priced items may be refunded, unfortunately
                sale items cannot be refunded.
                <br />
                <br />
                <h2 className="h4-fs mt-2 mb-2">Exchanges (if applicable)</h2>
                ...
                <br />
                <br />
                <h2 className="mt-2 mb-2 h4-fs">Gifts</h2>
                ...
                <br />
                <br />
                <h2 className="h4-fs mt-2 mb-2">Shipping</h2>
