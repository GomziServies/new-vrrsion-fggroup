  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="What makes these books the best health and fitness books? If you're interested in learning about nutrition and personal training then it includes all topics." />
        <meta name="keyword" content="dietitian and nutritionists, dietitian and nutritionist course, courses for fitness trainer, certification for fitness trainer" />
        <meta property="og:title" content="Terms & Condition | FG Group" />
        <meta property="og:description" content="What makes these books the best health and fitness books? If you're interested in learning about nutrition and personal training then it includes all topics." />
        ...
        <div className="container-fluid">
          <div className="container">
            ...
            <div className="describe">
              <p>
                This website is operated by FITNESSWITHGOMZI. Throughout the
                site, the terms “we”, “us” and “our” refer to FITNESSWITHGOMZI.
              ...
              <p>
                <h2 className="h4-fs mt-2 mb-2">SECTION 1 - ONLINE STORE TERMS</h2>
              ...
              <p>
                <h2 className="h4-fs mt-2 mb-2">SECTION 2 - GENERAL CONDITIONS</h2>
                ...
                used in this agreement are included for convenience only and
                will not limit or otherwise affect these Terms.
              </p>
              <p>
                <h2 className="h4-fs mt-2 mb-2">
              ...
              <p>
                <h2 className="h4-fs mt-2 mb-2">SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES</h2>
              ...
              <p>
                <h2 className="h4-fs mt-2 mb-2">SECTION 5 - PRODUCTS OR SERVICES</h2>
              ...
              <p>
                <h2 className="h4-fs mt-2 mb-2">SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</h2>
                ...
                limit or distributors. prohibit orders that, in our sole
                judgment, appear to be placed by dealers, resellers or prohibit
                orders that, in our sole judgment, appear tobe placed by
                dealers, resellers or You agree to provide current, complete and
                accurate purchase and account information for all purchases made
                at our store. You agree to promptly update your account and
                other information, including your email address and credit card
                numbers and expiration dates, so that we can complete your
                transactions and contact you as needed. For more detail, please
                review our Returns Policy.
              </p>
              <p>
                <h2 className="h4-fs mt-2 mb-2">SECTION 7 - OPTIONAL TOOLS</h2>
                We may provide you with access to third-party tools over
                which we neither monitor nor have any control nor input.
                prohibit orders that, in our sole judgment, appear to/be placed
                by dealers, resellers or prohibit orders that, in our sole
                judgment, appear tobe placed by dealers, resellers or You
              ...
              <p>
                <h2 className="h4-fs mt-2 mb-2">SECTION 8 - THIRD-PARTY LINKS</h2>
                prohibit orders that, in our sole judgment, appear to/be
                placed by dealers, resellers or prohibit orders that, in our
                sole judgment, appear tobe placed by dealers, resellers or
              ...
              <p>
                ...
                prohibit orders that, in our sole judgment, appear to/be placed
                by dealers, resellers or prohibit orders that, in our sole
                judgment, appear tobe placed by dealers, resellers or materials,
                ...
                these Terms of Service. prohibit orders that, in our sole
                judgment, appear to/be placed by dealers, resellers or prohibit
                orders that, in our sole judgment, appear tobe placed by
                dealers, resellers or You agree that your comments will not
              ...
              <p>
                <h2 className="h4-fs mt-2 mb-2">SECTION 10 - PERSONAL INFORMATION</h2>
                prohibit orders that, in our sole judgment, appear to/be
              ...
              <p>
                <h2 className="h4-fs mt-2 mb-2">SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS</h2>
              ...
              <p>
                <h2 className="h4-fs mt-2 mb-2">SECTION 12 - PROHIBITED USES</h2>
              ...
              <p>
                ...
                In no case shall FITNESSWITHGOMZI, our directors, officers,
              ...
              <p>
                <h2 className="h4-fs mt-2 mb-2">SECTION 14 - INDEMNIFICATION</h2>
              ...
              <p>
                <h2 className="h4-fs mt-2 mb-2">SECTION 15 - SEVERABILITY</h2>
              ...
              <p>
                <h2 className="h4-fs mt-2 mb-2">SECTION 16 - TERMINATION</h2>
              ...
              <p>
                <h2 className="h4-fs mt-2 mb-2">SECTION 17 - ENTIRE AGREEMENT</h2>
              ...
              <p>
                <h2 className="h4-fs mt-2 mb-2">SECTION 18 - GOVERNING LAW</h2>
                These Terms of Service and any separate agreements
                whereby we provide you Services shall be governed by and
                construed in accordance with the laws of India and jurisdiction
                of Jaipur, Rajasthan
              </p>
              <p>
                <h2 className="h4-fs mt-2 mb-2">SECTION 19 - CHANGES TO TERMS OF SERVICE</h2>
              ...
              <p className="mb-5">
                <h2 className="h4-fs mt-2 mb-2">SECTION 20 - CONTACT INFORMATION</h2>
